...
<head>
  ...
  <script type="text/javascript">
    ...
    _gaq.push(['_setCustomVar', 1, 'rails_action', 'messages_index']);
  ...
  <div class="page-wrapper">
    <div class="page-body page-body-scrollable">
      <div class="page-container container">
        ...
        <header class="section-header bbm mbx">
  <h2>Messages</h2>
</header>
...
<div class="row mtl">
  <div class="unit size6">
    <aside class="prl">
  <a href="/messages/new" class="btn btn-block btn-primary mbl">Compose</a>
  <ul class="nav-links nav-links-block nav-links-states bts">
    <li>
      <a href="/notifications" class="phm ">
        Notifications
      </a>
    </li>
    <li>
      <a href="/inbox" class="phm active">
        Inbox
      </a>
    </li>
    <li>
      <a href="/inbox?type=sent" class="phm ">
        Sent
      </a>
    </li>
  </ul>
  ...
  <form accept-charset="UTF-8" action="/messages_index_post" id="threads_form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="k9JnfEONrAxSaAQPZpYyDUVMmkIU7ztguOQXk5VBq58=" /></div>
    <input id="action_type" name="action_type" type="hidden" />
    <div class="unit size18">
      <section class="tab-content">
          <header class="section-header bbs mbn">
            <div class="btn-group mbx">
              <a href="#" class="btn btn-small" id="mark_delete">Delete</a>

              <div class="btn-group mls" data-drop-down="hidden">
                <button class="btn btn-small" type="button" data-drop-down-handler="1">
                  More <i class="icon-btn-caret"></i>
                </button>
                <ul data-drop-down-target="1" class="dropdown-menu hidden">
                  <li><a href="/inbox?unread=true">Show unread messages</a></li>
                  <li><a href="#" id="mark_read">Mark as read</a></li>
                  <li><a href="#" id="mark_unread">Mark as unread</a></li>
                </ul>
              </div>
            </div>
          </header>
          ...
          <table class="table table-messages">
            <thead>
              <tr>
                <th class="size1">
                  <a href="#" class="tooltip-south">
                    <input type="checkbox" id="select_all">
                    <span class="tip">Select all</span>
                  </a>
                </th>
                <th class="size4">From</th>
                <th class="size9">Message</th>
                <th class="size4">Date</th>
              </tr>
            </thead>
            <tbody>
                <tr class="" data-link="/messages/3689239t?type=#last-message">
                  <td class='checkbox-wrapper'><input type="checkbox" value="1" name="threads[3689239t]"></td>
                  <td>
                    <img alt="3de7d01188" class="thumbnail-avatar-tiny pull-left mrs" height="20" src="http://0.viki.io/u/547598u/3de7d01188.jpg?s=20x20&amp;cb=1" width="20" />
                    <div class="media-body">Viki</div>
                  </td>
                  <td class="word-wrap">
                    <div class="size9">Congratulations! People love your subtitles -- ...</div>
                  </td>
                  <td>4 days ago </td>
                </tr>
                <tr class="" data-link="/messages/3683642t?type=#last-message">
                  <td class='checkbox-wrapper'><input type="checkbox" value="1" name="threads[3683642t]"></td>
                  <td>
                    <img alt="3de7d01188" class="thumbnail-avatar-tiny pull-left mrs" height="20" src="http://0.viki.io/u/547598u/3de7d01188.jpg?s=20x20&amp;cb=1" width="20" />
                    <div class="media-body">Viki</div>
                  </td>
          ...
          <fieldset class="button-actions hidden">
  ...
  <div class="container">
    ...
    <div class="colophon-links pull-right">
      ...
      <a href="/messages?locale=en" class="first-child muted" rel="nofollow" title="English">
        <i class="img-flag-us"></i> English
</a>      <a href="/messages?locale=es" class="muted" rel="nofollow" title="Español">
