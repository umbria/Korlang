...
<head>
  ...
  <script type="text/javascript">
    ...
    _gaq.push(['_setCustomVar', 1, 'rails_action', 'static_pages_copyright']);
...
<body class="">
  ...
  <div class="unit size16">
    <article>
      <header class="page-header pbm">
        <h1><a href="/copyright">Intellectual Property Policy</a></h1>
        <p class="summary">If you are an intellectual property owner or an agent
          thereof and believe that either (1) any Content on the Viki website or
          (2) any material or activity contained on an online location to which
          Viki has referred or linked users, infringes upon your intellectual
          property rights, you may submit a notification pursuant to the Digital
          Millennium Copyright Act ("DMCA") by providing our Agent for Notice of
          Claims with the following information in writing (see 17 U.S.C.
          512(c)(3) and 512(d) for further detail): </p>
      </header>
      <ol class="bullet-alpha-upper">
        ...
        <li>identification of the material that is claimed to be infringing or
          ...
          sufficient to permit us to locate the material (or in the case of
          referrals or links that are claimed to lead to infringing material or
          activity, identification of the reference or link that is to be
          removed or access to which is to be disabled, and information
          reasonably sufficient to permit us to locate that reference or link);
        </li>
        <li>information reasonably sufficient to permit us to contact you, such
      ...
      <p>You acknowledge that if you fail to comply with all of the requirements
        of this section, your DMCA notice may not be valid. E-mails or notices
        sent to Viki without a proper subject line, or for purposes other than
        communication about intellectual property claims, may not be
        acknowledged or responded to.</p>
    </article>
  </div>
  ...
  <div class="unit size7 offset1">
    <aside class="mlm mtx">
      <div class="mod mod-well">
        <div class="mod-bd">
          <h3>Notification pursuant to the DMCA should be submitted to:</h3>
          <div id="hcardAgentNoticeClaims" class="vcard">
            <span class="fn additional-name">Viki, Inc. Agent for Notice of Claims</span>,
            <div class="adr">
              <div class="street-address">Block 59 Mohamed Sultan Road <br> #04-08/09/10</div>
              <span class="country-name">Singapore</span>
              <span class="postal-code">238999</span>
            </div>
            <br>
            <span class="email">
              <span class="type">Email</span>:
              <a class="value" href="mailto:dmca@viki.com">dmca@viki.com</a>
            </span>
            <div class="tel">
              <span class="type">Fax</span>:
              <span class="value">+65.6846.8066</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="colophon-links pull-right">
      ...
      <a href="/copyright?locale=en" class="first-child muted" rel="nofollow" title="English">
        <i class="img-flag-us"></i> English
</a>      <a href="/copyright?locale=es" class="muted" rel="nofollow" title="Español">
...
<div id="data-modal-qc-vikipass" class="modal modal-subscription invisible">
  ...
  <script type="text/javascript">
    ...
    window.cur_a = "static_pages_copyright";
