...
<head>
  ...
  <script type="text/javascript">
    ...
    _gaq.push(['_setCustomVar', 1, 'rails_action', 'users_contributions']);
...
<div class="row mtl">
  ...
  <aside class="prl">
    <div class="mod user-info">
      <div class="mod-well mod-well-profile vcard mbl">
        <a href="/users/youngseok_kim/contributions" title="Youngseok Kim" class="avatar-wrapper">
  ...
  <li>
    <a href="/users/youngseok_kim/favorites" data-tab-id="following-shows" class="">Favorites</a>
  </li>
  <li>
    <a href="/users/youngseok_kim/contributions" data-tab-id="contributions" class="active">Volunteer Projects</a>
  </li>
</ul>


    <section class="tab-content" data-tab-id="contributions">
      <header class="section-header bbm mbl">
        <div class="btn-group pull-right mtm" data-drop-down="hidden">
          <button class="btn btn-small" type="button" data-drop-down-handler="1">Contributions Count
            <i class="icon-btn-caret"></i></button>
          <ul data-drop-down-target="1" class="dropdown-menu hidden">
            <li><a href="/users/youngseok_kim/roles">Channel Roles</a></li>
            <li><a href="/users/youngseok_kim/recent">Recent Subtitles</a></li>
          </ul>
        </div>
        <h2>Contributions Count by Youngseok Kim</h2>
      </header>

        <ul class="medias mbn">
          <li class="media">
            <a class="pull-left" href="#">
              <img alt="4minute" height="63" src="http://0.viki.io/c/2666c/a865c8d146.jpg?s=110x63&amp;e=t&amp;f=t&amp;cb=1" width="110" />
            </a>
            <div class="media-body">
              <ul class="nav-stats nav-stats-small mod-well pull-right pas mrm">
                <li>0 <span>Segments</span></li>
                <li>1 <span>Subtitle</span></li>
              </ul>
              <h4 class="delta"><a href="/artists/2666c-4minute">4minute</a></h4>

            </div>
          </li>
          <li class="media">
            <a class="pull-left" href="#">
              <img alt="The Heart Is But A Child" height="63" src="http://1.viki.io/c/5224/bcbd2c3058d630e57111bbeca180611411d125b3.jpg?s=110x63&amp;e=t&amp;f=t&amp;cb=1" width="110" />
            </a>
            <div class="media-body">
              <ul class="nav-stats nav-stats-small mod-well pull-right pas mrm">
                <li>0 <span>Segments</span></li>
              ...
              <h4 class="delta"><a href="/movies/5224c-the-heart-is-but-a-child">The Heart Is But A Child</a></h4>

            </div>
          </li>
          <li class="media">
            <a class="pull-left" href="#">
              <img alt="Prem Ka Game" height="63" src="http://0.viki.io/c/6922/d6b79637997b01acb9823b467d7af24fd71a66d0.png?s=110x63&amp;e=t&amp;f=t&amp;cb=1" width="110" />
            </a>
            <div class="media-body">
              <ul class="nav-stats nav-stats-small mod-well pull-right pas mrm">
                <li>0 <span>Segments</span></li>
              ...
              <h4 class="delta"><a href="/movies/6922c-prem-ka-game">Prem Ka Game</a></h4>
  ...
  <div class="container">
    ...
    <div class="colophon-links pull-right">
      ...
      <a href="/users/youngseok_kim/contributions?locale=en" class="first-child muted" rel="nofollow" title="English">
        <i class="img-flag-us"></i> English
</a>      <a href="/users/youngseok_kim/contributions?locale=es" class="muted" rel="nofollow" title="Español">
...
<div id="data-modal-qc-vikipass" class="modal modal-subscription invisible">
  ...
  <script type="text/javascript">
    ...
    window.cur_a = "users_contributions";
