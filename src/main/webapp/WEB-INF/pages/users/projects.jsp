...
<head>
  ...
  <script type="text/javascript">
    ...
    _gaq.push(['_setCustomVar', 1, 'rails_action', 'users_roles']);
...
<div class="row mtl">
  ...
  <aside class="prl">
    <div class="mod user-info">
      <div class="mod-well mod-well-profile vcard mbl">
        <a href="/users/youngseok_kim/roles" title="Youngseok Kim" class="avatar-wrapper">
    ...
    <section class="tab-content" data-tab-id="contributions">
      <header class="section-header bbm mbl">
        <div class="btn-group pull-right mtm" data-drop-down="hidden">
          <button class="btn btn-small" type="button" data-drop-down-handler="1">Channel Roles
            <i class="icon-btn-caret"></i></button>
          <ul data-drop-down-target="1" class="dropdown-menu hidden">
            <li><a href="/users/youngseok_kim/contributions">Contributions Count</a></li>
            <li><a href="/users/youngseok_kim/recent">Recent Subtitles</a></li>
          </ul>
        </div>
        <h2>Volunteer projects for Youngseok Kim</h2>
      </header>

        <div class="alert">
          <i class="icon-emo-sad pull-left"></i>
          <div class="alert-body">
            No Volunteer Projects yet.
          </div>
        </div>
  ...
  <div class="container">
    ...
    <div class="colophon-links pull-right">
      ...
      <a href="/users/youngseok_kim/roles?locale=en" class="first-child muted" rel="nofollow" title="English">
        <i class="img-flag-us"></i> English
</a>      <a href="/users/youngseok_kim/roles?locale=es" class="muted" rel="nofollow" title="Español">
