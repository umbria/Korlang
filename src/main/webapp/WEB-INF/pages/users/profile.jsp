...
<head>
  ...
  <script type="text/javascript">
    ...
    _gaq.push(['_setCustomVar', 1, 'rails_action', 'users_show']);
...
<div class="row mtl">
  ...
  <aside class="prl">
    <div class="mod user-info">
      <div class="mod-well mod-well-profile vcard mbl">
        <a href="/users/youngseok_kim" title="Youngseok Kim" class="avatar-wrapper">
  ...
  <div class="unit size18">
    <ul class="tabs mbl">
  <li>
    <a href="/users/youngseok_kim/about" data-tab-id="about-me" class="active">About Me</a>
  </li>
  <li>
  ...
  <li>
    ...
    <section class="tab-content" data-tab-id="about-me">
      <header class="section-header bbm mbl">
        <a href="https://www.viki.com/settings#about-me" class="btn btn-small btn-more-alt pull-right mlm mtm hidden" data-viewable="7275880u" rel="no-follow">Customize your profile</a>

        <h2>About Youngseok Kim</h2>
      </header>

        <div class="alert alert-noresults">
          <i class="icon-emo-sad pull-left"></i>

          <div class="alert-body">No information here yet. :(</div>
        </div>
    </section>
  </div>
</div>
  ...
  <div class="container">
    ...
    <div class="colophon-links pull-right">
      ...
      <a href="/users/youngseok_kim?locale=en" class="first-child muted" rel="nofollow" title="English">
        <i class="img-flag-us"></i> English
</a>      <a href="/users/youngseok_kim?locale=es" class="muted" rel="nofollow" title="Español">
