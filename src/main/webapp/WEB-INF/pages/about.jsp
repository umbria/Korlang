...
<head>
  ...
  <script type="text/javascript">
    ...
    _gaq.push(['_setCustomVar', 1, 'rails_action', 'static_pages_about']);
...
<body class="">
  ...
  <h1>
    <a href="/about">Fun in any language<sup class="f-zeta">TM</sup></a>
  </h1>
</header>
...
<div class="row">
  <div class="unit size16">
    <article>
      <p class="summary strong">Bringing down language barriers that stand between great entertainment and its fans, no matter where they are</p>
      <p>Viki, a play on the words <q>video</q> and <q>wiki,</q> is a global TV site powered by a volunteer community of avid fans. Launched in December 2010, Viki now has tens of millions of users every month watching and sharing TV shows, movies, music videos and other premium content from around the world, translated into more than 160 languages.</p>
      <p>With over 2 billion video streams and more than 400 million words translated to date, Viki uniquely brings global prime-time entertainment to new audiences and unlocks new markets and revenue opportunities for content owners; thousands of hours of video from content providers like NBC, BBC, KBS, SBS, TV Tokyo and <a href="/partners" title="Viki Partners">many others</a>.</p>
    </article>
    <article>
      <p class="summary strong">By the fans, for the fans</p>
      <p>Viki is the first and fastest platform for real-time subtitling and sharing of video -- from Korean and Turkish dramas to Japanese Anime and music videos by well-known artists. Community members subtitle their favorite videos into their preferred languages under a Creative Commons license using Viki&#x27;s subtitling technology, which enables thousands of fans around the world to collaborate in dozens of languages at once.</p>
      <p>
        In addition to watching on viki.com, viewers can access their favorite shows on any <a href="/apps" title="Get Viki on Mobile">web-enabled phone or tablet</a>,
        including iPhone, iPad, Blackberry and Android-powered smartphones and tablets, as well as <a href="/apps" title="Get Viki on connected TVs">connected TVs</a>, including Samsung Smart TV and Google TV. Viki also syndicates select programs with fan-generated subtitles to partners such as Hulu, Netflix, Amazon.com, MSN and Renren in China.
      </p>
      <header class="section-header bbs ptl mbl">
        <h2>The Team Behind Viki</h2>
      </header>
      <p>Viki was born as a joint class project between Harvard and Stanford graduate students who wanted to remove barriers to popular entertainment, regardless of language or country of origin. Today, our team is as diverse as Viki itself -- entrepreneurs, technologists and pop-culture fans from Canada, China, Egypt, England, Hungary, India, Indonesia, Japan, Korea, Mongolia, Philippines, Singapore, Spain, Taiwan, Thailand, Ukraine, Venezuela, Vietnam and the United States.</p>
      <blockquote class="quotebox">
        <p>
          <q>We share a passion for discovering and enjoying great content from around the world and building communities of like-minded people.</q>
        </p>
      </blockquote>
      <p>Viki is backed by leading venture firms Greylock Partners, Andreessen Horowitz, Charles River Ventures and Neoteny Labs, among others, as well as strategic investors SK Planet (a subsidiary of SK Telecom) and BBC Worldwide.</p>
      <p>Viki has offices in San Francisco, Singapore and Seoul.</p>
    </article>
  </div>
  ...
  <div class="unit size7 offset1">
    <aside class="mlm mtm">
      <div class="mod mod-well mod-well-info align-center hidden" data-viewable="non-logged-in">
        <h3 class="epsilon otro mtn">Ready for some serious fun?</h3>
        <a href="/sign_up" class="btn btn-flat btn-secondary btn-large btn-block caps">Sign Up Now</a>
      </div>

      <div class="mod">
        <div class="mod-hd">
          <h3 class="nekto">How to reach us</h3>
        </div>
        <div class="mod-bd">
          <ul>
            <li>Partners: <a href="mailto:partners@viki.com" title="partners@viki.com">partners@viki.com</a></li>
            <li>Press: <a href="mailto:press@viki.com" title="press@viki.com">press@viki.com</a></li>
            <li>Advertisers: <a href="mailto:advertise@viki.com" title="advertise@viki.com">advertise@viki.com</a></li>
            <li>Community support: <a href="mailto:help@viki.com" title="@viki.com">help@viki.com</a></li>
            <li>Career opportunities: <a href="mailto:jobs@viki.com" title="jobs@viki.com">jobs@viki.com</a></li>
            <li>General: <a href="mailto:info@viki.com" title="info@viki.com">info@viki.com</a></li>
          </ul>
        </div>
      </div>
      ...
      <div class="mod">
        <div class="mod-hd">
          <h3 class="nekto">Questions?</h3>
        </div>
        <div class="mod-bd">
          <p>If you can't find what you're looking for, please visit our <a href="http://support.viki.com/home" title="Viki Help Center">Help Center</a>.</p>
        </div>
      </div>
    </aside>
  </div>
  ...
  <div class="container">
    ...
    <div class="colophon-links pull-right">
      ...
      <a href="/about?locale=en" class="first-child muted" rel="nofollow" title="English">
        <i class="img-flag-us"></i> English
</a>      <a href="/about?locale=es" class="muted" rel="nofollow" title="Español">
...
<div id="data-modal-qc-vikipass" class="modal modal-subscription invisible">
  ...
  <script type="text/javascript">
    ...
    window.cur_a = "static_pages_about";
