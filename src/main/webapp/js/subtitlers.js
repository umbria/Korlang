!function (window100, undefinede) {
    ...
    function s(t, i, n, s) {
        if (le.acceptData(t)) {
            var r, o, a = le.expando, l = "string" == typeof i, u = t.nodeType, c = u ? le.cache : t, h = u ? t[a] : t[a] && a;
            if (h && c[h] && (s || c[h].data) || !l || n !== undefinede)return h || (u ? t[a] = h = Z.pop() || le.guid++ : h = a), c[h] || (c[h] = {}, u || (c[h].toJSON = le.noop)), ("object" == typeof i || "function" == typeof i) && (s ? c[h] = le.extend(c[h], i) : c[h].data = le.extend(c[h].data, i)), r = c[h], s || (r.data || (r.data = {}), r = r.data), n !== undefinede && (r[le.camelCase(i)] = n), l ? (o = r[i], null == o && (o = r[le.camelCase(i)])) : o = r, o
        }
    }

    function r(t, e, i) {
        if (le.acceptData(t)) {
            var n, s, r, o = t.nodeType, l = o ? le.cache : t, u = o ? t[le.expando] : le.expando;
            if (l[u]) {
    ...
    function d(t) {
        var e = Ue.split("|"), i = t.createDocumentFragment();
    ...
    function v(t, e) {
        if (1 === e.nodeType && le.hasData(t)) {
            var i, n, s, r = le._data(t), o = le._data(e, r), a = r.events;
            if (a) {
                delete o.handle, o.events = {};
                for (i in a)for (n = 0, s = a[i].length; s > n; n++)le.event.add(e, i, a[i][n])
            }
    ...
    function _(t, i) {
        var n, s, r = 0, o = typeof t.getElementsByTagName !== K ? t.getElementsByTagName(i || "*") : typeof t.querySelectorAll !== K ? t.querySelectorAll(i || "*") : undefinede;
        if (!o)for (o = [], n = t.childNodes || t; null != (s = n[r]); r++)!i || le.nodeName(s, i) ? o.push(s) : le.merge(o, _(s, i));
        return i === undefinede || i && le.nodeName(t, i) ? le.merge([t], o) : o
    }
    ...
    function w(t, e) {
        if (e in t)return e;
        for (var i = e.charAt(0).toUpperCase() + e.slice(1), n = e, s = Ci.length; s--;)if (e = Ci[s] + i, e in t)return e;
        return n
    }
    ...
    function S(t, e, i) {
        var n = !0, s = "width" === e ? t.offsetWidth : t.offsetHeight, r = ci(t), o = le.support.boxSizing && "border-box" === le.css(t, "boxSizing", !1, r);
        if (0 >= s || null == s) {
    ...
    function D(t, e, i, n) {
        ...
        }); else if (i || "object" !== le.type(e))n(t, e); else for (s in e)D(t + "[" + s + "]", e[s], i, n)
    }

    function I(t) {
        return function (e, i) {
            "string" != typeof e && (i = e, e = "*");
            var n, s = 0, r = e.toLowerCase().match(ce) || [];
            if (le.isFunction(i))for (; n = r[s++];)"+" === n[0] ? (n = n.slice(1) || "*", (t[n] = t[n] || []).unshift(i)) : (t[n] = t[n] || []).push(i)
        }
    }
    ...
    function A(t, i) {
        ...
        for (s in i)i[s] !== undefinede && ((r[s] ? t : n || (n = {}))[s] = i[s]);
        return n && le.extend(!0, t, n), t
    }

    function N(t, i, n) {
        var s, r, o, a, l = t.contents, u = t.dataTypes, c = t.responseFields;
        for (a in c)a in n && (i[c[a]] = n[a]);
        for (; "*" === u[0];)u.shift(), r === undefinede && (r = t.mimeType || i.getResponseHeader("Content-Type"));
    ...
    function V(t, e) {
        var i, n, s, r, o = {}, a = 0, l = t.dataTypes.slice(), u = l[0];
        if (t.dataFilter && (e = t.dataFilter(e, t.dataType)), l[1])for (s in t.converters)o[s.toLowerCase()] = t.converters[s];
        for (; n = l[++a];)if ("*" !== n) {
            if ("*" !== u && u !== n) {
                if (s = o[u + " " + n] || o["* " + n], !s)for (i in o)if (r = i.split(" "), r[1] === n && (s = o[u + " " + r[0]] || o["* " + r[0]])) {
                ...
                if (s !== !0)if (s && t["throws"])e = s(e); else try {
                    ...
                    return{state: "parsererror", error: s ? c : "No conversion from " + u + " to " + n}
                }
            }
            u = n
        }
    ...
    function j() {
        try {
            return new window100.XMLHttpRequest
        } catch (e) {
        }
    }
    ...
    function $() {
        try {
            return new window100.ActiveXObject("Microsoft.XMLHTTP")
        } catch (e) {
        }
    }
    ...
    function F(t, e) {
        le.each(e, function (e, i) {
            for (var n = (rn[e] || []).concat(rn["*"]), s = 0, r = n.length; r > s; s++)if (n[s].call(t, e, i))return
        })
    }

    function H(t, e, i) {
        var n, s, r = 0, o = sn.length, a = le.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (s)return!1;
            for (var e = Ji || O(), i = Math.max(0, u.startTime + u.duration - e), n = i / u.duration || 0, r = 1 - n, o = 0, l = u.tweens.length; l > o; o++)u.tweens[o].run(r);
            return a.notifyWith(t, [u, r, i]), 1 > r && l ? i : (a.resolveWith(t, [u]), !1)
        }, u = a.promise({elem: t, props: le.extend({}, e), opts: le.extend(!0, {specialEasing: {}}, i), originalProperties: e, originalOptions: i, startTime: Ji || O(), duration: i.duration, tweens: [], createTween: function (e, i) {
        ...
        for (L(c, u.opts.specialEasing); o > r; r++)if (n = sn[r].call(u, t, c, u.opts))return n;
        return F(u, c), le.isFunction(u.opts.start) && u.opts.start.call(t, u), le.fx.timer(le.extend(l, {elem: t, anim: u, queue: u.opts.queue})), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always)
    }

    function L(t, e) {
        var i, n, s, r, o;
        for (s in t)if (n = le.camelCase(s), r = e[n], i = t[s], le.isArray(i) && (r = i[1], i = t[s] = i[0]), s !== n && (t[n] = i, delete t[s]), o = le.cssHooks[n], o && "expand"in o) {
    ...
    function B(t, e, i) {
        var n, s, r, o, a, l, u, c, h, d = this, p = t.style, f = {}, m = [], g = t.nodeType && x(t);
    ...
    var q, U, K = typeof undefinede, Y = window100.document, X = window100.location, G = window100.jQuery, Q = window100.$, J = {}, Z = [], te = "1.9.1", ee = Z.concat, ie = Z.push, ne = Z.slice, se = Z.indexOf, re = J.toString, oe = J.hasOwnProperty, ae = te.trim, le = function (t, e) {
        return new le.fn.init(t, e, U)
    }, ue = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, ce = /\S+/g, he = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, de = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, pe = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, fe = /^[\],:{}\s]*$/, me = /(?:^|:|,)(?:\s*\[)+/g, ge = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, ve = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, ye = /^-ms-/, _e = /-([\da-z])/gi, be = function (t, e) {
        return e.toUpperCase()
    }, we = function (t) {
        (Y.addEventListener || "load" === t.type || "complete" === Y.readyState) && (xe(), le.ready())
    }, xe = function () {
        Y.addEventListener ? (Y.removeEventListener("DOMContentLoaded", we, !1), window100.removeEventListener("load", we, !1)) : (Y.detachEvent("onreadystatechange", we), window100.detachEvent("onload", we))
    };
    le.fn = le.prototype = {jquery: te, constructor: le, init: function (t, i, n) {
        var s, r;
        if (!t)return this;
        if ("string" == typeof t) {
            ...
            if (s[1]) {
                if (i = i instanceof le ? i[0] : i, le.merge(this, le.parseHTML(s[1], i && i.nodeType ? i.ownerDocument || i : Y, !0)), pe.test(s[1]) && le.isPlainObject(i))for (s in i)le.isFunction(this[s]) ? this[s](i[s]) : this.attr(s, i[s]);
                return this
            }
        ...
        return t.nodeType ? (this.context = this[0] = t, this.length = 1, this) : le.isFunction(t) ? n.ready(t) : (t.selector !== undefinede && (this.selector = t.selector, this.context = t.context), le.makeArray(t, this))
    ...
    }, push: ie, sort: [].sort, splice: [].splice}, le.fn.init.prototype = le.fn, le.extend = le.fn.extend = function () {
        var t, i, n, s, r, o, a = arguments[0] || {}, l = 1, u = arguments.length, c = !1;
        for ("boolean" == typeof a && (c = a, a = arguments[1] || {}, l = 2), "object" == typeof a || le.isFunction(a) || (a = {}), u === l && (a = this, --l); u > l; l++)if (null != (r = arguments[l]))for (s in r)t = a[s], n = r[s], a !== n && (c && n && (le.isPlainObject(n) || (i = le.isArray(n))) ? (i ? (i = !1, o = t && le.isArray(t) ? t : []) : o = t && le.isPlainObject(t) ? t : {}, a[s] = le.extend(c, o, n)) : n !== undefinede && (a[s] = n));
        return a
    }, le.extend({noConflict: function (e) {
        return window100.$ === le && (window100.$ = Q), e && window100.jQuery === le && (window100.jQuery = G), le
        ...
        var n;
        for (n in t);
        return n === undefinede || oe.call(t, n)
        ...
        return window100.JSON && window100.JSON.parse ? window100.JSON.parse(e) : null === e ? e : "string" == typeof e && (e = le.trim(e), e && fe.test(e.replace(ge, "@").replace(ve, "]").replace(me, ""))) ? new Function("return " + e)() : (le.error("Invalid JSON: " + e), void 0)
    }, parseXML: function (i) {
        var n, s;
        if (!i || "string" != typeof i)return null;
        try {
            window100.DOMParser ? (s = new DOMParser, n = s.parseFromString(i, "text/xml")) : (n = new ActiveXObject("Microsoft.XMLDOM"), n.async = "false", n.loadXML(i))
        } catch (r) {
            n = undefinede
        }
        ...
        e && le.trim(e) && (window100.execScript || function (e) {
            window100.eval.call(window100, e)
        })(e)
        ...
        return t
    }, trim: ae && !ae.call("ï»¿Â ") ? function (t) {
        ...
        if ("number" == typeof n)for (; n > r; r++)t[s++] = i[r]; else for (; i[r] !== undefinede;)t[s++] = i[r++];
        return t.length = s, t
    }, grep: function (t, e, i) {
        ...
        }, s.guid = t.guid = t.guid || le.guid++, s) : undefinede
    }, access: function (t, i, n, s, r, o, a) {
        var l = 0, u = t.length, c = null == n;
        if ("object" === le.type(n)) {
            r = !0;
            for (l in n)le.access(t, i, l, n[l], !0, o, a)
        } else if (s !== undefinede && (r = !0, le.isFunction(s) || (a = !0), c && (a ? (i.call(t, s), i = null) : (c = i, i = function (t, e, i) {
            return c.call(le(t), i)
        })), i))for (; u > l; l++)i(t[l], n, a ? s : s.call(t[l], l, i(t[l], n)));
        return r ? t : c ? i.call(t) : u ? i(t[0], n) : o
    }, now: function () {
        return(new Date).getTime()
    }}), le.ready.promise = function (e) {
        if (!q)if (q = le.Deferred(), "complete" === Y.readyState)setTimeout(le.ready); else if (Y.addEventListener)Y.addEventListener("DOMContentLoaded", we, !1), window100.addEventListener("load", we, !1); else {
            Y.attachEvent("onreadystatechange", we), window100.attachEvent("onload", we);
            var i = !1;
            try {
                i = null == window100.frameElement && Y.documentElement
            } catch (n) {
            }
    ...
    le.Callbacks = function (t) {
        ...
        var i, s, r, o, a, l, u = [], c = !t.once && [], h = function (e) {
            for (s = t.memory && e, r = !0, a = l || 0, l = 0, o = u.length, i = !0; u && o > a; a++)if (u[a].apply(e[0], e[1]) === !1 && t.stopOnFalse) {
                s = !1;
                break
            }
            ...
            return u && le.each(arguments, function (t, e) {
                for (var n; (n = le.inArray(e, u, n)) > -1;)u.splice(n, 1), i && (o >= n && o--, a >= n && a--)
            }), this
        }, has: function (t) {
            ...
            return u = c = s = undefinede, this
        }, disabled: function () {
            return!u
        }, lock: function () {
            return c = undefinede, s || d.disable(), this
        }, locked: function () {
            return!c
        ...
        var e = [
            ...
            return le.Deferred(function (i) {
                le.each(e, function (e, r) {
                    var o = r[0], a = le.isFunction(t[e]) && t[e];
                    s[r[1]](function () {
        ...
        var e, i, n, s = 0, r = ne.call(arguments), o = r.length, a = 1 !== o || t && le.isFunction(t.promise) ? o : 0, l = 1 === a ? t : le.Deferred(), u = function (t, i, n) {
            return function (s) {
                i[t] = this, n[t] = arguments.length > 1 ? ne.call(arguments) : s, n === e ? l.notifyWith(i, n) : --a || l.resolveWith(i, n)
            }
        };
        if (o > 1)for (e = new Array(o), i = new Array(o), n = new Array(o); o > s; s++)r[s] && le.isFunction(r[s].promise) ? r[s].promise().done(u(s, n, r)).fail(l.reject).progress(u(s, i, e)) : --a;
        return a || l.resolveWith(n, r), l.promise()
    }}), le.support = function () {
        var e, i, n, s, r, o, a, l, u, c, h = Y.createElement("div");
        if (h.setAttribute("className", "window100"), h.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", i = h.getElementsByTagName("*"), n = h.getElementsByTagName("a")[0], !i || !n || !i.length)return{};
        r = Y.createElement("select"), a = r.appendChild(Y.createElement("option")), s = h.getElementsByTagName("input")[0], n.style.cssText = "top:1px;float:left;opacity:.5", e = {getSetAttribute: "window100" !== h.className, leadingWhitespace: 3 === h.firstChild.nodeType, tbody: !h.getElementsByTagName("tbody").length, htmlSerialize: !!h.getElementsByTagName("link").length, style: /top/.test(n.getAttribute("style")), hrefNormalized: "/a" === n.getAttribute("href"), opacity: /^0.5/.test(n.style.opacity), cssFloat: !!n.style.cssFloat, checkOn: !!s.value, optSelected: a.selected, enctype: !!Y.createElement("form").enctype, html5Clone: "<:nav></:nav>" !== Y.createElement("nav").cloneNode(!0).outerHTML, boxModel: "CSS1Compat" === Y.compatMode, deleteExpando: !0, noCloneEvent: !0, inlineBlockNeedsLayout: !1, shrinkWrapBlocks: !1, reliableMarginRight: !0, boxSizingReliable: !0, pixelPosition: !1}, s.checked = !0, e.noCloneChecked = s.cloneNode(!0).checked, r.disabled = !0, e.optDisabled = !a.disabled;
        try {
            delete h.test
        } catch (d) {
            e.deleteExpando = !1
        }
        s = Y.createElement("input"), s.setAttribute("value", ""), e.input = "" === s.getAttribute("value"), s.value = "window100", s.setAttribute("type", "radio"), e.radioValue = "window100" === s.value, s.setAttribute("checked", "window100"), s.setAttribute("name", "window100"), o = Y.createDocumentFragment(), o.appendChild(s), e.appendChecked = s.checked, e.checkClone = o.cloneNode(!0).cloneNode(!0).lastChild.checked, h.attachEvent && (h.attachEvent("onclick", function () {
            e.noCloneEvent = !1
        }), h.cloneNode(!0).click());
        for (c in{submit: !0, change: !0, focusin: !0})h.setAttribute(l = "on" + c, "window100"), e[c + "Bubbles"] = l in window100 || h.attributes[l].expando === !1;
        return h.style.backgroundClip = "content-box", h.cloneNode(!0).style.backgroundClip = "", e.clearCloneStyle = "content-box" === h.style.backgroundClip, le(function () {
            var i, n, s, r = "padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;", o = Y.getElementsByTagName("body")[0];
            o && (i = Y.createElement("div"), i.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", o.appendChild(i).appendChild(h), h.innerHTML = "<table><tr><td></td><td>window100</td></tr></table>", s = h.getElementsByTagName("td"), s[0].style.cssText = "padding:0;margin:0;border:0;display:none", u = 0 === s[0].offsetHeight, s[0].style.display = "", s[1].style.display = "none", e.reliableHiddenOffsets = u && 0 === s[0].offsetHeight, h.innerHTML = "", h.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", e.boxSizing = 4 === h.offsetWidth, e.doesNotIncludeMarginInBodyOffset = 1 !== o.offsetTop, window100.getComputedStyle && (e.pixelPosition = "1%" !== (window100.getComputedStyle(h, null) || {}).top, e.boxSizingReliable = "4px" === (window100.getComputedStyle(h, null) || {width: "4px"}).width, n = h.appendChild(Y.createElement("div")), n.style.cssText = h.style.cssText = r, n.style.marginRight = n.style.width = "0", h.style.width = "1px", e.reliableMarginRight = !parseFloat((window100.getComputedStyle(n, null) || {}).marginRight)), typeof h.style.zoom !== K && (h.innerHTML = "", h.style.cssText = r + "width:1px;padding:1px;display:inline;zoom:1", e.inlineBlockNeedsLayout = 3 === h.offsetWidth, h.style.display = "block", h.innerHTML = "<div></div>", h.firstChild.style.width = "5px", e.shrinkWrapBlocks = 3 !== h.offsetWidth, e.inlineBlockNeedsLayout && (o.style.zoom = 1)), o.removeChild(i), i = h = s = n = null)
        }), i = r = o = a = n = s = null, e
    }();
    var Ce = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/, Te = /([A-Z])/g;
    le.extend({cache: {}, expando: "jQuery" + (te + Math.random()).replace(/\D/g, ""), noData: {embed: !0, object: "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000", applet: !0}, hasData: function (t) {
    ...
    }}), le.fn.extend({data: function (t, i) {
        ...
        return"object" == typeof t ? this.each(function () {
            ...
            return i === undefinede ? r ? o(r, t, le.data(r, t)) : null : (this.each(function () {
                le.data(this, t, i)
            }), void 0)
    ...
    }}), le.extend({queue: function (t, e, i) {
        var n;
        return t ? (e = (e || "fx") + "queue", n = le._data(t, e), i && (!n || le.isArray(i) ? n = le._data(t, e, le.makeArray(i)) : n.push(i)), n || []) : void 0
    }, dequeue: function (t, e) {
        e = e || "fx";
        var i = le.queue(t, e), n = i.length, s = i.shift(), r = le._queueHooks(t, e), o = function () {
            le.dequeue(t, e)
        };
        "inprogress" === s && (s = i.shift(), n--), r.cur = s, s && ("fx" === e && i.unshift("inprogress"), delete r.stop, s.call(t, o, r)), !n && r && r.empty.fire()
    }, _queueHooks: function (t, e) {
        var i = e + "queueHooks";
        return le._data(t, i) || le._data(t, i, {empty: le.Callbacks("once memory").add(function () {
            le._removeData(t, e + "queue"), le._removeData(t, i)
        })})
    }}), le.fn.extend({queue: function (t, i) {
        var n = 2;
        return"string" != typeof t && (i = t, t = "fx", n--), arguments.length < n ? le.queue(this[0], t) : i === undefinede ? this : this.each(function () {
        ...
        var n, s = 1, r = le.Deferred(), o = this, a = this.length, l = function () {
            --s || r.resolveWith(o, [o])
        };
        for ("string" != typeof t && (i = t, t = undefinede), t = t || "fx"; a--;)n = le._data(o[a], t + "queueHooks"), n && n.empty && (s++, n.empty.add(l));
        return l(), r.promise(i)
    }});
    var Se, Ee, Pe = /[\t\r\n]/g, De = /\r/g, Ie = /^(?:input|select|textarea|button|object)$/i, Me = /^(?:a|area)$/i, Ae = /^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i, Ne = /^(?:checked|selected)$/i, Ve = le.support.getSetAttribute, je = le.support.input;
    le.fn.extend({attr: function (t, e) {
        ...
        return t = le.propFix[t] || t, this.each(function () {
            try {
                this[t] = undefinede, delete this[t]
            } catch (i) {
            }
        })
    }, addClass: function (t) {
        ...
        if (l)for (e = (t || "").match(ce) || []; a > o; o++)if (i = this[o], n = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(Pe, " ") : " ")) {
        ...
        return le.isFunction(t) ? this.each(function (i) {
            ...
            if ("string" === i)for (var s, r = 0, o = le(this), a = e, l = t.match(ce) || []; s = l[r++];)a = n ? a : !o.hasClass(s), o[a ? "addClass" : "removeClass"](s); else(i === K || "boolean" === i) && (this.className && le._data(this, "__className__", this.className), this.className = this.className || t === !1 ? "" : le._data(this, "__className__") || "")
        })
    }, hasClass: function (t) {
        ...
        var i, n, s, r = this[0];
        {
            if (arguments.length)return s = le.isFunction(t), this.each(function (i) {
                ...
                1 === this.nodeType && (r = s ? t.call(this, i, o.val()) : t, null == r ? r = "" : "number" == typeof r ? r += "" : le.isArray(r) && (r = le.map(r, function (t) {
                    return null == t ? "" : t + ""
                })), n = le.valHooks[this.type] || le.valHooks[this.nodeName.toLowerCase()], n && "set"in n && n.set(this, r, "value") !== undefinede || (this.value = r))
            });
            if (r)return n = le.valHooks[r.type] || le.valHooks[r.nodeName.toLowerCase()], n && "get"in n && (i = n.get(r, "value")) !== undefinede ? i : (i = r.value, "string" == typeof i ? i.replace(De, "") : null == i ? "" : i)
        }
    }}), le.extend({valHooks: {option: {get: function (t) {
        var e = t.attributes.value;
        return!e || e.specified ? t.value : t.text
    }}, select: {get: function (t) {
        for (var e, i, n = t.options, s = t.selectedIndex, r = "select-one" === t.type || 0 > s, o = r ? null : [], a = r ? s + 1 : n.length, l = 0 > s ? a : r ? s : 0; a > l; l++)if (i = n[l], !(!i.selected && l !== s || (le.support.optDisabled ? i.disabled : null !== i.getAttribute("disabled")) || i.parentNode.disabled && le.nodeName(i.parentNode, "optgroup"))) {
        ...
        if (t && 3 !== a && 8 !== a && 2 !== a)return typeof t.getAttribute === K ? le.prop(t, i, n) : (r = 1 !== a || !le.isXMLDoc(t), r && (i = i.toLowerCase(), s = le.attrHooks[i] || (Ae.test(i) ? Ee : Se)), n === undefinede ? s && r && "get"in s && null !== (o = s.get(t, i)) ? o : (typeof t.getAttribute !== K && (o = t.getAttribute(i)), null == o ? undefinede : o) : null !== n ? s && r && "set"in s && (o = s.set(t, n, i)) !== undefinede ? o : (t.setAttribute(i, n + ""), n) : (le.removeAttr(t, i), void 0))
    }, removeAttr: function (t, e) {
        var i, n, s = 0, r = e && e.match(ce);
        if (r && 1 === t.nodeType)for (; i = r[s++];)n = le.propFix[i] || i, Ae.test(i) ? !Ve && Ne.test(i) ? t[le.camelCase("default-" + i)] = t[n] = !1 : t[n] = !1 : le.attr(t, i, ""), t.removeAttribute(Ve ? i : n)
    }, attrHooks: {type: {set: function (t, e) {
        if (!le.support.radioValue && "radio" === e && le.nodeName(t, "input")) {
            var i = t.value;
            return t.setAttribute("type", e), i && (t.value = i), e
        }
    }}}, propFix: {tabindex: "tabIndex", readonly: "readOnly", "for": "htmlFor", "class": "className", maxlength: "maxLength", cellspacing: "cellSpacing", cellpadding: "cellPadding", rowspan: "rowSpan", colspan: "colSpan", usemap: "useMap", frameborder: "frameBorder", contenteditable: "contentEditable"}, prop: function (t, i, n) {
        var s, r, o, a = t.nodeType;
        if (t && 3 !== a && 8 !== a && 2 !== a)return o = 1 !== a || !le.isXMLDoc(t), o && (i = le.propFix[i] || i, r = le.propHooks[i]), n !== undefinede ? r && "set"in r && (s = r.set(t, n, i)) !== undefinede ? s : t[i] = n : r && "get"in r && null !== (s = r.get(t, i)) ? s : t[i]
    }, propHooks: {tabIndex: {get: function (t) {
        var i = t.getAttributeNode("tabindex");
        return i && i.specified ? parseInt(i.value, 10) : Ie.test(t.nodeName) || Me.test(t.nodeName) && t.href ? 0 : undefinede
    }}}}), Ee = {get: function (t, i) {
        var n = le.prop(t, i), s = "boolean" == typeof n && t.getAttribute(i), r = "boolean" == typeof n ? je && Ve ? null != s : Ne.test(i) ? t[le.camelCase("default-" + i)] : !!s : t.getAttributeNode(i);
        return r && r.value !== !1 ? i.toLowerCase() : undefinede
    }, set: function (t, e, i) {
        return e === !1 ? le.removeAttr(t, i) : je && Ve || !Ne.test(i) ? t.setAttribute(!Ve && le.propFix[i] || i, i) : t[le.camelCase("default-" + i)] = t[i] = !0, i
    }}, je && Ve || (le.attrHooks.value = {get: function (t, i) {
        var n = t.getAttributeNode(i);
        return le.nodeName(t, "input") ? t.defaultValue : n && n.specified ? n.value : undefinede
    }, set: function (t, e, i) {
        return le.nodeName(t, "input") ? (t.defaultValue = e, void 0) : Se && Se.set(t, e, i)
    }}), Ve || (Se = le.valHooks.button = {get: function (t, i) {
        var n = t.getAttributeNode(i);
        return n && ("id" === i || "name" === i || "coords" === i ? "" !== n.value : n.specified) ? n.value : undefinede
    }, set: function (t, i, n) {
        var s = t.getAttributeNode(n);
        return s || t.setAttributeNode(s = t.ownerDocument.createAttribute(n)), s.value = i += "", "value" === n || i === t.getAttribute(n) ? i : undefinede
    }}, le.attrHooks.contenteditable = {get: Se.get, set: function (t, e, i) {
        Se.set(t, "" === e ? !1 : e, i)
    }}, le.each(["width", "height"], function (t, e) {
        le.attrHooks[e] = le.extend(le.attrHooks[e], {set: function (t, i) {
            return"" === i ? (t.setAttribute(e, "auto"), i) : void 0
        }})
    })), le.support.hrefNormalized || (le.each(["href", "src", "width", "height"], function (t, i) {
        le.attrHooks[i] = le.extend(le.attrHooks[i], {get: function (t) {
            var n = t.getAttribute(i, 2);
            return null == n ? undefinede : n
        }})
    }), le.each(["href", "src"], function (t, e) {
        le.propHooks[e] = {get: function (t) {
            return t.getAttribute(e, 4)
        }}
    })), le.support.style || (le.attrHooks.style = {get: function (t) {
        return t.style.cssText || undefinede
    }, set: function (t, e) {
        return t.style.cssText = e + ""
    }}), le.support.optSelected || (le.propHooks.selected = le.extend(le.propHooks.selected, {get: function (t) {
        var e = t.parentNode;
        return e && (e.selectedIndex, e.parentNode && e.parentNode.selectedIndex), null
    }})), le.support.enctype || (le.propFix.enctype = "encoding"), le.support.checkOn || le.each(["radio", "checkbox"], function () {
        le.valHooks[this] = {get: function (t) {
            return null === t.getAttribute("value") ? "on" : t.value
        }}
    }), le.each(["radio", "checkbox"], function () {
        le.valHooks[this] = le.extend(le.valHooks[this], {set: function (t, e) {
            return le.isArray(e) ? t.checked = le.inArray(le(t).val(), e) >= 0 : void 0
        }})
    });
    var $e = /^(?:input|select|textarea)$/i, Oe = /^key/, Fe = /^(?:mouse|contextmenu)|click/, He = /^(?:focusinfocus|focusoutblur)$/, Le = /^([^.]*)(?:\.(.+)|)$/;
    le.event = {global: {}, add: function (t, i, n, s, r) {
        ...
        if (v) {
            for (n.handler && (u = n, n = u.handler, r = u.selector), n.guid || (n.guid = le.guid++), (a = v.events) || (a = v.events = {}), (h = v.handle) || (h = v.handle = function (t) {
                return typeof le === K || t && le.event.triggered === t.type ? undefinede : le.event.dispatch.apply(h.elem, arguments)
            }, h.elem = t), i = (i || "").match(ce) || [""], l = i.length; l--;)o = Le.exec(i[l]) || [], f = g = o[1], m = (o[2] || "").split(".").sort(), c = le.event.special[f] || {}, f = (r ? c.delegateType : c.bindType) || f, c = le.event.special[f] || {}, d = le.extend({type: f, origType: g, data: s, handler: n, guid: n.guid, selector: r, needsContext: r && le.expr.match.needsContext.test(r), namespace: m.join(".")}, u), (p = a[f]) || (p = a[f] = [], p.delegateCount = 0, c.setup && c.setup.call(t, s, m, h) !== !1 || (t.addEventListener ? t.addEventListener(f, h, !1) : t.attachEvent && t.attachEvent("on" + f, h))), c.add && (c.add.call(t, d), d.handler.guid || (d.handler.guid = n.guid)), r ? p.splice(p.delegateCount++, 0, d) : p.push(d), le.event.global[f] = !0;
            t = null
        }
    }, remove: function (t, e, i, n, s) {
        var r, o, a, l, u, c, h, d, p, f, m, g = le.hasData(t) && le._data(t);
        if (g && (c = g.events)) {
            for (e = (e || "").match(ce) || [""], u = e.length; u--;)if (a = Le.exec(e[u]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p) {
            ...
            } else for (p in c)le.event.remove(t, p + e[u], i, n, !0);
            le.isEmptyObject(c) && (delete g.handle, le._removeData(t, "events"))
        }
    }, trigger: function (i, n, s, r) {
        var o, a, l, u, c, h, d, p = [s || Y], f = oe.call(i, "type") ? i.type : i, m = oe.call(i, "namespace") ? i.namespace.split(".") : [];
        if (l = h = s = s || Y, 3 !== s.nodeType && 8 !== s.nodeType && !He.test(f + le.event.triggered) && (f.indexOf(".") >= 0 && (m = f.split("."), f = m.shift(), m.sort()), a = f.indexOf(":") < 0 && "on" + f, i = i[le.expando] ? i : new le.Event(f, "object" == typeof i && i), i.isTrigger = !0, i.namespace = m.join("."), i.namespace_re = i.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, i.result = undefinede, i.target || (i.target = s), n = null == n ? [i] : le.makeArray(n, [i]), c = le.event.special[f] || {}, r || !c.trigger || c.trigger.apply(s, n) !== !1)) {
            if (!r && !c.noBubble && !le.isWindow(s)) {
                for (u = c.delegateType || f, He.test(u + f) || (l = l.parentNode); l; l = l.parentNode)p.push(l), h = l;
                h === (s.ownerDocument || Y) && p.push(h.defaultView || h.parentWindow || window100)
            }
            for (d = 0; (l = p[d++]) && !i.isPropagationStopped();)i.type = d > 1 ? u : c.bindType || f, o = (le._data(l, "events") || {})[i.type] && le._data(l, "handle"), o && o.apply(l, n), o = a && l[a], o && le.acceptData(l) && o.apply && o.apply(l, n) === !1 && i.preventDefault();
        ...
        for (o || (this.fixHooks[s] = o = Fe.test(s) ? this.mouseHooks : Oe.test(s) ? this.keyHooks : {}), n = o.props ? this.props.concat(o.props) : this.props, t = new le.Event(r), e = n.length; e--;)i = n[e], t[i] = r[i];
        ...
        return null == t.pageX && null != i.clientX && (s = t.target.ownerDocument || Y, r = s.documentElement, n = s.body, t.pageX = i.clientX + (r && r.scrollLeft || n && n.scrollLeft || 0) - (r && r.clientLeft || n && n.clientLeft || 0), t.pageY = i.clientY + (r && r.scrollTop || n && n.scrollTop || 0) - (r && r.clientTop || n && n.clientTop || 0)), !t.relatedTarget && a && (t.relatedTarget = a === t.target ? i.toElement : a), t.which || o === undefinede || (t.which = 1 & o ? 1 : 2 & o ? 3 : 4 & o ? 2 : 0), t
    ...
    }, delegateType: "focusout"}, beforeunload: {postDispatch: function (t) {
        t.result !== undefinede && (t.originalEvent.returnValue = t.result)
    }}}, simulate: function (t, e, i, n) {
        var s = le.extend(new le.Event, i, {type: t, isSimulated: !0, originalEvent: {}});
    ...
    }, le.Event.prototype = {isDefaultPrevented: u, isPropagationStopped: u, isImmediatePropagationStopped: u, preventDefault: function () {
    ...
    }}, le.each({mouseenter: "mouseover", mouseleave: "mouseout"}, function (t, e) {
        le.event.special[t] = {delegateType: e, bindType: e, handle: function (t) {
    ...
    }), le.support.submitBubbles || (le.event.special.submit = {setup: function () {
        return le.nodeName(this, "form") ? !1 : (le.event.add(this, "click._submit keypress._submit", function (t) {
            var i = t.target, n = le.nodeName(i, "input") || le.nodeName(i, "button") ? i.form : undefinede;
    ...
    }}), le.support.changeBubbles || (le.event.special.change = {setup: function () {
        return $e.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (le.event.add(this, "propertychange._change", function (t) {
            ...
            var e = t.target;
            $e.test(e.nodeName) && !le._data(e, "changeBubbles") && (le.event.add(e, "change._change", function (t) {
        ...
        return le.event.remove(this, "._change"), !$e.test(this.nodeName)
    }}), le.support.focusinBubbles || le.each({focus: "focusin", blur: "focusout"}, function (t, e) {
        var i = 0, n = function (t) {
            le.event.simulate(e, t.target, le.event.fix(t), !0)
        };
        le.event.special[e] = {setup: function () {
            0 === i++ && Y.addEventListener(t, n, !0)
        }, teardown: function () {
            0 === --i && Y.removeEventListener(t, n, !0)
        }}
    }), le.fn.extend({on: function (t, i, n, s, r) {
        var o, a;
        if ("object" == typeof t) {
            "string" != typeof i && (n = n || i, i = undefinede);
            for (o in t)this.on(o, i, n, t[o], r);
            return this
        }
        if (null == n && null == s ? (s = i, n = i = undefinede) : null == s && ("string" == typeof i ? (s = n, n = undefinede) : (s = n, n = i, i = undefinede)), s === !1)s = u; else if (!s)return this;
        ...
        return(i === !1 || "function" == typeof i) && (n = i, i = undefinede), n === !1 && (n = u), this.each(function () {
        ...
        function o(t, e, i, n) {
            ...
            if (!N && !n) {
                if (s = me.exec(t))if (o = s[1]) {
                    if (9 === a) {
                        if (r = e.getElementById(o), !r || !r.parentNode)return i;
                        if (r.id === o)return i.push(r), i
                    } else if (e.ownerDocument && (r = e.ownerDocument.getElementById(o)) && O(e, r) && r.id === o)return i.push(r), i
                } else {
        ...
        function a(t, e) {
            var i = e && t, n = i && (~e.sourceIndex || Y) - (~t.sourceIndex || Y);
            if (n)return n;
        ...
        function h(t, e) {
            ...
            for (a = t, l = [], u = C.preFilter; a;) {
                (!i || (n = ae.exec(a))) && (n && (a = a.slice(n[0].length) || a), l.push(s = [])), i = !1, (n = ue.exec(a)) && (i = n.shift(), s.push({value: i, type: n[0].replace(oe, " ")}), a = a.slice(i.length));
                for (r in C.filter)!(n = de[r].exec(a)) || u[r] && !(n = u[r](n)) || (i = n.shift(), s.push({value: i, type: r, matches: n}), a = a.slice(i.length));
                if (!i)break
            }
        ...
        function p(t, e, i) {
            var n = e.dir, s = i && "parentNode" === n, r = R++;
            return e.first ? function (e, i, r) {
                ...
                } else for (; e = e[n];)if (1 === e.nodeType || s)if (u = e[H] || (e[H] = {}), (l = u[n]) && l[0] === c) {
        ...
        function g(t, e, i, n, r, o) {
            return n && !n[H] && (n = g(n)), r && !r[H] && (r = g(r, o)), s(function (s, o, a, l) {
                var u, c, h, d = [], p = [], f = o.length, g = s || _(e || "*", a.nodeType ? [a] : a, []), v = !t || !s && e ? g : m(g, d, t, a, l), y = i ? r || (s ? t : f || n) ? [] : o : v;
                if (i && i(v, y, a, l), n)for (u = m(y, p), n(u, [], a, l), c = u.length; c--;)(h = u[c]) && (y[p[c]] = !(v[p[c]] = h));
                if (s) {
                    if (r || t) {
                        if (r) {
        ...
        function v(t) {
            ...
            }]; s > a; a++)if (i = C.relative[t[a].type])c = [p(f(c), i)]; else {
        ...
        function y(t, e) {
            var i = 0, n = e.length > 0, r = t.length > 0, a = function (s, a, l, u, c) {
                var h, d, p, f = [], g = 0, v = "0", y = s && [], _ = null != c, b = D, w = s || r && C.find.TAG("*", c && a.parentNode || a), x = z += null == b ? 1 : Math.random() || .1;
                ...
                if (g += v, n && v !== g) {
                    ...
                    if (s) {
                        if (g > 0)for (; v--;)y[v] || f[v] || (f[v] = G.call(u));
                        f = m(f)
                    }
        ...
        function b(t, e, i, n) {
            ...
            if (!n && 1 === u.length) {
                ...
                for (s = de.needsContext.test(t) ? 0 : r.length; s-- && (o = r[s], !C.relative[a = o.type]);)if ((l = C.find[a]) && (n = l(o.matches[0].replace(be, we), pe.test(r[0].type) && e.parentNode || e))) {
        ...
        S = o.isXML = function (t) {
            ...
            }, j = [], V = [":focus"], (B.qsa = i(n.querySelectorAll)) && (r(function (t) {
            ...
            })), (B.matchesSelector = i($ = A.matchesSelector || A.mozMatchesSelector || A.webkitMatchesSelector || A.oMatchesSelector || A.msMatchesSelector)) && r(function (t) {
                B.disconnectedMatch = $.call(t, "div"), $.call(t, "[s!='']:x"), j.push("!=", re)
            }), V = new RegExp(V.join("|")), j = new RegExp(j.join("|")), O = i(A.contains) || A.compareDocumentPosition ? function (t, e) {
                var i = 9 === t.nodeType ? t.documentElement : t, n = e && e.parentNode;
                return t === n || !(!n || 1 !== n.nodeType || !(i.contains ? i.contains(n) : t.compareDocumentPosition && 16 & t.compareDocumentPosition(n)))
            } : function (t, e) {
                if (e)for (; e = e.parentNode;)if (e === t)return!0;
                return!1
            }, F = A.compareDocumentPosition ? function (t, e) {
                var i;
                return t === e ? (P = !0, 0) : (i = e.compareDocumentPosition && t.compareDocumentPosition && t.compareDocumentPosition(e)) ? 1 & i || t.parentNode && 11 === t.parentNode.nodeType ? t === n || O(L, t) ? -1 : e === n || O(L, e) ? 1 : 0 : 4 & i ? -1 : 1 : t.compareDocumentPosition ? -1 : 1
            } : function (t, e) {
                var i, s = 0, r = t.parentNode, o = e.parentNode, l = [t], u = [e];
                if (t === e)return P = !0, 0;
            ...
            }, P = !1, [0, 0].sort(F), B.detectDuplicates = P, M) : M
        }, o.matches = function (t, e) {
            return o(t, null, null, e)
        }, o.matchesSelector = function (t, e) {
            if ((t.ownerDocument || t) !== M && I(t), e = e.replace(_e, "='$1']"), !(!B.matchesSelector || N || j && j.test(e) || V.test(e)))try {
                var i = $.call(t, e);
            ...
            return(t.ownerDocument || t) !== M && I(t), O(t, e)
        }, o.attr = function (t, e) {
            var i;
            ...
            var e, i = [], n = 1, s = 0;
            if (P = !B.detectDuplicates, t.sort(F), P) {
            ...
            return i
        }, C = o.selectors = {cacheLength: 50, createPseudo: s, match: de, find: {}, relative: {">": {dir: "parentNode", first: !0}, " ": {dir: "parentNode"}, "+": {dir: "previousSibling", first: !0}, "~": {dir: "previousSibling"}}, preFilter: {ATTR: function (t) {
            ...
            return 1 === n && 0 === s ? function (t) {
                ...
                var u, c, h, d, p, f, m = r !== o ? "nextSibling" : "previousSibling", g = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a;
                if (g) {
                    if (r) {
                        for (; m;) {
                    ...
                    if (f = [o ? g.firstChild : g.lastChild], o && y) {
                        for (c = g[H] || (g[H] = {}), u = c[t] || [], p = u[0] === z && u[1], d = u[0] === z && u[2], h = p && g.childNodes[p]; h = ++p && h && h[m] || (d = p = 0) || f.pop();)if (1 === h.nodeType && ++d && h === e) {
                            c[t] = [z, p, d];
                            break
                        }
                    } else if (y && (u = (e[H] || (e[H] = {}))[t]) && u[0] === z)d = u[1]; else for (; (h = ++p && h && h[m] || (d = p = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++d || (y && ((h[H] || (h[H] = {}))[t] = [z, d]), h !== e)););
        ...
        }}, pseudos: {not: s(function (t) {
            var e = [], i = [], n = E(t.replace(oe, "$1"));
            ...
            return he.test(t || "") || o.error("unsupported lang: " + t), t = t.replace(be, we).toLowerCase(), function (e) {
                var i;
                do if (i = N ? e.getAttribute("xml:lang") || e.getAttribute("lang") : e.lang)return i = i.toLowerCase(), i === t || 0 === i.indexOf(t + "-"); while ((e = e.parentNode) && 1 === e.nodeType);
                return!1
            }
        }), target: function (e) {
    ...
    var Be = /Until$/, ze = /^(?:parents|prev(?:Until|All))/, Re = /^.[^:#\[\.,]*$/, We = le.expr.match.needsContext, qe = {children: !0, contents: !0, next: !0, prev: !0};
    le.fn.extend({find: function (t) {
        var e, i, n, s = this.length;
        if ("string" != typeof t)return n = this, this.pushStack(le(t).filter(function () {
            for (e = 0; s > e; e++)if (le.contains(n[e], this))return!0
        }));
        ...
        for (var i, n = 0, s = this.length, r = [], o = We.test(t) || "string" != typeof t ? le(t, e || this.context) : 0; s > n; n++)for (i = this[n]; i && i.ownerDocument && i !== e && 11 !== i.nodeType;) {
    ...
    }}), le.fn.andSelf = le.fn.addBack, le.each({parent: function (t) {
        var e = t.parentNode;
    ...
    }), le.extend({filter: function (t, e, i) {
        return i && (t = ":not(" + t + ")"), 1 === e.length ? le.find.matchesSelector(e[0], t) ? [e[0]] : [] : le.find.matches(t, e)
    }, dir: function (t, i, n) {
        for (var s = [], r = t[i]; r && 9 !== r.nodeType && (n === undefinede || 1 !== r.nodeType || !le(r).is(n));)1 === r.nodeType && s.push(r), r = r[i];
        return s
    }, sibling: function (t, e) {
        for (var i = []; t; t = t.nextSibling)1 === t.nodeType && t !== e && i.push(t);
        return i
    }});
    var Ue = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", Ke = / jQuery\d+="(?:null|\d+)"/g, Ye = new RegExp("<(?:" + Ue + ")[\\s/>]", "i"), Xe = /^\s+/, Ge = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Qe = /<([\w:]+)/, Je = /<tbody/i, Ze = /<|&#?\w+;/, ti = /<(?:script|style|link)/i, ei = /^(?:checkbox|radio)$/i, ii = /checked\s*(?:[^=]|=\s*.checked.)/i, ni = /^$|\/(?:java|ecma)script/i, si = /^true\/(.*)/, ri = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, oi = {option: [1, "<select multiple='multiple'>", "</select>"], legend: [1, "<fieldset>", "</fieldset>"], area: [1, "<map>", "</map>"], param: [1, "<object>", "</object>"], thead: [1, "<table>", "</table>"], tr: [2, "<table><tbody>", "</tbody></table>"], col: [2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], _default: le.support.htmlSerialize ? [0, "", ""] : [1, "X<div>", "</div>"]}, ai = d(Y), li = ai.appendChild(Y.createElement("div"));
    oi.optgroup = oi.option, oi.tbody = oi.tfoot = oi.colgroup = oi.caption = oi.thead, oi.th = oi.td, le.fn.extend({text: function (t) {
        return le.access(this, function (t) {
            return t === undefinede ? le.text(this) : this.empty().append((this[0] && this[0].ownerDocument || Y).createTextNode(t))
        ...
        return le.access(this, function (t) {
            ...
            if (t === undefinede)return 1 === i.nodeType ? i.innerHTML.replace(Ke, "") : undefinede;
        ...
        t = ee.apply([], t);
        var s, r, o, a, l, u, c = 0, h = this.length, d = this, g = h - 1, v = t[0], y = le.isFunction(v);
        if (y || !(1 >= h || "string" != typeof v || le.support.checkClone) && ii.test(v))return this.each(function (s) {
            var r = d.eq(s);
            y && (t[0] = v.call(this, s, i ? r.html() : undefinede)), r.domManip(t, i, n)
        });
        if (h && (u = le.buildFragment(t, this[0].ownerDocument, !1, this), s = u.firstChild, 1 === u.childNodes.length && (u = s), s)) {
            ...
            if (o)for (l = a[a.length - 1].ownerDocument, le.map(a, m), c = 0; o > c; c++)r = a[c], ni.test(r.type || "") && !le._data(r, "globalEval") && le.contains(l, r) && (r.src ? le.ajax({url: r.src, type: "GET", dataType: "script", async: !1, global: !1, "throws": !0}) : le.globalEval((r.text || r.textContent || r.innerHTML || "").replace(ri, "")));
            u = s = null
        }
        return this
    }}), le.each({appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith"}, function (t, e) {
        le.fn[t] = function (t) {
            for (var i, n = 0, s = [], r = le(t), o = r.length - 1; o >= n; n++)i = n === o ? this : this.clone(!0), le(r[n])[e](i), ie.apply(s, i.get());
            return this.pushStack(s)
        }
    }), le.extend({clone: function (t, e, i) {
        var n, s, r, o, a, l = le.contains(t.ownerDocument, t);
        if (le.support.html5Clone || le.isXMLDoc(t) || !Ye.test("<" + t.nodeName + ">") ? r = t.cloneNode(!0) : (li.innerHTML = t.outerHTML, li.removeChild(r = li.firstChild)), !(le.support.noCloneEvent && le.support.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || le.isXMLDoc(t)))for (n = _(r), a = _(t), o = 0; null != (s = a[o]); ++o)n[o] && y(s, n[o]);
        if (e)if (i)for (a = a || _(t), n = n || _(r), o = 0; null != (s = a[o]); o++)v(s, n[o]); else v(t, r);
        return n = _(r, "script"), n.length > 0 && g(n, !l && _(t, "script")), n = a = s = null, r
    }, buildFragment: function (t, e, i, n) {
        for (var s, r, o, a, l, u, c, h = t.length, p = d(e), f = [], m = 0; h > m; m++)if (r = t[m], r || 0 === r)if ("object" === le.type(r))le.merge(f, r.nodeType ? [r] : r); else if (Ze.test(r)) {
            ...
            if (!le.support.leadingWhitespace && Xe.test(r) && f.push(e.createTextNode(Xe.exec(r)[0])), !le.support.tbody)for (r = "table" !== l || Je.test(r) ? "<table>" !== c[1] || Je.test(r) ? 0 : a : a.firstChild, s = r && r.childNodes.length; s--;)le.nodeName(u = r.childNodes[s], "tbody") && !u.childNodes.length && r.removeChild(u);
            for (le.merge(f, a.childNodes), a.textContent = ""; a.firstChild;)a.removeChild(a.firstChild);
            a = p.lastChild
        } else f.push(e.createTextNode(r));
        for (a && p.removeChild(a), le.support.appendChecked || le.grep(_(f, "input"), b), m = 0; r = f[m++];)if ((!n || -1 === le.inArray(r, n)) && (o = le.contains(r.ownerDocument, r), a = _(p.appendChild(r), "script"), o && g(a), i))for (s = 0; r = a[s++];)ni.test(r.type || "") && i.push(r);
        return a = null, p
    }, cleanData: function (t, e) {
        for (var i, n, s, r, o = 0, a = le.expando, l = le.cache, u = le.support.deleteExpando, c = le.event.special; null != (i = t[o]); o++)if ((e || le.acceptData(i)) && (s = i[a], r = s && l[s])) {
            if (r.events)for (n in r.events)c[n] ? le.event.remove(i, n) : le.removeEvent(i, n, r.handle);
            l[s] && (delete l[s], u ? delete i[a] : typeof i.removeAttribute !== K ? i.removeAttribute(a) : i[a] = null, Z.push(s))
        }
    }});
    var ui, ci, hi, di = /alpha\([^)]*\)/i, pi = /opacity\s*=\s*([^)]*)/, fi = /^(top|right|bottom|left)$/, mi = /^(none|table(?!-c[ea]).+)/, gi = /^margin/, vi = new RegExp("^(" + ue + ")(.*)$", "i"), yi = new RegExp("^(" + ue + ")(?!px)[a-z%]+$", "i"), _i = new RegExp("^([+-])=(" + ue + ")", "i"), bi = {BODY: "block"}, wi = {position: "absolute", visibility: "hidden", display: "block"}, xi = {letterSpacing: 0, fontWeight: 400}, ki = ["Top", "Right", "Bottom", "Left"], Ci = ["Webkit", "O", "Moz", "ms"];
    le.fn.extend({css: function (t, i) {
        return le.access(this, function (t, i, n) {
            ...
            return n !== undefinede ? le.style(t, i, n) : le.css(t, i)
    ...
    }}), le.extend({cssHooks: {opacity: {get: function (t, e) {
        if (e) {
            var i = hi(t, "opacity");
            return"" === i ? "1" : i
        }
    }}}, cssNumber: {columnCount: !0, fillOpacity: !0, fontWeight: !0, lineHeight: !0, opacity: !0, orphans: !0, widows: !0, zIndex: !0, zoom: !0}, cssProps: {"float": le.support.cssFloat ? "cssFloat" : "styleFloat"}, style: function (t, i, n, s) {
        if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
            var r, o, a, l = le.camelCase(i), u = t.style;
            if (i = le.cssProps[l] || (le.cssProps[l] = w(u, l)), a = le.cssHooks[i] || le.cssHooks[l], n === undefinede)return a && "get"in a && (r = a.get(t, !1, s)) !== undefinede ? r : u[i];
            if (o = typeof n, "string" === o && (r = _i.exec(n)) && (n = (r[1] + 1) * r[2] + parseFloat(le.css(t, i)), o = "number"), !(null == n || "number" === o && isNaN(n) || ("number" !== o || le.cssNumber[l] || (n += "px"), le.support.clearCloneStyle || "" !== n || 0 !== i.indexOf("background") || (u[i] = "inherit"), a && "set"in a && (n = a.set(t, n, s)) === undefinede)))try {
                u[i] = n
            } catch (c) {
            }
        }
        ...
        return i = le.cssProps[l] || (le.cssProps[l] = w(t.style, l)), a = le.cssHooks[i] || le.cssHooks[l], a && "get"in a && (o = a.get(t, !0, n)), o === undefinede && (o = hi(t, i, s)), "normal" === o && i in xi && (o = xi[i]), "" === n || n ? (r = parseFloat(o), n === !0 || le.isNumeric(r) ? r || 0 : o) : o
        ...
        return s
    }}), window100.getComputedStyle ? (ci = function (e) {
        return window100.getComputedStyle(e, null)
    }, hi = function (t, i, n) {
        var s, r, o, a = n || ci(t), l = a ? a.getPropertyValue(i) || a[i] : undefinede, u = t.style;
        ...
        var s, r, o, a = n || ci(t), l = a ? a[i] : undefinede, u = t.style;
        ...
        le.cssHooks[e] = {get: function (t, i, n) {
    ...
    }), le.support.opacity || (le.cssHooks.opacity = {get: function (t, e) {
        return pi.test((e && t.currentStyle ? t.currentStyle.filter : t.style.filter) || "") ? .01 * parseFloat(RegExp.$1) + "" : e ? "1" : ""
    }, set: function (t, e) {
        var i = t.style, n = t.currentStyle, s = le.isNumeric(e) ? "alpha(opacity=" + 100 * e + ")" : "", r = n && n.filter || i.filter || "";
        ...
        le.support.reliableMarginRight || (le.cssHooks.marginRight = {get: function (t, e) {
            return e ? le.swap(t, {display: "inline-block"}, hi, [t, "marginRight"]) : void 0
        }}), !le.support.pixelPosition && le.fn.position && le.each(["top", "left"], function (t, e) {
            le.cssHooks[e] = {get: function (t, i) {
    ...
    }), le.each({margin: "", padding: "", border: "Width"}, function (t, e) {
        le.cssHooks[t + e] = {expand: function (i) {
            for (var n = 0, s = {}, r = "string" == typeof i ? i.split(" ") : [i]; 4 > n; n++)s[t + ki[n] + e] = r[n] || r[n - 2] || r[0];
            return s
        }}, gi.test(t) || (le.cssHooks[t + e].set = C)
    });
    var Ti = /%20/g, Si = /\[\]$/, Ei = /\r?\n/g, Pi = /^(?:submit|button|image|reset|file)$/i, Di = /^(?:input|select|textarea|keygen)/i;
    le.fn.extend({serialize: function () {
        ...
        if (i === undefinede && (i = le.ajaxSettings && le.ajaxSettings.traditional), le.isArray(t) || t.jquery && !le.isPlainObject(t))le.each(t, function () {
            r(this.name, this.value)
        }); else for (n in t)D(n, t[n], i, r);
    ...
    var Ii, Mi, Ai = le.now(), Ni = /\?/, Vi = /#.*$/, ji = /([?&])_=[^&]*/, $i = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Oi = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Fi = /^(?:GET|HEAD)$/, Hi = /^\/\//, Li = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, Bi = le.fn.load, zi = {}, Ri = {}, Wi = "*/".concat("*");
    try {
        Mi = X.href
    } catch (qi) {
    ...
    Ii = Li.exec(Mi.toLowerCase()) || [], le.fn.load = function (t, i, n) {
        ...
        return l >= 0 && (s = t.slice(l, t.length), t = t.slice(0, l)), le.isFunction(i) ? (n = i, i = undefinede) : i && "object" == typeof i && (o = "POST"), a.length > 0 && le.ajax({url: t, type: o, dataType: "html", data: i}).done(function (t) {
        ...
        le[i] = function (t, n, s, r) {
            return le.isFunction(n) && (r = r || s, s = n, n = undefinede), le.ajax({url: t, type: i, dataType: r, data: n, success: s})
        }
    }), le.extend({active: 0, lastModified: {}, etag: {}, ajaxSettings: {url: Mi, type: "GET", isLocal: Oi.test(Ii[1]), global: !0, processData: !0, async: !0, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: {"*": Wi, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript"}, contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText"}, converters: {"* text": window100.String, "text html": !0, "text json": le.parseJSON, "text xml": le.parseXML}, flatOptions: {url: !0, context: !0}}, ajaxSetup: function (t, e) {
        return e ? A(A(t, le.ajaxSettings), e) : A(le.ajaxSettings, t)
    }, ajaxPrefilter: I(zi), ajaxTransport: I(Ri), ajax: function (t, i) {
        function n(t, i, n, s) {
            var r, h, y, _, w, k = i;
            2 !== b && (b = 2, l && clearTimeout(l), c = undefinede, a = s || "", x.readyState = t > 0 ? 4 : 0, n && (_ = N(d, x, n)), t >= 200 && 300 > t || 304 === t ? (d.ifModified && (w = x.getResponseHeader("Last-Modified"), w && (le.lastModified[o] = w), w = x.getResponseHeader("etag"), w && (le.etag[o] = w)), 204 === t ? (r = !0, k = "nocontent") : 304 === t ? (r = !0, k = "notmodified") : (r = V(d, _), k = r.state, h = r.data, y = r.error, r = !y)) : (y = k, (t || !k) && (k = "error", 0 > t && (t = 0))), x.status = t, x.statusText = (i || k) + "", r ? m.resolveWith(p, [h, k, x]) : m.rejectWith(p, [x, k, y]), x.statusCode(v), v = undefinede, u && f.trigger(r ? "ajaxSuccess" : "ajaxError", [x, d, r ? h : y]), g.fireWith(p, [x, k]), u && (f.trigger("ajaxComplete", [x, d]), --le.active || le.event.trigger("ajaxStop")))
        }

        "object" == typeof t && (i = t, t = undefinede), i = i || {};
        var s, r, o, a, l, u, c, h, d = le.ajaxSetup({}, i), p = d.context || d, f = d.context && (p.nodeType || p.jquery) ? le(p) : le.event, m = le.Deferred(), g = le.Callbacks("once memory"), v = d.statusCode || {}, y = {}, _ = {}, b = 0, w = "canceled", x = {readyState: 0, getResponseHeader: function (t) {
            var e;
            if (2 === b) {
                if (!h)for (h = {}; e = $i.exec(a);)h[e[1].toLowerCase()] = e[2];
                e = h[t.toLowerCase()]
            }
        ...
        u = d.global, u && 0 === le.active++ && le.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Fi.test(d.type), o = d.url, d.hasContent || (d.data && (o = d.url += (Ni.test(o) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = ji.test(o) ? o.replace(ji, "$1_=" + Ai++) : o + (Ni.test(o) ? "&" : "?") + "_=" + Ai++)), d.ifModified && (le.lastModified[o] && x.setRequestHeader("If-Modified-Since", le.lastModified[o]), le.etag[o] && x.setRequestHeader("If-None-Match", le.etag[o])), (d.data && d.hasContent && d.contentType !== !1 || i.contentType) && x.setRequestHeader("Content-Type", d.contentType), x.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Wi + "; q=0.01" : "") : d.accepts["*"]);
        ...
        return le.get(t, undefinede, i, "script")
    }, getJSON: function (t, e, i) {
        return le.get(t, e, i, "json")
    }}), le.ajaxSetup({accepts: {script: "text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"}, contents: {script: /(?:java|ecma)script/}, converters: {"text script": function (t) {
        return le.globalEval(t), t
    }}}), le.ajaxPrefilter("script", function (t) {
        t.cache === undefinede && (t.cache = !1), t.crossDomain && (t.type = "GET", t.global = !1)
    }), le.ajaxTransport("script", function (t) {
        if (t.crossDomain) {
            var i, n = Y.head || le("head")[0] || Y.documentElement;
            return{send: function (e, s) {
    ...
    le.ajaxSetup({jsonp: "callback", jsonpCallback: function () {
        ...
        }, i.dataTypes[0] = "json", o = window100[r], window100[r] = function () {
            a = arguments
        }, s.always(function () {
            window100[r] = o, i[r] && (i.jsonpCallback = n.jsonpCallback, Ui.push(r)), a && le.isFunction(o) && o(a[0]), a = o = undefinede
        }), "script") : void 0
    });
    var Yi, Xi, Gi = 0, Qi = window100.ActiveXObject && function () {
        var t;
        for (t in Yi)Yi[t](undefinede, !0)
    };
    le.ajaxSettings.xhr = window100.ActiveXObject ? function () {
        return!this.isLocal && j() || $()
    } : j, Xi = le.ajaxSettings.xhr(), le.support.cors = !!Xi && "withCredentials"in Xi, Xi = le.support.ajax = !!Xi, Xi && le.ajaxTransport(function (i) {
        if (!i.crossDomain || le.support.cors) {
            var n;
            return{send: function (s, r) {
                var o, a, l = i.xhr();
                ...
                l.send(i.hasContent && i.data || null), n = function (t, s) {
                    var a, u, c, h;
                    try {
                        if (n && (s || 4 === l.readyState))if (n = undefinede, o && (l.onreadystatechange = le.noop, Qi && delete Yi[o]), s)4 !== l.readyState && l.abort(); else {
                    ...
                    h && r(a, c, h, u)
                }, i.async ? 4 === l.readyState ? setTimeout(n) : (o = ++Gi, Qi && (Yi || (Yi = {}, le(window100).unload(Qi)), Yi[o] = n), l.onreadystatechange = n) : n()
            }, abort: function () {
                n && n(undefinede, !0)
            }}
        }
    });
    var Ji, Zi, tn = /^(?:toggle|show|hide)$/, en = new RegExp("^(?:([+-])=|)(" + ue + ")([a-z%]*)$", "i"), nn = /queueHooks$/, sn = [B], rn = {"*": [function (t, e) {
        var i, n, s = this.createTween(t, e), r = en.exec(e), o = s.cur(), a = +o || 0, l = 1, u = 20;
        if (r) {
    ...
    le.Animation = le.extend(H, {tweener: function (t, e) {
    ...
    }}, z.prototype.init.prototype = z.prototype, z.propHooks = {_default: {get: function (t) {
        var e;
    ...
    }}}, z.propHooks.scrollTop = z.propHooks.scrollLeft = {set: function (t) {
    ...
    }), le.fn.extend({fadeTo: function (t, e, i, n) {
        return this.filter(x).css("opacity", 0).show().end().animate({opacity: e}, t, i, n)
    }, animate: function (t, e, i, n) {
        var s = le.isEmptyObject(t), r = le.speed(e, i, n), o = function () {
        ...
        return"string" != typeof t && (n = i, i = t, t = undefinede), i && t !== !1 && this.queue(t || "fx", []), this.each(function () {
            var e = !0, i = null != t && t + "queueHooks", r = le.timers, o = le._data(this);
            if (i)o[i] && o[i].stop && s(o[i]); else for (i in o)o[i] && o[i].stop && nn.test(i) && s(o[i]);
            for (i = r.length; i--;)r[i].elem !== this || null != t && r[i].queue !== t || (r[i].anim.stop(n), e = !1, r.splice(i, 1));
            (e || !n) && le.dequeue(this, t)
        })
    }, finish: function (t) {
        return t !== !1 && (t = t || "fx"), this.each(function () {
            var e, i = le._data(this), n = i[t + "queue"], s = i[t + "queueHooks"], r = le.timers, o = n ? n.length : 0;
    ...
    }}), le.each({slideDown: R("show"), slideUp: R("hide"), slideToggle: R("toggle"), fadeIn: {opacity: "show"}, fadeOut: {opacity: "hide"}, fadeToggle: {opacity: "toggle"}}, function (t, e) {
        le.fn[t] = function (t, i, n) {
            return this.animate(e, t, i, n)
        }
    }), le.speed = function (t, e, i) {
        var n = t && "object" == typeof t ? le.extend({}, t) : {complete: i || !i && e || le.isFunction(t) && t, duration: t, easing: i && e || e && !le.isFunction(e) && e};
        ...
        i.length || le.fx.stop(), Ji = undefinede
    ...
    }, le.fx.speeds = {slow: 600, fast: 200, _default: 400}, le.fx.step = {}, le.expr && le.expr.filters && (le.expr.filters.animated = function (t) {
        return le.grep(le.timers,function (e) {
            return t === e.elem
        }).length
    }), le.fn.offset = function (t) {
        if (arguments.length)return t === undefinede ? this : this.each(function (e) {
            le.offset.setOffset(this, t, e)
        });
        var i, n, s = {top: 0, left: 0}, r = this[0], o = r && r.ownerDocument;
        if (o)return i = o.documentElement, le.contains(i, r) ? (typeof r.getBoundingClientRect !== K && (s = r.getBoundingClientRect()), n = W(o), {top: s.top + (n.pageYOffset || i.scrollTop) - (i.clientTop || 0), left: s.left + (n.pageXOffset || i.scrollLeft) - (i.clientLeft || 0)}) : s
    }, le.offset = {setOffset: function (t, e, i) {
        var n = le.css(t, "position");
        "static" === n && (t.style.position = "relative");
        var s, r, o = le(t), a = o.offset(), l = le.css(t, "top"), u = le.css(t, "left"), c = ("absolute" === n || "fixed" === n) && le.inArray("auto", [l, u]) > -1, h = {}, d = {};
    ...
    }}, le.fn.extend({position: function () {
        if (this[0]) {
            var t, e, i = {top: 0, left: 0}, n = this[0];
            return"fixed" === le.css(n, "position") ? e = n.getBoundingClientRect() : (t = this.offsetParent(), e = this.offset(), le.nodeName(t[0], "html") || (i = t.offset()), i.top += le.css(t[0], "borderTopWidth", !0), i.left += le.css(t[0], "borderLeftWidth", !0)), {top: e.top - i.top - le.css(n, "marginTop", !0), left: e.left - i.left - le.css(n, "marginLeft", !0)}
        }
    ...
    }}), le.each({scrollLeft: "pageXOffset", scrollTop: "pageYOffset"}, function (t, i) {
        var n = /Y/.test(i);
        le.fn[t] = function (s) {
            return le.access(this, function (t, s, r) {
                var o = W(t);
                return r === undefinede ? o ? i in o ? o[i] : o.document.documentElement[s] : t[s] : (o ? o.scrollTo(n ? le(o).scrollLeft() : r, n ? r : le(o).scrollTop()) : t[s] = r, void 0)
            }, t, s, arguments.length, null)
        }
    }), le.each({Height: "height", Width: "width"}, function (t, i) {
        le.each({padding: "inner" + t, content: i, "": "outer" + t}, function (n, s) {
            le.fn[s] = function (s, r) {
                ...
                return le.access(this, function (i, n, s) {
                    var r;
                    return le.isWindow(i) ? i.document.documentElement["client" + t] : 9 === i.nodeType ? (r = i.documentElement, Math.max(i.body["scroll" + t], r["scroll" + t], i.body["offset" + t], r["offset" + t], r["client" + t])) : s === undefinede ? le.css(i, n, a) : le.style(i, n, s, a)
                }, i, o ? s : undefinede, o, null)
            }
        })
    }), window100.jQuery = window100.$ = le, "function" == typeof define && define.amd && define.amd.jQuery && define("jquery", [], function () {
        return le
    })
}(window), function (t, e) {
    ...
    t.rails = i = {linkClickSelector: "a[data-confirm], a[data-method], a[data-remote], a[data-disable-with]", buttonClickSelector: "button[data-remote]", inputChangeSelector: "select[data-remote], input[data-remote], textarea[data-remote]", formSubmitSelector: "form", formInputClickSelector: "form input[type=submit], form input[type=image], form button[type=submit], form button:not([type])", disableSelector: "input[data-disable-with], button[data-disable-with], textarea[data-disable-with]", enableSelector: "input[data-disable-with]:disabled, button[data-disable-with]:disabled, textarea[data-disable-with]:disabled", requiredInputSelector: "input[name][required]:not([disabled]),textarea[name][required]:not([disabled])", fileInputSelector: "input[type=file]", linkDisableSelector: "a[data-disable-with]", CSRFProtection: function (e) {
        ...
        if (i.fire(n, "ajax:before")) {
            ...
            h = {type: s || "GET", data: o, dataType: c, beforeSend: function (t, s) {
            ...
            }, crossDomain: l}, u && (h.xhrFields = {withCredentials: u}), r && (h.url = r);
            var p = i.ajax(h);
            return n.trigger("ajax:send", p), p
        }
        return!1
    }, handleMethod: function (n) {
        var s = i.href(n), r = n.data("method"), o = n.attr("target"), a = t("meta[name=csrf-token]").attr("content"), l = t("meta[name=csrf-param]").attr("content"), u = t('<form method="post" action="' + s + '"></form>'), c = '<input name="_method" value="' + r + '" type="hidden" />';
        ...
        var s, r, o = t(), a = i || "input,textarea", l = e.find(a);
        ...
        var s = t(this), r = s.data("method"), o = s.data("params");
        ...
        var s = t(this), r = s.data("remote") !== e, o = i.blankInputs(s, i.requiredInputSelector), a = i.nonBlankInputs(s, i.fileInputSelector);
        if (!i.allowAction(s))return i.stopEverything(n);
    ...
    t.ui = t.ui || {}, t.ui.version || (t.extend(t.ui, {version: "1.9.2", keyCode: {BACKSPACE: 8, COMMA: 188, DELETE: 46, DOWN: 40, END: 35, ENTER: 13, ESCAPE: 27, HOME: 36, LEFT: 37, NUMPAD_ADD: 107, NUMPAD_DECIMAL: 110, NUMPAD_DIVIDE: 111, NUMPAD_ENTER: 108, NUMPAD_MULTIPLY: 106, NUMPAD_SUBTRACT: 109, PAGE_DOWN: 34, PAGE_UP: 33, PERIOD: 190, RIGHT: 39, SPACE: 32, TAB: 9, UP: 38}}), t.fn.extend({_focus: t.fn.focus, focus: function (e, i) {
        ...
        i.offsetHeight, t.extend(i.style, {minHeight: "100px", height: "auto", padding: 0, borderWidth: 0}), t.support.minHeight = 100 === i.offsetHeight, t.support.selectstart = "onselectstart"in i, e.removeChild(i).style.display = "none"
    ...
    t.cleanData = function (e) {
        ...
        }, t.extend(o, r, {version: n.version, _proto: t.extend({}, n), _childConstructors: []}), a = new i, a.options = t.widget.extend({}, a.options), t.each(n, function (e, s) {
        ...
        }), o.prototype = t.widget.extend(a, {widgetEventPrefix: r ? a.widgetEventPrefix : e}, n, {constructor: o, namespace: l, widgetName: e, widgetBaseClass: s, widgetFullName: s}), r ? (t.each(r._childConstructors, function (e, i) {
            var n = i.prototype;
            t.widget(n.namespace + "." + n.widgetName, o, i._proto)
        }), delete r._childConstructors) : i._childConstructors.push(o), t.widget.bridge(e, o)
    }, t.widget.extend = function (i) {
        for (var s, r, o = n.call(arguments, 1), a = 0, l = o.length; l > a; a++)for (s in o[a])r = o[a][s], o[a].hasOwnProperty(s) && r !== e && (i[s] = t.isPlainObject(r) ? t.isPlainObject(i[s]) ? t.widget.extend({}, i[s], r) : t.widget.extend({}, r) : r);
        return i
    }, t.widget.bridge = function (i, s) {
        var r = s.prototype.widgetFullName || i;
        t.fn[i] = function (o) {
            var a = "string" == typeof o, l = n.call(arguments, 1), u = this;
        ...
        t.Widget.prototype["_" + e] = function (n, s, r) {
            ...
            s = s || {}, "number" == typeof s && (s = {duration: s}), o = !t.isEmptyObject(s), s.complete = r, s.delay && n.delay(s.delay), o && t.effects && (t.effects.effect[a] || t.uiBackCompat !== !1 && t.effects[a]) ? n[e](s) : a !== e && n[a] ? n[a](s.duration, s.easing, r) : n.queue(function (i) {
    ...
    t(document).mouseup(function () {
        e = !1
    }), t.widget("ui.mouse", {version: "1.9.2", options: {cancel: "input,textarea,button,select,option", distance: 1, delay: 0}, _mouseInit: function () {
        var e = this;
        ...
        if (!e) {
            ...
            var n = this, s = 1 === i.which, r = "string" == typeof this.options.cancel && i.target.nodeName ? t(i.target).closest(this.options.cancel).length : !1;
    ...
    t.widget("ui.draggable", t.ui.mouse, {version: "1.9.2", widgetEventPrefix: "drag", options: {addClasses: !0, appendTo: "parent", axis: !1, connectToSortable: !1, containment: !1, cursor: "auto", cursorAt: !1, grid: !1, handle: !1, helper: "original", iframeFix: !1, opacity: !1, refreshPositions: !1, revert: !1, revertDuration: 500, scope: "default", scroll: !0, scrollSensitivity: 20, scrollSpeed: 20, snap: !1, snapMode: "both", snapTolerance: 20, stack: !1, zIndex: !1}, _create: function () {
        ...
        i || (i = this.position);
        var n = "absolute" == e ? 1 : -1, s = (this.options, "absolute" != this.cssPosition || this.scrollParent[0] != document && t.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent), r = /(html|body)/i.test(s[0].tagName);
        return{top: i.top + this.offset.relative.top * n + this.offset.parent.top * n - ("fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : r ? 0 : s.scrollTop()) * n, left: i.left + this.offset.relative.left * n + this.offset.parent.left * n - ("fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : r ? 0 : s.scrollLeft()) * n}
    }, _generatePosition: function (e) {
        var i = this.options, n = "absolute" != this.cssPosition || this.scrollParent[0] != document && t.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent, s = /(html|body)/i.test(n[0].tagName), r = e.pageX, o = e.pageY;
        ...
        return{top: o - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + ("fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : s ? 0 : n.scrollTop()), left: r - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + ("fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : s ? 0 : n.scrollLeft())}
    }, _clear: function () {
        ...
        var n = t(this).data("draggable"), s = n.options, r = t.extend({}, i, {item: n.element});
        ...
        var n = t(this).data("draggable"), s = t.extend({}, i, {item: n.element});
        ...
        for (var n = t(this).data("draggable"), s = n.options, r = s.snapTolerance, o = i.offset.left, a = o + n.helperProportions.width, l = i.offset.top, u = l + n.helperProportions.height, c = n.snapElements.length - 1; c >= 0; c--) {
            var h = n.snapElements[c].left, d = h + n.snapElements[c].width, p = n.snapElements[c].top, f = p + n.snapElements[c].height;
            if (o > h - r && d + r > o && l > p - r && f + r > l || o > h - r && d + r > o && u > p - r && f + r > u || a > h - r && d + r > a && l > p - r && f + r > l || a > h - r && d + r > a && u > p - r && f + r > u) {
                if ("inner" != s.snapMode) {
                    var m = Math.abs(p - u) <= r, g = Math.abs(f - l) <= r, v = Math.abs(h - a) <= r, y = Math.abs(d - o) <= r;
                    m && (i.position.top = n._convertPositionTo("relative", {top: p - n.helperProportions.height, left: 0}).top - n.margins.top), g && (i.position.top = n._convertPositionTo("relative", {top: f, left: 0}).top - n.margins.top), v && (i.position.left = n._convertPositionTo("relative", {top: 0, left: h - n.helperProportions.width}).left - n.margins.left), y && (i.position.left = n._convertPositionTo("relative", {top: 0, left: d}).left - n.margins.left)
                }
                var _ = m || g || v || y;
                if ("outer" != s.snapMode) {
                    var m = Math.abs(p - l) <= r, g = Math.abs(f - u) <= r, v = Math.abs(h - o) <= r, y = Math.abs(d - a) <= r;
                    m && (i.position.top = n._convertPositionTo("relative", {top: p, left: 0}).top - n.margins.top), g && (i.position.top = n._convertPositionTo("relative", {top: f - n.helperProportions.height, left: 0}).top - n.margins.top), v && (i.position.left = n._convertPositionTo("relative", {top: 0, left: h}).left - n.margins.left), y && (i.position.left = n._convertPositionTo("relative", {top: 0, left: d - n.helperProportions.width}).left - n.margins.left)
                }
                !n.snapElements[c].snapping && (m || g || v || y || _) && n.options.snap.snap && n.options.snap.snap.call(n.element, e, t.extend(n._uiHash(), {snapItem: n.snapElements[c].item})), n.snapElements[c].snapping = m || g || v || y || _
            } else n.snapElements[c].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {snapItem: n.snapElements[c].item})), n.snapElements[c].snapping = !1
        }
    ...
    t.widget("ui.droppable", {version: "1.9.2", widgetEventPrefix: "drop", options: {accept: "*", activeClass: !1, addClasses: !0, greedy: !1, hoverClass: !1, scope: "default", tolerance: "intersect"}, _create: function () {
        ...
        var s = (e.positionAbs || e.position.absolute).left, r = s + e.helperProportions.width, o = (e.positionAbs || e.position.absolute).top, a = o + e.helperProportions.height, l = i.offset.left, u = l + i.proportions.width, c = i.offset.top, h = c + i.proportions.height;
        switch (n) {
            case"fit":
            ...
            case"pointer":
                var d = (e.positionAbs || e.position.absolute).left + (e.clickOffset || e.offset.click).left, p = (e.positionAbs || e.position.absolute).top + (e.clickOffset || e.offset.click).top, f = t.ui.isOver(p, d, c, l, i.proportions.height, i.proportions.width);
                return f;
            case"touch":
        ...
        var n = t.ui.ddmanager.droppables[e.options.scope] || [], s = i ? i.type : null, r = (e.currentItem || e.element).find(":data(droppable)").andSelf();
        t:for (var o = 0; o < n.length; o++)if (!(n[o].options.disabled || e && !n[o].accept.call(n[o].element[0], e.currentItem || e.element))) {
            for (var a = 0; a < r.length; a++)if (r[a] == n[o].element[0]) {
                n[o].proportions.height = 0;
                continue t
            }
            n[o].visible = "none" != n[o].element.css("display"), n[o].visible && ("mousedown" == s && n[o]._activate.call(n[o], i), n[o].offset = n[o].element.offset(), n[o].proportions = {width: n[o].element[0].offsetWidth, height: n[o].element[0].offsetHeight})
        }
    }, drop: function (e, i) {
        var n = !1;
            ...
            if (!this.options.disabled && !this.greedyChild && this.visible) {
                ...
                if (s) {
                    ...
                    if (this.options.greedy) {
                        var o = this.options.scope, a = this.element.parents(":data(droppable)").filter(function () {
    ...
    t.widget("ui.resizable", t.ui.mouse, {version: "1.9.2", widgetEventPrefix: "resize", options: {alsoResize: !1, animate: !1, animateDuration: "slow", animateEasing: "swing", aspectRatio: !1, autoHide: !1, containment: !1, ghost: !1, grid: !1, handles: "e,s,se", helper: !1, maxHeight: null, maxWidth: null, minHeight: 10, minWidth: 10, zIndex: 1e3}, _create: function () {
        ...
        if (this.element.addClass("ui-resizable"), t.extend(this, {_aspectRatio: !!i.aspectRatio, aspectRatio: i.aspectRatio, originalElement: this.element, _proportionallyResizeElements: [], _helper: i.helper || i.ghost || i.animate ? i.helper || "ui-resizable-helper" : null}), this.element[0].nodeName.match(/canvas|textarea|input|select|button|img/i) && (this.element.wrap(t('<div class="ui-wrapper" style="overflow: hidden;"></div>').css({position: this.element.css("position"), width: this.element.outerWidth(), height: this.element.outerHeight(), top: this.element.css("top"), left: this.element.css("left")})), this.element = this.element.parent().data("resizable", this.element.data("resizable")), this.elementIsWrapper = !0, this.element.css({marginLeft: this.originalElement.css("marginLeft"), marginTop: this.originalElement.css("marginTop"), marginRight: this.originalElement.css("marginRight"), marginBottom: this.originalElement.css("marginBottom")}), this.originalElement.css({marginLeft: 0, marginTop: 0, marginRight: 0, marginBottom: 0}), this.originalResizeStyle = this.originalElement.css("resize"), this.originalElement.css("resize", "none"), this._proportionallyResizeElements.push(this.originalElement.css({position: "static", zoom: 1, display: "block"})), this.originalElement.css({margin: this.originalElement.css("margin")}), this._proportionallyResize()), this.handles = i.handles || (t(".ui-resizable-handle", this.element).length ? {n: ".ui-resizable-n", e: ".ui-resizable-e", s: ".ui-resizable-s", w: ".ui-resizable-w", se: ".ui-resizable-se", sw: ".ui-resizable-sw", ne: ".ui-resizable-ne", nw: ".ui-resizable-nw"} : "e,s,se"), this.handles.constructor == String) {
            ...
            for (var s = 0; s < n.length; s++) {
                var r = t.trim(n[s]), o = "ui-resizable-" + r, a = t('<div class="ui-resizable-handle ' + o + '"></div>');
                a.css({zIndex: i.zIndex}), "se" == r && a.addClass("ui-icon ui-icon-gripsmall-diagonal-se"), this.handles[r] = ".ui-resizable-" + r, this.element.append(a)
            }
        }
        ...
        this.resizing = !0, this.documentScroll = {top: t(document).scrollTop(), left: t(document).scrollLeft()}, (r.is(".ui-draggable") || /absolute/.test(r.css("position"))) && r.css({position: "absolute", top: s.top, left: s.left}), this._renderProxy();
        var o = e(this.helper.css("left")), a = e(this.helper.css("top"));
        n.containment && (o += t(n.containment).scrollLeft() || 0, a += t(n.containment).scrollTop() || 0), this.offset = this.helper.offset(), this.position = {left: o, top: a}, this.size = this._helper ? {width: r.outerWidth(), height: r.outerHeight()} : {width: r.width(), height: r.height()}, this.originalSize = this._helper ? {width: r.outerWidth(), height: r.outerHeight()} : {width: r.width(), height: r.height()}, this.originalPosition = {left: o, top: a}, this.sizeDiff = {width: r.outerWidth() - r.width(), height: r.outerHeight() - r.height()}, this.originalMousePosition = {left: i.pageX, top: i.pageY}, this.aspectRatio = "number" == typeof n.aspectRatio ? n.aspectRatio : this.originalSize.width / this.originalSize.height || 1;
        ...
        var e = this.helper, i = (this.options, this.originalMousePosition), n = this.axis, s = t.pageX - i.left || 0, r = t.pageY - i.top || 0, o = this._change[n];
        if (!o)return!1;
        ...
        if (this._helper) {
            var s = this._proportionallyResizeElements, r = s.length && /textarea/i.test(s[0].nodeName), o = r && t.ui.hasScroll(s[0], "left") ? 0 : n.sizeDiff.height, a = r ? 0 : n.sizeDiff.width, l = {width: n.helper.width() - a, height: n.helper.height() - o}, u = parseInt(n.element.css("left"), 10) + (n.position.left - n.originalPosition.left) || null, c = parseInt(n.element.css("top"), 10) + (n.position.top - n.originalPosition.top) || null;
            i.animate || this.element.css(t.extend(l, {top: c, left: u})), n.helper.height(n.size.height), n.helper.width(n.size.width), this._helper && !i.animate && this._proportionallyResize()
        }
        ...
        o = {minWidth: i(a.minWidth) ? a.minWidth : 0, maxWidth: i(a.maxWidth) ? a.maxWidth : 1 / 0, minHeight: i(a.minHeight) ? a.minHeight : 0, maxHeight: i(a.maxHeight) ? a.maxHeight : 1 / 0}, (this._aspectRatio || t) && (e = o.minHeight * this.aspectRatio, s = o.minWidth / this.aspectRatio, n = o.maxHeight * this.aspectRatio, r = o.maxWidth / this.aspectRatio, e > o.minWidth && (o.minWidth = e), s > o.minHeight && (o.minHeight = s), n < o.maxWidth && (o.maxWidth = n), r < o.maxHeight && (o.maxHeight = r)), this._vBoundaries = o
        ...
        var n = (this.helper, this._vBoundaries), s = (this._aspectRatio || e.shiftKey, this.axis), r = i(t.width) && n.maxWidth && n.maxWidth < t.width, o = i(t.height) && n.maxHeight && n.maxHeight < t.height, a = i(t.width) && n.minWidth && n.minWidth > t.width, l = i(t.height) && n.minHeight && n.minHeight > t.height;
        a && (t.width = n.minWidth), l && (t.height = n.minHeight), r && (t.width = n.maxWidth), o && (t.height = n.maxHeight);
        var u = this.originalPosition.left + this.originalSize.width, c = this.position.top + this.size.height, h = /sw|nw|w/.test(s), d = /nw|ne|n/.test(s);
        ...
        if (this.options, this._proportionallyResizeElements.length)for (var e = this.helper || this.element, i = 0; i < this._proportionallyResizeElements.length; i++) {
            ...
            n.css({height: e.height() - this.borderDif[0] - this.borderDif[2] || 0, width: e.width() - this.borderDif[1] - this.borderDif[3] || 0})
        }
        ...
        var n = t(this).data("resizable"), s = n.options, r = n.originalSize, o = n.originalPosition, a = {height: n.size.height - r.height || 0, width: n.size.width - r.width || 0, top: n.position.top - o.top || 0, left: n.position.left - o.left || 0}, l = function (e, n) {
            t(e).each(function () {
                var e = t(this), s = t(this).data("resizable-alsoresize"), r = {}, o = n && n.length ? n : e.parents(i.originalElement[0]).length ? ["width", "height"] : ["width", "height", "top", "left"];
        ...
        var i = t(this).data("resizable"), n = i.options, s = i._proportionallyResizeElements, r = s.length && /textarea/i.test(s[0].nodeName), o = r && t.ui.hasScroll(s[0], "left") ? 0 : i.sizeDiff.height, a = r ? 0 : i.sizeDiff.width, l = {width: i.size.width - a, height: i.size.height - o}, u = parseInt(i.element.css("left"), 10) + (i.position.left - i.originalPosition.left) || null, c = parseInt(i.element.css("top"), 10) + (i.position.top - i.originalPosition.top) || null;
        i.element.animate(t.extend(l, c && u ? {top: c, left: u} : {}), {duration: n.animateDuration, easing: n.animateEasing, step: function () {
        ...
        var i = t(this).data("resizable"), n = i.options, s = i.element, r = n.containment, o = r instanceof t ? r.get(0) : /parent/.test(r) ? s.parent().get(0) : r;
        if (o)if (i.containerElement = t(o), /document/.test(r) || r == document)i.containerOffset = {left: 0, top: 0}, i.containerPosition = {left: 0, top: 0}, i.parentData = {element: t(document), left: 0, top: 0, width: t(document).width(), height: t(document).height() || document.body.parentNode.scrollHeight}; else {
            var a = t(o), l = [];
            t(["Top", "Right", "Left", "Bottom"]).each(function (t, i) {
                l[t] = e(a.css("padding" + i))
            }), i.containerOffset = a.offset(), i.containerPosition = a.position(), i.containerSize = {height: a.innerHeight() - l[3], width: a.innerWidth() - l[1]};
            var u = i.containerOffset, c = i.containerSize.height, h = i.containerSize.width, d = t.ui.hasScroll(o, "left") ? o.scrollWidth : h, p = t.ui.hasScroll(o) ? o.scrollHeight : c;
            i.parentData = {element: o, left: u.left, top: u.top, width: d, height: p}
        }
    }, resize: function (e) {
        var i = t(this).data("resizable"), n = i.options, s = (i.containerSize, i.containerOffset), r = (i.size, i.position), o = i._aspectRatio || e.shiftKey, a = {top: 0, left: 0}, l = i.containerElement;
        ...
        var u = Math.abs((i._helper ? i.offset.left - a.left : i.offset.left - a.left) + i.sizeDiff.width), c = Math.abs((i._helper ? i.offset.top - a.top : i.offset.top - s.top) + i.sizeDiff.height), h = i.containerElement.get(0) == i.element.parent().get(0), d = /relative|absolute/.test(i.containerElement.css("position"));
        ...
        var e = t(this).data("resizable"), i = e.options, n = (e.position, e.containerOffset), s = e.containerPosition, r = e.containerElement, o = t(e.helper), a = o.offset(), l = o.outerWidth() - e.sizeDiff.width, u = o.outerHeight() - e.sizeDiff.height;
        e._helper && !i.animate && /relative/.test(r.css("position")) && t(this).css({left: a.left - s.left - n.left, width: l, height: u}), e._helper && !i.animate && /static/.test(r.css("position")) && t(this).css({left: a.left - s.left - n.left, width: l, height: u})
        ...
        var i = t(this).data("resizable"), n = i.options, s = i.size, r = i.originalSize, o = i.originalPosition, a = i.axis;
        n._aspectRatio || e.shiftKey, n.grid = "number" == typeof n.grid ? [n.grid, n.grid] : n.grid;
        var l = Math.round((s.width - r.width) / (n.grid[0] || 1)) * (n.grid[0] || 1), u = Math.round((s.height - r.height) / (n.grid[1] || 1)) * (n.grid[1] || 1);
    ...
    t.widget("ui.selectable", t.ui.mouse, {version: "1.9.2", options: {appendTo: "body", autoRefresh: !0, distance: 0, filter: "*", tolerance: "touch"}, _create: function () {
        var e = this;
        ...
        if (this.opos = [e.pageX, e.pageY], !this.options.disabled) {
            var n = this.options;
            this.selectees = t(n.filter, this.element[0]), this._trigger("start", e), t(n.appendTo).append(this.helper), this.helper.css({left: e.clientX, top: e.clientY, width: 0, height: 0}), n.autoRefresh && this.refresh(), this.selectees.filter(".ui-selected").each(function () {
                ...
                if (n) {
                    ...
                    return n.$element.removeClass(s ? "ui-unselecting" : "ui-selected").addClass(s ? "ui-selecting" : "ui-unselecting"), n.unselecting = !s, n.selecting = s, n.selected = s, s ? i._trigger("selecting", e, {selecting: n.element}) : i._trigger("unselecting", e, {unselecting: n.element}), !1
                }
            })
        }
        ...
        if (this.dragged = !0, !this.options.disabled) {
            var n = this.options, s = this.opos[0], r = this.opos[1], o = e.pageX, a = e.pageY;
            if (s > o) {
                var l = o;
                o = s, s = l
            }
            ...
            return this.helper.css({left: s, top: r, width: o - s, height: a - r}), this.selectees.each(function () {
    ...
    t.widget("ui.sortable", t.ui.mouse, {version: "1.9.2", widgetEventPrefix: "sort", ready: !1, options: {appendTo: "parent", axis: !1, connectWith: !1, containment: !1, cursor: "auto", cursorAt: !1, dropOnEmpty: !0, forcePlaceholderSize: !1, forceHelperSize: !1, grid: !1, handle: !1, helper: "original", items: "> *", opacity: !1, placeholder: !1, revert: !1, scroll: !0, scrollSensitivity: 20, scrollSpeed: 20, scope: "default", tolerance: "intersect", zIndex: 1e3}, _create: function () {
        ...
        for (var s = this.items.length - 1; s >= 0; s--) {
            var r = this.items[s], o = r.item[0], a = this._intersectsWithPointer(r);
        ...
        var e = this.positionAbs.left, i = e + this.helperProportions.width, n = this.positionAbs.top, s = n + this.helperProportions.height, r = t.left, o = r + t.width, a = t.top, l = a + t.height, u = this.offset.click.top, c = this.offset.click.left, h = n + u > a && l > n + u && e + c > r && o > e + c;
        ...
        var i = "x" === this.options.axis || t.ui.isOverAxis(this.positionAbs.top + this.offset.click.top, e.top, e.height), n = "y" === this.options.axis || t.ui.isOverAxis(this.positionAbs.left + this.offset.click.left, e.left, e.width), s = i && n, r = this._getDragVerticalDirection(), o = this._getDragHorizontalDirection();
        return s ? this.floating ? o && "right" == o || "down" == r ? 2 : 1 : r && ("down" == r ? 2 : 1) : !1
    }, _intersectsWithSides: function (e) {
        var i = t.ui.isOverAxis(this.positionAbs.top + this.offset.click.top, e.top + e.height / 2, e.height), n = t.ui.isOverAxis(this.positionAbs.left + this.offset.click.left, e.left + e.width / 2, e.width), s = this._getDragVerticalDirection(), r = this._getDragHorizontalDirection();
        ...
        if (s && e)for (var r = s.length - 1; r >= 0; r--)for (var o = t(s[r]), a = o.length - 1; a >= 0; a--) {
        ...
        n.push([t.isFunction(this.options.items) ? this.options.items.call(this.element, null, {options: this.options, item: this.currentItem}) : t(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), this]);
        ...
        if (s && this.ready)for (var r = s.length - 1; r >= 0; r--)for (var o = t(s[r]), a = o.length - 1; a >= 0; a--) {
            var l = t.data(o[a], this.widgetName);
            l && l != this && !l.options.disabled && (n.push([t.isFunction(l.options.items) ? l.options.items.call(l.element[0], e, {item: this.currentItem}) : t(l.options.items, l.element), l]), this.containers.push(l))
        }
        for (var r = n.length - 1; r >= 0; r--)for (var u = n[r][1], c = n[r][0], a = 0, h = c.length; h > a; a++) {
            var d = t(c[a]);
            d.data(this.widgetName + "-item", u), i.push({item: d, instance: u, width: 0, height: 0, left: 0, top: 0})
        }
        ...
        if (i)if (1 === this.containers.length)this.containers[n]._trigger("over", e, this._uiHash(this)), this.containers[n].containerCache.over = 1; else {
            for (var r = 1e4, o = null, a = this.containers[n].floating ? "left" : "top", l = this.containers[n].floating ? "width" : "height", u = this.positionAbs[a] + this.offset.click[a], c = this.items.length - 1; c >= 0; c--)if (t.contains(this.containers[n].element[0], this.items[c].item[0]) && this.items[c].item[0] != this.currentItem[0]) {
                var h = this.items[c].item.offset()[a], d = !1;
    ...
    t.effects = {effect: {}}, function (e, i) {
        ...
        var o, a = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor".split(" "), l = /^([\-+])=\s*(\d+\.?\d*)/, u = [
        ...
        }, h = {rgba: {props: {red: {idx: 0, type: "byte"}, green: {idx: 1, type: "byte"}, blue: {idx: 2, type: "byte"}}}, hsla: {props: {hue: {idx: 0, type: "degrees"}, saturation: {idx: 1, type: "percent"}, lightness: {idx: 2, type: "percent"}}}}, d = {"byte": {floor: !0, max: 255}, percent: {max: 1}, degrees: {mod: 360, floor: !0}}, p = c.support = {}, f = e("<p>")[0], m = e.each;
        f.style.cssText = "background-color:rgba(1,1,1,.5)", p.rgba = f.style.backgroundColor.indexOf("rgba") > -1, m(h, function (t, e) {
            e.cache = "_" + t, e.props.alpha = {idx: 3, type: "percent", def: 1}
        }), c.fn = e.extend(c.prototype, {parse: function (r, a, l, u) {
            ...
            var i = c(t), s = i._space(), r = h[s], o = 0 === this.alpha() ? c("transparent") : this, a = o[r.cache] || r.to(o._rgba), l = a.slice();
            return i = i[r.cache], m(r.props, function (t, s) {
                var r = s.idx, o = a[r], u = i[r], c = d[s.type] || {};
            ...
            var r = s.props, o = s.cache, a = s.to, u = s.from;
            c.fn[t] = function (t) {
                if (a && !this[o] && (this[o] = a(this._rgba)), t === i)return this[o].slice();
                var s, l = e.type(t), h = "array" === l || "object" === l ? t : arguments, d = this[o].slice();
                ...
                c.fn[i] || (c.fn[i] = function (s) {
                    var r, o = e.type(s), a = "alpha" === i ? this._hsla ? "hsla" : "rgba" : t, u = this[a](), c = u[n.idx];
        ...
        var s = ["add", "remove", "toggle"], r = {border: 1, borderBottom: 1, borderColor: 1, borderLeft: 1, borderRight: 1, borderTop: 1, borderWidth: 1, margin: 1, padding: 1};
        t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function (e, i) {
            ...
            return this.queue(function () {
                var r, o = t(this), a = o.attr("class") || "", u = l.children ? o.find("*").andSelf() : o;
                u = u.map(function () {
                    var e = t(this);
                    ...
                    var e = this, i = t.Deferred(), n = jQuery.extend({}, l, {queue: !1, complete: function () {
                        i.resolve(e)
                    }});
        ...
        }, t.fn.extend({_addClass: t.fn.addClass, addClass: function (e, i, n, s) {
            return i ? t.effects.animateClass.call(this, {add: e}, i, n, s) : this._addClass(e)
        }, _removeClass: t.fn.removeClass, removeClass: function (e, i, n, s) {
            return i ? t.effects.animateClass.call(this, {remove: e}, i, n, s) : this._removeClass(e)
        }, _toggleClass: t.fn.toggleClass, toggleClass: function (i, n, s, r, o) {
            return"boolean" == typeof n || n === e ? s ? t.effects.animateClass.call(this, n ? {add: i} : {remove: i}, s, r, o) : this._toggleClass(i, n) : t.effects.animateClass.call(this, {toggle: i}, n, s, r)
        ...
        t.extend(t.effects, {version: "1.9.2", save: function (t, e) {
            ...
            function e(e) {
                ...
                var s = t(this), r = n.complete, o = n.mode;
                (s.is(":hidden") ? "hide" === o : "show" === o) ? i() : a.call(s[0], n, i)
            }

            var n = s.apply(this, arguments), r = n.mode, o = n.queue, a = t.effects.effect[n.effect], l = !a && i && t.effects[n.effect];
            return t.fx.off || !a && !l ? r ? this[r](n.duration, n.complete) : this.each(function () {
                n.complete && n.complete.call(this)
            }) : a ? o === !1 ? this.each(e) : this.queue(o || "fx", e) : l.call(this, {options: n, duration: n.duration, callback: n.complete, mode: n.mode})
    ...
    i.height = i.paddingTop = i.paddingBottom = i.borderTopWidth = i.borderBottomWidth = "hide", n.height = n.paddingTop = n.paddingBottom = n.borderTopWidth = n.borderBottomWidth = "show", t.widget("ui.accordion", {version: "1.9.2", options: {active: 0, animate: {}, collapsible: !1, event: "click", header: "> li > :first-child,> :not(li):even", heightStyle: "auto", icons: {activeHeader: "ui-icon-triangle-1-s", header: "ui-icon-triangle-1-e"}, activate: null, beforeActivate: null}, _create: function () {
        ...
        this.prevShow = this.prevHide = t(), this.element.addClass("ui-accordion ui-widget ui-helper-reset"), this.headers = this.element.find(n.header).addClass("ui-accordion-header ui-helper-reset ui-state-default ui-corner-all"), this._hoverable(this.headers), this._focusable(this.headers), this.headers.next().addClass("ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom").hide(), n.collapsible || n.active !== !1 && null != n.active || (n.active = 0), n.active < 0 && (n.active += this.headers.length), this.active = this._findActive(n.active).addClass("ui-accordion-header-active ui-state-active").toggleClass("ui-corner-all ui-corner-top"), this.active.next().addClass("ui-accordion-content-active").show(), this._createIcons(), this.refresh(), this.element.attr("role", "tablist"), this.headers.attr("role", "tab").each(function (e) {
            var n = t(this), s = n.attr("id"), r = n.next(), o = r.attr("id");
        ...
        if (!e.altKey && !e.ctrlKey) {
            var i = t.ui.keyCode, n = this.headers.length, s = this.headers.index(e.target), r = !1;
            switch (e.keyCode) {
                case i.RIGHT:
                case i.DOWN:
        ...
        var i = this.options, n = this.active, s = t(e.currentTarget), r = s[0] === n[0], o = r && i.collapsible, a = o ? t() : s.next(), l = n.next(), u = {oldHeader: n, oldPanel: l, newHeader: o ? t() : s, newPanel: a};
        ...
        var r, o, a, l = this, u = 0, c = t.length && (!e.length || t.index() < e.index()), h = this.options.animate || {}, d = c && h.down || h, p = function () {
            l._toggleComplete(s)
        };
        return"number" == typeof d && (a = d), "string" == typeof d && (o = d), o = o || d.easing || h.easing, a = a || d.duration || h.duration, e.length ? t.length ? (r = t.show().outerHeight(), e.animate(i, {duration: a, easing: o, step: function (t, e) {
            e.now = Math.round(t)
        }}), t.hide().animate(n, {duration: a, easing: o, complete: p, step: function (t, i) {
        ...
        t.extend(e.options, {navigation: !1, navigationFilter: function () {
            return this.href.toLowerCase() === location.href.toLowerCase()
        }});
        var i = e._create;
        e._create = function () {
            if (this.options.navigation) {
                var e = this, n = this.element.find(this.options.header), s = n.next(), r = n.add(s).find("a").filter(this.options.navigationFilter)[0];
        ...
        e._trigger = function (t, e, n) {
            ...
            return s ? ("beforeActivate" === t ? s = i.call(this, "changestart", e, {oldHeader: n.oldHeader, oldContent: n.oldPanel, newHeader: n.newHeader, newContent: n.newPanel}) : "activate" === t && (s = i.call(this, "change", e, {oldHeader: n.oldHeader, oldContent: n.oldPanel, newHeader: n.newHeader, newContent: n.newPanel})), s) : !1
        }
    }(jQuery, jQuery.ui.accordion.prototype), function (t, e) {
        ...
        e._create = function () {
            var t = this.options;
            null === t.animate && (t.animate = t.animated ? "slide" === t.animated ? 300 : "bounceslide" === t.animated ? {duration: 200, down: {easing: "easeOutBounce", duration: 1e3}} : t.animated : !1), i.call(this)
        }
    }(jQuery, jQuery.ui.accordion.prototype))
}(jQuery), function (t) {
    console.log("function13");
    var e = 0;
    t.widget("ui.autocomplete", {version: "1.9.2", defaultElement: "<input>", options: {appendTo: "body", autoFocus: !1, delay: 300, minLength: 1, position: {my: "left top", at: "left bottom", collision: "none"}, source: null, change: null, close: null, focus: null, open: null, response: null, search: null, select: null}, pending: 0, _create: function () {
        var e, i, n;
        ...
        }}), this._initSource(), this.menu = t("<ul>").addClass("ui-autocomplete").appendTo(this.document.find(this.options.appendTo || "body")[0]).menu({input: t(), role: null}).zIndex(this.element.zIndex() + 1).hide().data("menu"), this._on(this.menu.element, {mousedown: function (e) {
        ...
        }}), this.liveRegion = t("<span>", {role: "status", "aria-live": "polite"}).addClass("ui-helper-hidden-accessible").insertAfter(this.element), t.fn.bgiframe && this.menu.element.bgiframe(), this._on(this.window, {beforeunload: function () {
    ...
    var e, i, n, s, r = "ui-button ui-widget ui-state-default ui-corner-all", o = "ui-state-hover ui-state-active ", a = "ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon-primary ui-button-text-icon-secondary ui-button-text-only", l = function () {
    ...
    t.widget("ui.button", {version: "1.9.2", defaultElement: "<button>", options: {disabled: null, text: !0, label: null, icons: {primary: null, secondary: null}}, _create: function () {
        ...
        var o = this, a = this.options, c = "checkbox" === this.type || "radio" === this.type, h = c ? "" : "ui-state-active", d = "ui-state-focus";
        ...
        var e = this.buttonElement.removeClass(a), i = t("<span></span>", this.document[0]).addClass("ui-button-text").html(this.options.label).appendTo(e.empty()).text(), n = this.options.icons, s = n.primary && n.secondary, r = [];
    ...
    $.extend(Datepicker.prototype, {markerClassName: "hasDatepicker", maxRows: 4, log: function () {
        ...
        return{id: i, input: t, selectedDay: 0, selectedMonth: 0, selectedYear: 0, drawMonth: 0, drawYear: 0, inline: e, dpDiv: e ? bindHover($('<div class="' + this._inlineClass + ' ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"></div>')) : this.dpDiv}
        ...
        if (("focus" == s || "both" == s) && t.focus(this._showDatepicker), "button" == s || "both" == s) {
            var r = this._get(e, "buttonText"), o = this._get(e, "buttonImage");
            e.trigger = $(this._get(e, "buttonImageOnly") ? $("<img/>").addClass(this._triggerClass).attr({src: o, alt: r, title: r}) : $('<button type="button"></button>').addClass(this._triggerClass).html("" == o ? r : $("<img/>").attr({src: o, alt: r, title: r}))), t[n ? "before" : "after"](e.trigger), e.trigger.click(function () {
        ...
        if (extendRemove(r.settings, n || {}), e = e && e.constructor == Date ? this._formatDate(r, e) : e, this._dialogInput.val(e), this._pos = s ? s.length ? s : [s.pageX, s.pageY] : null, !this._pos) {
            var a = document.documentElement.clientWidth, l = document.documentElement.clientHeight, u = document.documentElement.scrollLeft || document.body.scrollLeft, c = document.documentElement.scrollTop || document.body.scrollTop;
        ...
        if ("string" == typeof e && (s = {}, s[e] = i), n) {
            ...
            var r = this._getDateDatepicker(t, !0), o = this._getMinMaxDate(n, "min"), a = this._getMinMaxDate(n, "max");
        ...
        if (t = t.target || t, "input" != t.nodeName.toLowerCase() && (t = $("input", t.parentNode)[0]), !$.datepicker._isDisabledDatepicker(t) && $.datepicker._lastInput != t) {
            ...
            if (n !== !1) {
                ...
                if ($.datepicker._pos = null, e.dpDiv.empty(), e.dpDiv.css({position: "absolute", display: "block", top: "-1000px"}), $.datepicker._updateDatepicker(e), r = $.datepicker._checkOffset(e, r, s), e.dpDiv.css({position: $.datepicker._inDialog && $.blockUI ? "static" : s ? "fixed" : "absolute", display: "none", left: r.left + "px", top: r.top + "px"}), !e.inline) {
                    var o = $.datepicker._get(e, "showAnim"), a = $.datepicker._get(e, "duration"), l = function () {
        ...
        var n = this._getNumberOfMonths(t), s = n[1], r = 17;
        ...
        var n = t.dpDiv.outerWidth(), s = t.dpDiv.outerHeight(), r = t.input ? t.input.outerWidth() : 0, o = t.input ? t.input.outerHeight() : 0, a = document.documentElement.clientWidth + (i ? 0 : $(document).scrollLeft()), l = document.documentElement.clientHeight + (i ? 0 : $(document).scrollTop());
        ...
        if (e && (!t || e == $.data(t, PROP_NAME)) && this._datepickerShowing) {
            ...
            r && r.apply(e.input ? e.input[0] : null, [e.input ? e.input.val() : "", e]), this._lastInput = null, this._inDialog && (this._dialogInput.css({position: "absolute", left: "0", top: "-100px"}), $.blockUI && ($.unblockUI(), $("body").append(this.dpDiv))), this._inDialog = !1
        }
        ...
        for (var s = (i ? i.dayNamesShort : null) || this._defaults.dayNamesShort, r = (i ? i.dayNames : null) || this._defaults.dayNames, o = (i ? i.monthNamesShort : null) || this._defaults.monthNamesShort, a = (i ? i.monthNames : null) || this._defaults.monthNames, l = -1, u = -1, c = -1, h = -1, d = !1, p = function (e) {
            ...
            var i = p(t), n = "@" == t ? 14 : "!" == t ? 20 : "y" == t && i ? 4 : "o" == t ? 3 : 2, s = new RegExp("^\\d{1," + n + "}"), r = e.substring(v).match(s);
            ...
            v++
        }, v = 0, y = 0; y < t.length; y++)if (d)"'" != t.charAt(y) || p("'") ? g() : d = !1; else switch (t.charAt(y)) {
            case"d":
                c = f("d");
                break;
            case"D":
        ...
        if (-1 == l ? l = (new Date).getFullYear() : 100 > l && (l += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (n >= l ? 0 : -100)), h > -1)for (u = 1, c = h; ;) {
        ...
        if (!e)return"";
        var n = (i ? i.dayNamesShort : null) || this._defaults.dayNamesShort, s = (i ? i.dayNames : null) || this._defaults.dayNames, r = (i ? i.monthNamesShort : null) || this._defaults.monthNamesShort, o = (i ? i.monthNames : null) || this._defaults.monthNames, a = function (e) {
        ...
        if (e)for (var d = 0; d < t.length; d++)if (h)"'" != t.charAt(d) || a("'") ? c += t.charAt(d) : h = !1; else switch (t.charAt(d)) {
            case"d":
                c += l("d", e.getDate(), 2);
                break;
            case"D":
        ...
        for (var e = "", i = !1, n = function (e) {
            ...
            return i && s++, i
        }, s = 0; s < t.length; s++)if (i)"'" != t.charAt(s) || n("'") ? e += t.charAt(s) : i = !1; else switch (t.charAt(s)) {
            case"d":
            case"m":
            case"y":
            case"@":
        ...
        if (t.input.val() != t.lastVal) {
            var i, n, s = this._get(t, "dateFormat"), r = t.lastVal = t.input ? t.input.val() : null;
        ...
        var x = t.inline ? "" : '<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" data-handler="hide" data-event="click">' + this._get(t, "closeText") + "</button>", k = n ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (i ? x : "") + (this._isInRange(t, w) ? '<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" data-handler="today" data-event="click">' + b + "</button>" : "") + (i ? "" : x) + "</div>" : "", C = parseInt(this._get(t, "firstDay"), 10);
        C = isNaN(C) ? 0 : C;
        var T = this._get(t, "showWeek"), S = this._get(t, "dayNames");
        this._get(t, "dayNamesShort");
        var E = this._get(t, "dayNamesMin"), P = this._get(t, "monthNames"), D = this._get(t, "monthNamesShort"), I = this._get(t, "beforeShowDay"), M = this._get(t, "showOtherMonths"), A = this._get(t, "selectOtherMonths");
        this._get(t, "calculateWeek") || this.iso8601Week;
        for (var N = this._getDefaultDate(t), V = "", j = 0; j < o[0]; j++) {
            var O = "";
            this.maxRows = 4;
            for (var F = 0; F < o[1]; F++) {
                var H = this._daylightSavingAdjust(new Date(f, p, t.selectedDay)), L = " ui-corner-all", B = "";
                if (u) {
                    if (B += '<div class="ui-datepicker-group', o[1] > 1)switch (F) {
                        case 0:
                ...
                B += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + L + '">' + (/all|left/.test(L) && 0 == j ? i ? _ : v : "") + (/all|right/.test(L) && 0 == j ? i ? v : _ : "") + this._generateMonthYearHeader(t, p, f, h, d, j > 0 || F > 0, P, D) + '</div><table class="ui-datepicker-calendar"><thead>' + "<tr>";
                ...
                var U = (this._getFirstDayOfMonth(f, p) - C + 7) % 7, K = Math.ceil((U + q) / 7), Y = u ? this.maxRows > K ? this.maxRows : K : K;
                this.maxRows = Y;
                for (var X = this._daylightSavingAdjust(new Date(f, p, 1 - U)), G = 0; Y > G; G++) {
                    ...
                    for (var Q = T ? '<td class="ui-datepicker-week-col">' + this._get(t, "calculateWeek")(X) + "</td>" : "", R = 0; 7 > R; R++) {
                        var J = I ? I.apply(t.input ? t.input[0] : null, [X]) : [!0, ""], Z = X.getMonth() != p, te = Z && !A || !J[0] || h && h > X || d && X > d;
                ...
                p++, p > 11 && (p = 0, f++), B += "</tbody></table>" + (u ? "</div>" + (o[0] > 0 && F == o[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : "") : ""), O += B
            }
            V += O
        }
        ...
        var l = this._get(t, "changeMonth"), u = this._get(t, "changeYear"), c = this._get(t, "showMonthAfterYear"), h = '<div class="ui-datepicker-title">', d = "";
        if (r || !l)d += '<span class="ui-datepicker-month">' + o[e] + "</span>"; else {
        ...
        if (c || (h += d + (!r && l && u ? "" : "&#xa0;")), !t.yearshtml)if (t.yearshtml = "", r || !u)h += '<span class="ui-datepicker-year">' + i + "</span>"; else {
            var g = this._get(t, "yearRange").split(":"), v = (new Date).getFullYear(), y = function (t) {
    ...
    t.widget("ui.dialog", {version: "1.9.2", options: {autoOpen: !0, buttons: {}, closeOnEscape: !0, closeText: "close", dialogClass: "", draggable: !0, hide: null, height: "auto", maxHeight: !1, maxWidth: !1, minHeight: 150, minWidth: 150, modal: !1, position: {my: "center", at: "center", of: window, collision: "fit", using: function (e) {
        ...
        var e, n, s, r, o, a = this, l = this.options, u = l.title || "&#160;";
        e = (this.uiDialog = t("<div>")).addClass(i + l.dialogClass).css({display: "none", outline: 0, zIndex: l.zIndex}).attr("tabIndex", -1).keydown(function (e) {
        ...
        return s.modal && !e || !s.stack && !s.modal ? this._trigger("focus", i) : (s.zIndex > t.ui.dialog.maxZ && (t.ui.dialog.maxZ = s.zIndex), this.overlay && (t.ui.dialog.maxZ += 1, t.ui.dialog.overlay.maxZ = t.ui.dialog.maxZ, this.overlay.$el.css("z-index", t.ui.dialog.overlay.maxZ)), n = {scrollTop: this.element.scrollTop(), scrollLeft: this.element.scrollLeft()}, t.ui.dialog.maxZ += 1, this.uiDialog.css("z-index", t.ui.dialog.maxZ), this.element.attr(n), this._trigger("focus", i), this)
    }, open: function () {
        if (!this._isOpen) {
        ...
        this.uiDialogButtonPane.remove(), this.uiButtonSet.empty(), "object" == typeof e && null !== e && t.each(e, function () {
            ...
            var s, r;
            n = t.isFunction(n) ? {click: n, text: e} : n, n = t.extend({type: "button"}, n), r = n.click, n.click = function () {
        ...
        var s = this, r = this.options, o = this.uiDialog.css("position"), a = "string" == typeof i ? i : "n,e,s,w,se,sw,ne,nw";
        this.uiDialog.resizable({cancel: ".ui-dialog-content", containment: "document", alsoResize: this.element, maxWidth: r.maxWidth, maxHeight: r.maxHeight, minWidth: r.minWidth, minHeight: this._minHeight(), handles: a, start: function (e, i) {
        ...
        }), e = {my: n[0] + (s[0] < 0 ? s[0] : "+" + s[0]) + " " + n[1] + (s[1] < 0 ? s[1] : "+" + s[1]), at: n.join(" ")}), e = t.extend({}, t.ui.dialog.prototype.options.position, e)) : e = t.ui.dialog.prototype.options.position, i = this.uiDialog.is(":visible"), i || this.uiDialog.show(), this.uiDialog.position(e), i || this.uiDialog.hide()
        ...
        var e, i, n, s = this.options, r = this.uiDialog.is(":visible");
        this.element.show().css({width: "auto", minHeight: 0, height: 0}), s.minWidth > s.width && (s.width = s.minWidth), e = this.uiDialog.css({height: "auto", width: s.width}).outerHeight(), i = Math.max(0, s.minHeight - e), "auto" === s.height ? t.support.minHeight ? this.element.css({minHeight: i, height: "auto"}) : (this.uiDialog.show(), n = this.element.css("height", "auto").height(), r || this.uiDialog.hide(), this.element.height(Math.max(n, i))) : this.element.height(Math.max(s.height - e, 0)), this.uiDialog.is(":data(resizable)") && this.uiDialog.resizable("option", "minHeight", this._minHeight())
    }}), t.extend(t.ui.dialog, {uuid: 0, maxZ: 0, getTitleId: function (t) {
        var e = t.attr("id");
        return e || (this.uuid += 1, e = this.uuid), "ui-dialog-title-" + e
    }, overlay: function (e) {
        this.$el = t.ui.dialog.overlay.create(e)
    }}), t.extend(t.ui.dialog.overlay, {instances: [], oldInstances: [], maxZ: 0, events: t.map("focus,mousedown,mouseup,keydown,keypress,click".split(","),function (t) {
        ...
        }), i.appendTo(document.body).css({width: this.width(), height: this.height()}), t.fn.bgiframe && i.bgiframe(), this.instances.push(i), i
    }, destroy: function (e) {
    ...
    }}), t.extend(t.ui.dialog.overlay.prototype, {destroy: function () {
        t.ui.dialog.overlay.destroy(this.$el)
    }})
}(jQuery), function (t) {
    console.log("function17");
    var e = /up|down|vertical/, i = /up|left|vertical|horizontal/;
    t.effects.effect.blind = function (n, s) {
        var r, o, a, l = t(this), u = ["position", "top", "bottom", "left", "right", "height", "width"], c = t.effects.setMode(l, n.mode || "hide"), h = n.direction || "up", d = e.test(h), p = d ? "height" : "width", f = d ? "top" : "left", m = i.test(h), g = {}, v = "show" === c;
        l.parent().is(".ui-effects-wrapper") ? t.effects.save(l.parent(), u) : t.effects.save(l, u), l.show(), r = t.effects.createWrapper(l).css({overflow: "hidden"}), o = r[p](), a = parseFloat(r.css(f)) || 0, g[p] = v ? o : 0, m || (l.css(d ? "bottom" : "right", 0).css(d ? "top" : "left", "auto").css({position: "absolute"}), g[f] = v ? a : o + a), v && (r.css(p, 0), m || r.css(f, a + o)), r.animate(g, {duration: n.duration, easing: n.easing, queue: !1, complete: function () {
            "hide" === c && l.hide(), t.effects.restore(l, u), t.effects.removeWrapper(l), s()
        }})
    }
}(jQuery), function (t) {
    console.log("function18");
    t.effects.effect.bounce = function (e, i) {
        var n, s, r, o = t(this), a = ["position", "top", "bottom", "left", "right", "height", "width"], l = t.effects.setMode(o, e.mode || "effect"), u = "hide" === l, c = "show" === l, h = e.direction || "up", d = e.distance, p = e.times || 5, f = 2 * p + (c || u ? 1 : 0), m = e.duration / f, g = e.easing, v = "up" === h || "down" === h ? "top" : "left", y = "up" === h || "left" === h, _ = o.queue(), b = _.length;
        for ((c || u) && a.push("opacity"), t.effects.save(o, a), o.show(), t.effects.createWrapper(o), d || (d = o["top" === v ? "outerHeight" : "outerWidth"]() / 3), c && (r = {opacity: 1}, r[v] = 0, o.css("opacity", 0).css(v, y ? 2 * -d : 2 * d).animate(r, m, g)), u && (d /= Math.pow(2, p - 1)), r = {}, r[v] = 0, n = 0; p > n; n++)s = {}, s[v] = (y ? "-=" : "+=") + d, o.animate(s, m, g).animate(r, m, g), d = u ? 2 * d : d / 2;
        u && (s = {opacity: 0}, s[v] = (y ? "-=" : "+=") + d, o.animate(s, m, g)), o.queue(function () {
            u && o.hide(), t.effects.restore(o, a), t.effects.removeWrapper(o), i()
        }), b > 1 && _.splice.apply(_, [1, 0].concat(_.splice(b, f + 1))), o.dequeue()
    }
}(jQuery), function (t) {
    console.log("function19");
    t.effects.effect.clip = function (e, i) {
        var n, s, r, o = t(this), a = ["position", "top", "bottom", "left", "right", "height", "width"], l = t.effects.setMode(o, e.mode || "hide"), u = "show" === l, c = e.direction || "vertical", h = "vertical" === c, d = h ? "height" : "width", p = h ? "top" : "left", f = {};
        t.effects.save(o, a), o.show(), n = t.effects.createWrapper(o).css({overflow: "hidden"}), s = "IMG" === o[0].tagName ? n : o, r = s[d](), u && (s.css(d, 0), s.css(p, r / 2)), f[d] = u ? r : 0, f[p] = u ? 0 : r / 2, s.animate(f, {queue: !1, duration: e.duration, easing: e.easing, complete: function () {
            u || o.hide(), t.effects.restore(o, a), t.effects.removeWrapper(o), i()
        }})
    }
}(jQuery), function (t) {
    ...
    t.effects.effect.drop = function (e, i) {
        var n, s = t(this), r = ["position", "top", "bottom", "left", "right", "opacity", "height", "width"], o = t.effects.setMode(s, e.mode || "hide"), a = "show" === o, l = e.direction || "left", u = "up" === l || "down" === l ? "top" : "left", c = "up" === l || "left" === l ? "pos" : "neg", h = {opacity: a ? 1 : 0};
        t.effects.save(s, r), s.show(), t.effects.createWrapper(s), n = e.distance || s["top" === u ? "outerHeight" : "outerWidth"](!0) / 2, a && s.css("opacity", 0).css(u, "pos" === c ? -n : n), h[u] = (a ? "pos" === c ? "+=" : "-=" : "pos" === c ? "-=" : "+=") + n, s.animate(h, {queue: !1, duration: e.duration, easing: e.easing, complete: function () {
    ...
    t.effects.effect.explode = function (e, i) {
        ...
        var r, o, a, l, u, c, h = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3, d = h, p = t(this), f = t.effects.setMode(p, e.mode || "hide"), m = "show" === f, g = p.show().css("visibility", "hidden").offset(), v = Math.ceil(p.outerWidth() / d), y = Math.ceil(p.outerHeight() / h), _ = [];
    ...
    console.log("function23");
    t.effects.effect.fold = function (e, i) {
        var n, s, r = t(this), o = ["position", "top", "bottom", "left", "right", "height", "width"], a = t.effects.setMode(r, e.mode || "hide"), l = "show" === a, u = "hide" === a, c = e.size || 15, h = /([0-9]+)%/.exec(c), d = !!e.horizFirst, p = l !== d, f = p ? ["width", "height"] : ["height", "width"], m = e.duration / 2, g = {}, v = {};
        t.effects.save(r, o), r.show(), n = t.effects.createWrapper(r).css({overflow: "hidden"}), s = p ? [n.width(), n.height()] : [n.height(), n.width()], h && (c = parseInt(h[1], 10) / 100 * s[u ? 0 : 1]), l && n.css(d ? {height: 0, width: c} : {height: c, width: 0}), g[f[0]] = l ? s[0] : c, v[f[1]] = l ? s[1] : 0, n.animate(g, m, e.easing).animate(v, m, e.easing, function () {
            u && r.hide(), t.effects.restore(r, o), t.effects.removeWrapper(r), i()
        })
    }
}(jQuery), function (t) {
    console.log("function24");
    t.effects.effect.highlight = function (e, i) {
        var n = t(this), s = ["backgroundImage", "backgroundColor", "opacity"], r = t.effects.setMode(n, e.mode || "show"), o = {backgroundColor: n.css("backgroundColor")};
        "hide" === r && (o.opacity = 0), t.effects.save(n, s), n.show().css({backgroundImage: "none", backgroundColor: e.color || "#ffff99"}).animate(o, {queue: !1, duration: e.duration, easing: e.easing, complete: function () {
            "hide" === r && n.hide(), t.effects.restore(n, s), i()
        }})
    }
}(jQuery), function (t) {
    console.log("function25");
    t.effects.effect.pulsate = function (e, i) {
        var n, s = t(this), r = t.effects.setMode(s, e.mode || "show"), o = "show" === r, a = "hide" === r, l = o || "hide" === r, u = 2 * (e.times || 5) + (l ? 1 : 0), c = e.duration / u, h = 0, d = s.queue(), p = d.length;
        for ((o || !s.is(":visible")) && (s.css("opacity", 0).show(), h = 1), n = 1; u > n; n++)s.animate({opacity: h}, c, e.easing), h = 1 - h;
        s.animate({opacity: h}, c, e.easing), s.queue(function () {
            a && s.hide(), i()
        }), p > 1 && d.splice.apply(d, [1, 0].concat(d.splice(p, u + 1))), s.dequeue()
    }
}(jQuery), function (t) {
    console.log("function26");
    t.effects.effect.puff = function (e, i) {
        var n = t(this), s = t.effects.setMode(n, e.mode || "hide"), r = "hide" === s, o = parseInt(e.percent, 10) || 150, a = o / 100, l = {height: n.height(), width: n.width(), outerHeight: n.outerHeight(), outerWidth: n.outerWidth()};
        t.extend(e, {effect: "scale", queue: !1, fade: !0, mode: s, complete: i, percent: r ? o : 100, from: r ? l : {height: l.height * a, width: l.width * a, outerHeight: l.outerHeight * a, outerWidth: l.outerWidth * a}}), n.effect(e)
    }, t.effects.effect.scale = function (e, i) {
        var n = t(this), s = t.extend(!0, {}, e), r = t.effects.setMode(n, e.mode || "effect"), o = parseInt(e.percent, 10) || (0 === parseInt(e.percent, 10) ? 0 : "hide" === r ? 0 : 100), a = e.direction || "both", l = e.origin, u = {height: n.height(), width: n.width(), outerHeight: n.outerHeight(), outerWidth: n.outerWidth()}, c = {y: "horizontal" !== a ? o / 100 : 1, x: "vertical" !== a ? o / 100 : 1};
        s.effect = "size", s.queue = !1, s.complete = i, "effect" !== r && (s.origin = l || ["middle", "center"], s.restore = !0), s.from = e.from || ("show" === r ? {height: 0, width: 0, outerHeight: 0, outerWidth: 0} : u), s.to = {height: u.height * c.y, width: u.width * c.x, outerHeight: u.outerHeight * c.y, outerWidth: u.outerWidth * c.x}, s.fade && ("show" === r && (s.from.opacity = 0, s.to.opacity = 1), "hide" === r && (s.from.opacity = 1, s.to.opacity = 0)), n.effect(s)
    }, t.effects.effect.size = function (e, i) {
        var n, s, r, o = t(this), a = ["position", "top", "bottom", "left", "right", "width", "height", "overflow", "opacity"], l = ["position", "top", "bottom", "left", "right", "overflow", "opacity"], u = ["width", "height", "overflow"], c = ["fontSize"], h = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"], d = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"], p = t.effects.setMode(o, e.mode || "effect"), f = e.restore || "effect" !== p, m = e.scale || "both", g = e.origin || ["middle", "center"], v = o.css("position"), y = f ? a : l, _ = {height: 0, width: 0, outerHeight: 0, outerWidth: 0};
        "show" === p && o.show(), n = {height: o.height(), width: o.width(), outerHeight: o.outerHeight(), outerWidth: o.outerWidth()}, "toggle" === e.mode && "show" === p ? (o.from = e.to || _, o.to = e.from || n) : (o.from = e.from || ("show" === p ? _ : n), o.to = e.to || ("hide" === p ? _ : n)), r = {from: {y: o.from.height / n.height, x: o.from.width / n.width}, to: {y: o.to.height / n.height, x: o.to.width / n.width}}, ("box" === m || "both" === m) && (r.from.y !== r.to.y && (y = y.concat(h), o.from = t.effects.setTransition(o, h, r.from.y, o.from), o.to = t.effects.setTransition(o, h, r.to.y, o.to)), r.from.x !== r.to.x && (y = y.concat(d), o.from = t.effects.setTransition(o, d, r.from.x, o.from), o.to = t.effects.setTransition(o, d, r.to.x, o.to))), ("content" === m || "both" === m) && r.from.y !== r.to.y && (y = y.concat(c).concat(u), o.from = t.effects.setTransition(o, c, r.from.y, o.from), o.to = t.effects.setTransition(o, c, r.to.y, o.to)), t.effects.save(o, y), o.show(), t.effects.createWrapper(o), o.css("overflow", "hidden").css(o.from), g && (s = t.effects.getBaseline(g, n), o.from.top = (n.outerHeight - o.outerHeight()) * s.y, o.from.left = (n.outerWidth - o.outerWidth()) * s.x, o.to.top = (n.outerHeight - o.to.outerHeight) * s.y, o.to.left = (n.outerWidth - o.to.outerWidth) * s.x), o.css(o.from), ("content" === m || "both" === m) && (h = h.concat(["marginTop", "marginBottom"]).concat(c), d = d.concat(["marginLeft", "marginRight"]), u = a.concat(h).concat(d), o.find("*[width]").each(function () {
            ...
            0 === o.to.opacity && o.css("opacity", o.from.opacity), "hide" === p && o.hide(), t.effects.restore(o, y), f || ("static" === v ? o.css({position: "relative", top: o.to.top, left: o.to.left}) : t.each(["top", "left"], function (t, e) {
                o.css(e, function (e, i) {
                    var n = parseInt(i, 10), s = t ? o.to.left : o.to.top;
    ...
    console.log("function27");
    t.effects.effect.shake = function (e, i) {
        var n, s = t(this), r = ["position", "top", "bottom", "left", "right", "height", "width"], o = t.effects.setMode(s, e.mode || "effect"), a = e.direction || "left", l = e.distance || 20, u = e.times || 3, c = 2 * u + 1, h = Math.round(e.duration / c), d = "up" === a || "down" === a ? "top" : "left", p = "up" === a || "left" === a, f = {}, m = {}, g = {}, v = s.queue(), y = v.length;
    ...
    console.log("function28");
    t.effects.effect.slide = function (e, i) {
        var n, s = t(this), r = ["position", "top", "bottom", "left", "right", "width", "height"], o = t.effects.setMode(s, e.mode || "show"), a = "show" === o, l = e.direction || "left", u = "up" === l || "down" === l ? "top" : "left", c = "up" === l || "left" === l, h = {};
        t.effects.save(s, r), s.show(), n = e.distance || s["top" === u ? "outerHeight" : "outerWidth"](!0), t.effects.createWrapper(s).css({overflow: "hidden"}), a && s.css(u, c ? isNaN(n) ? "-" + n : -n : n), h[u] = (a ? c ? "+=" : "-=" : c ? "-=" : "+=") + n, s.animate(h, {queue: !1, duration: e.duration, easing: e.easing, complete: function () {
            "hide" === o && s.hide(), t.effects.restore(s, r), t.effects.removeWrapper(s), i()
        }})
    }
}(jQuery), function (t) {
    ...
    console.log("function30");
    var e = !1;
    t.widget("ui.menu", {version: "1.9.2", defaultElement: "<ul>", delay: 300, options: {icons: {submenu: "ui-icon-carat-1-e"}, menus: "ul", position: {my: "left top", at: "right top"}, role: "menu", blur: null, focus: null, select: null}, _create: function () {
        this.activeMenu = this.element, this.element.uniqueId().addClass("ui-menu ui-widget ui-widget-content ui-corner-all").toggleClass("ui-menu-icons", !!this.element.find(".ui-icon").length).attr({role: this.options.role, tabIndex: 0}).bind("click" + this.eventNamespace, t.proxy(function (t) {
    ...
    t.ui = t.ui || {};
    var s, r = Math.max, o = Math.abs, a = Math.round, l = /left|center|right/, u = /top|center|bottom/, c = /[\+\-]\d+%?/, h = /^\w+/, d = /%$/, p = t.fn.position;
    t.position = {scrollbarWidth: function () {
        if (s !== e)return s;
        var i, n, r = t("<div style='display:block;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"), o = r.children()[0];
        ...
        e = t.extend({}, e);
        var s, d, f, m, g, v = t(e.of), y = t.position.getWithinInfo(e.within), _ = t.position.getScrollInfo(y), b = v[0], w = (e.collision || "flip").split(" "), x = {};
        return 9 === b.nodeType ? (d = v.width(), f = v.height(), m = {top: 0, left: 0}) : t.isWindow(b) ? (d = v.width(), f = v.height(), m = {top: v.scrollTop(), left: v.scrollLeft()}) : b.preventDefault ? (e.at = "left top", d = f = 0, m = {top: b.pageY, left: b.pageX}) : (d = v.outerWidth(), f = v.outerHeight(), m = v.offset()), g = t.extend({}, m), t.each(["my", "at"], function () {
            ...
            var l, u, c = t(this), h = c.outerWidth(), p = c.outerHeight(), b = n(this, "marginLeft"), k = n(this, "marginTop"), C = h + b + n(this, "marginRight") + _.width, T = p + k + n(this, "marginBottom") + _.height, S = t.extend({}, g), E = i(x.my, c.outerWidth(), c.outerHeight());
            "right" === e.my[0] ? S.left -= h : "center" === e.my[0] && (S.left -= h / 2), "bottom" === e.my[1] ? S.top -= p : "center" === e.my[1] && (S.top -= p / 2), S.left += E[0], S.top += E[1], t.support.offsetFractions || (S.left = a(S.left), S.top = a(S.top)), l = {marginLeft: b, marginTop: k}, t.each(["left", "top"], function (i, n) {
                t.ui.position[w[i]] && t.ui.position[w[i]][n](S, {targetWidth: d, targetHeight: f, elemWidth: h, elemHeight: p, collisionPosition: l, collisionWidth: C, collisionHeight: T, offset: [s[0] + E[0], s[1] + E[1]], my: e.my, at: e.at, within: y, elem: c})
            }), t.fn.bgiframe && c.bgiframe(), e.using && (u = function (t) {
                var i = m.left - S.left, n = i + d - h, s = m.top - S.top, a = s + f - p, l = {target: {element: v, left: m.left, top: m.top, width: d, height: f}, element: {element: c, left: S.left, top: S.top, width: h, height: p}, horizontal: 0 > n ? "left" : i > 0 ? "right" : "center", vertical: 0 > a ? "top" : s > 0 ? "bottom" : "middle"};
        ...
        var i, n, s = e.within, r = s.offset.left + s.scrollLeft, a = s.width, l = s.isWindow ? s.scrollLeft : s.offset.left, u = t.left - e.collisionPosition.marginLeft, c = u - l, h = u + e.collisionWidth - a - l, d = "left" === e.my[0] ? -e.elemWidth : "right" === e.my[0] ? e.elemWidth : 0, p = "left" === e.at[0] ? e.targetWidth : "right" === e.at[0] ? -e.targetWidth : 0, f = -2 * e.offset[0];
        ...
        var i, n, s = e.within, r = s.offset.top + s.scrollTop, a = s.height, l = s.isWindow ? s.scrollTop : s.offset.top, u = t.top - e.collisionPosition.marginTop, c = u - l, h = u + e.collisionHeight - a - l, d = "top" === e.my[1], p = d ? -e.elemHeight : "bottom" === e.my[1] ? e.elemHeight : 0, f = "top" === e.at[1] ? e.targetHeight : "bottom" === e.at[1] ? -e.targetHeight : 0, m = -2 * e.offset[1];
        ...
        e = document.createElement(o ? "div" : "body"), n = {visibility: "hidden", width: 0, height: 0, border: 0, margin: 0, background: "none"}, o && t.extend(n, {position: "absolute", left: "-1000px", top: "-1000px"});
        ...
        t.fn.position = function (n) {
            ...
            return 1 === s.length && (s[1] = s[0]), /^\d/.test(s[0]) && (s[0] = "+" + s[0]), /^\d/.test(s[1]) && (s[1] = "+" + s[1]), 1 === r.length && (/left|center|right/.test(r[0]) ? r[1] = "center" : (r[1] = r[0], r[0] = "center")), i.call(this, t.extend(n, {at: r[0] + s[0] + " " + r[1] + s[1], offset: e}))
        }
    }(jQuery)
}(jQuery), function (t, e) {
    console.log("function32");
    ...
    t.widget("ui.slider", t.ui.mouse, {version: "1.9.2", widgetEventPrefix: "slide", options: {animate: !1, distance: 0, max: 100, min: 0, orientation: "horizontal", range: !1, step: 1, value: 0, values: null}, _create: function () {
        var i, n, s = this.options, r = this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"), o = "<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>", a = [];
        ...
        var i, n, s, r, o, a, l, u, c = this, h = this.options;
        return h.disabled ? !1 : (this.elementSize = {width: this.element.outerWidth(), height: this.element.outerHeight()}, this.elementOffset = this.element.offset(), i = {x: e.pageX, y: e.pageY}, n = this._normValueFromMouse(i), s = this._valueMax() - this._valueMin() + 1, this.handles.each(function (e) {
            var i = Math.abs(n - c.values(e));
            s > i && (s = i, r = t(this), o = e)
        }), h.range === !0 && this.values(1) === h.min && (o += 1, r = t(this.handles[o])), a = this._start(e, o), a === !1 ? !1 : (this._mouseSliding = !0, this._handleIndex = o, r.addClass("ui-state-active").focus(), l = r.offset(), u = !t(e.target).parents().andSelf().is(".ui-slider-handle"), this._clickOffset = u ? {left: 0, top: 0} : {left: e.pageX - l.left - r.width() / 2, top: e.pageY - l.top - r.height() / 2 - (parseInt(r.css("borderTopWidth"), 10) || 0) - (parseInt(r.css("borderBottomWidth"), 10) || 0) + (parseInt(r.css("marginTop"), 10) || 0)}, this.handles.hasClass("ui-state-hover") || this._slide(e, o, n), this._animateOff = !0, !0))
    }, _mouseStart: function () {
        return!0
    }, _mouseDrag: function (t) {
        ...
        var n, s, r;
        this.options.values && this.options.values.length ? (n = this.values(e ? 0 : 1), 2 === this.options.values.length && this.options.range === !0 && (0 === e && i > n || 1 === e && n > i) && (i = n), i !== this.values(e) && (s = this.values(), s[e] = i, r = this._trigger("slide", t, {handle: this.handles[e], value: i, values: s}), n = this.values(e ? 0 : 1), r !== !1 && this.values(e, i, !0))) : i !== this.value() && (r = this._trigger("slide", t, {handle: this.handles[e], value: i}), r !== !1 && this.value(i))
    }, _stop: function (t, e) {
        var i = {handle: this.handles[e], value: this.value()};
        ...
        var e, i, n, s, r, o = this.options.range, a = this.options, l = this, u = this._animateOff ? !1 : a.animate, c = {};
        this.options.values && this.options.values.length ? this.handles.each(function (n) {
            i = 100 * ((l.values(n) - l._valueMin()) / (l._valueMax() - l._valueMin())), c["horizontal" === l.orientation ? "left" : "bottom"] = i + "%", t(this).stop(1, 1)[u ? "animate" : "css"](c, a.animate), l.options.range === !0 && ("horizontal" === l.orientation ? (0 === n && l.range.stop(1, 1)[u ? "animate" : "css"]({left: i + "%"}, a.animate), 1 === n && l.range[u ? "animate" : "css"]({width: i - e + "%"}, {queue: !1, duration: a.animate})) : (0 === n && l.range.stop(1, 1)[u ? "animate" : "css"]({bottom: i + "%"}, a.animate), 1 === n && l.range[u ? "animate" : "css"]({height: i - e + "%"}, {queue: !1, duration: a.animate}))), e = i
    ...
    t.widget("ui.tabs", {version: "1.9.2", delay: 300, options: {active: null, collapsible: !1, event: "click", heightStyle: "content", hide: null, show: null, activate: null, beforeActivate: null, beforeLoad: null, load: null}, _create: function () {
        var e = this, i = this.options, n = i.active, s = location.hash.substring(1);
        ...
        this.tablist = this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").attr("role", "tablist"), this.tabs = this.tablist.find("> li:has(a[href])").addClass("ui-state-default ui-corner-top").attr({role: "tab", tabIndex: -1}), this.anchors = this.tabs.map(function () {
            ...
            var r, o, a, l = t(s).uniqueId().attr("id"), u = t(s).closest("li"), c = u.attr("aria-controls");
        ...
        var i = this.options, n = this.active, s = t(e.currentTarget), r = s.closest("li"), o = r[0] === n[0], a = o && i.collapsible, l = a ? t() : this._getPanelForTab(r), u = n.length ? this._getPanelForTab(n) : t(), c = {oldTab: n, oldPanel: u, newTab: a ? t() : r, newPanel: l};
        ...
        }) : (i.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"), a.hide(), s()), a.attr({"aria-expanded": "false", "aria-hidden": "true"}), i.oldTab.attr("aria-selected", "false"), o.length && a.length ? i.oldTab.attr("tabIndex", -1) : o.length && this.tabs.filter(function () {
            return 0 === t(this).attr("tabIndex")
        ...
        e = this._getIndex(e);
        var s = this, r = this.tabs.eq(e), o = r.find(".ui-tabs-anchor"), a = this._getPanelForTab(r), l = {tab: r, panel: a};
        ...
        return t.extend({}, s, {error: function (t, e) {
            try {
    ...
    }}), t.widget("ui.tabs", t.ui.tabs, {options: {add: null, remove: null, tabTemplate: "<li><a href='#{href}'><span>#{label}</span></a></li>"}, add: function (i, n, s) {
        s === e && (s = this.anchors.length);
        var r, o, a = this.options, l = t(a.tabTemplate.replace(/#\{href\}/g, i).replace(/#\{label\}/g, n)), u = i.indexOf("#") ? this._tabId(l) : i.replace("#", "");
    ...
    }(), t.widget("ui.tabs", t.ui.tabs, {_trigger: function (e, i, n) {
        var s = t.extend({}, n);
        ...
        return n && (t.isArray(n) ? (e = n[0], i = n[1]) : e = i = n), n ? {show: i, hide: e} : null
        ...
        var s = this, r = e.newPanel, o = e.oldPanel, a = this._getFx();
    ...
    t.widget("ui.tooltip", {version: "1.9.2", options: {content: function () {
        ...
        if (s) {
            ...
            n.is("[title]") && (i && "mouseover" === i.type ? n.attr("title", "") : n.removeAttr("title")), o = this._tooltip(n), e(n, o.attr("id")), o.find(".ui-tooltip-content").html(s), this.options.track && i && /^mouse/.test(i.type) ? (this._on(this.document, {mousemove: r}), r(i)) : o.position(t.extend({of: n}, this.options.position)), o.hide(), this._show(o, this.options.show), this.options.show && this.options.show.delay && (l = setInterval(function () {
                o.is(":visible") && (r(u.of), clearInterval(l))
            }, t.fx.interval)), this._trigger("open", i, {tooltip: o}), a = {keyup: function (e) {
        ...
        var i = "ui-tooltip-" + n++, s = t("<div>").attr({id: i, role: "tooltip"}).addClass("ui-tooltip ui-widget ui-corner-all ui-widget-content " + (this.options.tooltipClass || ""));
    ...
    function r(r) {
        function p(t) {
            X++ || (G(), W && (S[U] = {s: [t]}), L && (t = L.apply(r, [t])), n(O, r, [t, w, r]), n(H, r, [r, w]))
        }

        function M(t) {
            X++ || (G(), W && t != x && (S[U] = t), n(F, r, [r, t]), n(H, r, [r, t]))
        }

        r = t.extend({}, P, r);
        var A, N, V, j, $, O = r.success, F = r.error, H = r.complete, L = r.dataFilter, B = r.callbackParameter, z = r.callback, R = r.cache, W = r.pageCache, q = r.charset, U = r.url, K = r.data, Y = r.timeout, X = 0, G = e;
        return C && C(function (t) {
            t.done(O).fail(F), O = t.resolve, F = t.reject
        }).promise(r), r.abort = function () {
            !X++ && G()
        }, n(r.beforeSend, r, [r]) === !1 || X ? r : (U = U || u, K = K ? "string" == typeof K ? K : t.param(K, r.traditional) : u, U += K ? s(U) + K : u, B && (U += s(U) + encodeURIComponent(B) + "=?"), !R && !W && (U += s(U) + "_" + (new Date).getTime() + "="), U = U.replace(/=\?(&|$)/, "=" + z + "$1"), W && (A = S[U]) ? A.s ? p(A.s[0]) : M(A) : (k[z] = i, V = t(b)[0], V.id = d + E++, q && (V[l] = q), D && D.version() < 11.6 ? (j = t(b)[0]).text = "document.getElementById('" + V.id + "')." + m + "()" : V[a] = a, I && (V.htmlFor = V.id, V.event = f), V[g] = V[m] = V[v] = function (t) {
            if (!V[y] || !/i/.test(V[y])) {
                try {
                    V[f] && V[f]()
                } catch (e) {
            ...
            $ && clearTimeout($), V[v] = V[g] = V[m] = null, T[_](V), j && T[_](j)
        }, T[h](V, N = T.firstChild), j && T[h](j, N), $ = Y > 0 && setTimeout(function () {
            M(x)
        }, Y)), r)
    }

    var o, a = "async", l = "charset", u = "", c = "error", h = "insertBefore", d = "_jqjsp", p = "on", f = p + "click", m = p + c, g = p + "load", v = p + "readystatechange", y = "readyState", _ = "removeChild", b = "<script>", w = "success", x = "timeout", k = window, C = t.Deferred, T = t("head")[0] || document.documentElement, S = {}, E = 0, P = {callback: d, url: location.href}, D = k.opera, I = !!t("<div>").html("<!--[if IE]><i><![endif]-->").find("i").length;
    r.setup = function (e) {
        t.extend(P, e)
    }, t.jsonp = r
}(jQuery), function () {
    console.log("function39");
    ...
    window.Waveform = e = function () {
        ...
        return e.name = "Waveform", e.prototype.setData = function (t) {
            ...
            var n, s, r, o;
            if (null == i && (i = 0), s = [], t.length > e)s = t.slice(t.length - e, t.length); else for (n = r = 0, o = e - 1; o >= 0 ? o >= r : r >= o; n = o >= 0 ? ++r : --r)s[n] = t[n] || i;
            return s
            ...
            var e, i;
            return null == t && (t = {}), e = !1, i = this, {whileplaying: this.redraw, whileloading: function () {
                var n;
            ...
            var i = this;
            return t.get("http://waveformjs.org/w", {url: e.waveform_url}, function (t) {
                return i.update({data: t})
            })
        }, e
    }(), t = function () {
        ...
        return o = function (t) {
            ...
            var e;
            return e = t
        }, e = 0, n = void 0, a = void 0, r = void 0, u = this, t = {}, {get: s, init: l}
    }()
}.call(this), function () {
    console.log("function40");
    var t = this, e = t._, i = {}, n = Array.prototype, s = Object.prototype, r = Function.prototype, o = n.push, a = n.slice, l = n.concat, u = s.toString, c = s.hasOwnProperty, h = n.forEach, d = n.map, p = n.reduce, f = n.reduceRight, m = n.filter, g = n.every, v = n.some, y = n.indexOf, _ = n.lastIndexOf, b = Array.isArray, w = Object.keys, x = r.bind, k = function (t) {
    ...
    var M = function (t, e, i, n) {
        ...
        var l = 0, c = !0;
        if ("[object Array]" == s) {
            if (l = t.length, c = l == e.length)for (; l-- && (c = M(t[l], e[l], i, n)););
        } else {
            for (var h in t)if (k.has(t, h) && (l++, !(c = k.has(e, h) && M(t[h], e[h], i, n))))break;
            if (c) {
                for (h in e)if (k.has(e, h) && !l--)break;
                c = !l
            }
        }
    ...
    var N = {escape: new RegExp("[" + k.keys(A.escape).join("") + "]", "g"), unescape: new RegExp("(" + k.keys(A.unescape).join("|") + ")", "g")};
    k.each(["escape", "unescape"], function (t) {
        ...
        C(k.functions(t), function (e) {
            ...
            k.prototype[e] = function () {
                var t = [this._wrapped];
                return o.apply(t, arguments), F.call(this, i.apply(k, t))
            }
        })
    };
    var V = 0;
    ...
    k.template = function (t, e, i) {
        ...
        var s = new RegExp([(i.escape || j).source, (i.interpolate || j).source, (i.evaluate || j).source].join("|") + "|$", "g"), r = 0, o = "__p+='";
        t.replace(s, function (e, i, n, s, a) {
            return o += t.slice(r, a).replace(O, function (t) {
                return"\\" + $[t]
    ...
    console.log("function41");
    var t = this, e = t.Backbone, i = [];
    i.push;
    var n = i.slice;
    i.splice;
    var s;
    ...
    var o = s.Events = {on: function (t, e, i) {
        ...
        for (a = t ? [t] : r.keys(this._events), u = 0, c = a.length; c > u; u++)if (t = a[u], o = this._events[t]) {
            if (this._events[t] = n = [], e || i)for (h = 0, d = o.length; d > h; h++)s = o[h], (e && e !== s.callback && e !== s.callback._callback || i && i !== s.context) && n.push(s);
    ...
    r.extend(h.prototype, o, {changed: null, validationError: null, idAttribute: "id", initialize: function () {
    }, toJSON: function () {
        ...
        }, $(this, i), s = this.isNew() ? "create" : i.patch ? "patch" : "update", "patch" === s && (i.attrs = n), o = this.sync(s, this, i), n && i.wait && (this.attributes = a), o
    }, destroy: function (t) {
        t = t ? r.clone(t) : {};
        ...
        var t = r.result(this, "urlRoot") || r.result(this.collection, "url") || j();
    ...
    var p = s.Collection = function (t, e) {
        e || (e = {}), e.model && (this.model = e.model), void 0 !== e.comparator && (this.comparator = e.comparator), this._reset(), this.initialize.apply(this, arguments), t && this.reset(t, r.extend({silent: !0}, e))
    }, f = {add: !0, remove: !0, merge: !0}, m = {add: !0, remove: !1};
    r.extend(p.prototype, o, {model: h, initialize: function () {
    }, toJSON: function (t) {
        ...
        var i = !r.isArray(t);
        t = i ? t ? [t] : [] : r.clone(t);
        var n, s, o, a, l, u, c, d = e.at, p = this.model, m = this.comparator && null == d && e.sort !== !1, g = r.isString(this.comparator) ? this.comparator : null, v = [], y = [], _ = {}, b = e.add, w = e.merge, x = e.remove, k = !m && b && x ? [] : !1;
        for (n = 0, s = t.length; s > n; n++) {
            if (l = t[n], o = l instanceof h ? a = l : l[p.prototype.idAttribute], u = this.get(o))x && (_[u.cid] = !0), w && (l = l === a ? a.attributes : l, e.parse && (l = u.parse(l, e)), u.set(l, e), m && !c && u.hasChanged(g) && (c = !0)), t[n] = u; else if (b) {
        ...
        if (v.length || k && k.length)if (m && (c = !0), this.length += v.length, null != d)for (n = 0, s = v.length; s > n; n++)this.models.splice(d + n, 0, v[n]); else {
    ...
    r.extend(y.prototype, o, {tagName: "div", $: function (t) {
        ...
        var n = x[t];
        r.defaults(i || (i = {}), {emulateHTTP: s.emulateHTTP, emulateJSON: s.emulateJSON});
        var o = {type: n, dataType: "json"};
        if (i.url || (o.url = r.result(e, "url") || j()), null != i.data || !e || "create" !== t && "update" !== t && "patch" !== t || (o.contentType = "application/json", o.data = JSON.stringify(i.attrs || e.toJSON(i))), i.emulateJSON && (o.contentType = "application/x-www-form-urlencoded", o.data = o.data ? {model: o.data} : {}), i.emulateHTTP && ("PUT" === n || "DELETE" === n || "PATCH" === n)) {
    ...
    }, C = /\((.*?)\)/g, T = /(\(\?)?:\w+/g, S = /\*\w+/g, E = /[\-{}\[\]+?.,\\\^$|#\s]/g;
    r.extend(k.prototype, o, {initialize: function () {
    ...
    }, D = /^[#\/]|\s+$/g, I = /^\/+|\/+$/g, M = /msie [\w.]+/, A = /\/$/, N = /[?#].*$/;
    P.started = !1, r.extend(P.prototype, o, {interval: 50, getHash: function (t) {
        ...
        P.started = !0, this.options = r.extend({root: "/"}, this.options, t), this.root = this.options.root, this._wantsHashChange = this.options.hashChange !== !1, this._wantsPushState = !!this.options.pushState, this._hasPushState = !!(this.options.pushState && this.history && this.history.pushState);
        var e = this.getFragment(), i = document.documentMode, n = M.exec(navigator.userAgent.toLowerCase()) && (!i || 7 >= i);
...
var swfobject = function () {
    console.log("function42");
    function t() {
        if (!R) {
            try {
                var t = $.getElementsByTagName("body")[0].appendChild(g("span"));
    ...
    function i(t) {
        if (typeof j.addEventListener != P)j.addEventListener("load", t, !1); else if (typeof $.addEventListener != P)$.addEventListener("load", t, !1); else if (typeof j.attachEvent != P)v(j, "onload", t); else if ("function" == typeof j.onload) {
            var e = j.onload;
            j.onload = function () {
                e(), t()
            }
    ...
    function s() {
        var t = $.getElementsByTagName("body")[0], e = g(D);
    ...
    function r() {
        ...
        if (t > 0)for (var e = 0; t > e; e++) {
            var i = L[e].id, n = L[e].callbackFn, s = {success: !1, id: i};
            if (U.pv[0] > 0) {
                var r = m(i);
                if (r)if (!y(L[e].swfVersion) || U.wk && U.wk < 312)if (L[e].expressInstall && a()) {
                    var c = {};
                    ...
                    l(c, h, i, n)
                } else u(r), n && n(s); else b(i, !0), n && (s.success = !0, s.ref = o(i), n(s))
            } else if (b(i, !0), n) {
                var g = o(i);
    ...
    function o(t) {
        var e = null, i = m(t);
        if (i && "OBJECT" == i.nodeName)if (typeof i.SetVariable != P)e = i; else {
    ...
    function l(t, e, i, n) {
        W = !0, C = n || null, T = {success: !1, id: i};
        var s = m(i);
        if (s) {
            "OBJECT" == s.nodeName ? (x = c(s), k = null) : (x = s, k = i), t.id = N, (typeof t.width == P || !/%$/.test(t.width) && parseInt(t.width, 10) < 310) && (t.width = "310"), (typeof t.height == P || !/%$/.test(t.height) && parseInt(t.height, 10) < 137) && (t.height = "137"), $.title = $.title.slice(0, 47) + " - Flash Player Installation";
            var r = U.ie && U.win ? "ActiveX" : "PlugIn", o = "MMredirectURL=" + j.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + r + "&MMdoctitle=" + $.title;
            if (typeof e.flashvars != P ? e.flashvars += "&" + o : e.flashvars = o, U.ie && U.win && 4 != s.readyState) {
                var a = g("div");
                i += "SWFObjectNew", a.setAttribute("id", i), s.parentNode.insertBefore(a, s), s.style.display = "none", function () {
    ...
    function u(t) {
        if (U.ie && U.win && 4 != t.readyState) {
            var e = g("div");
            t.parentNode.insertBefore(e, t), e.parentNode.replaceChild(c(t), e), t.style.display = "none", function () {
    ...
    function c(t) {
        var e = g("div");
        if (U.win && U.ie)e.innerHTML = t.innerHTML; else {
            var i = t.getElementsByTagName(D)[0];
            if (i) {
                var n = i.childNodes;
                if (n)for (var s = n.length, r = 0; s > r; r++)1 == n[r].nodeType && "PARAM" == n[r].nodeName || 8 == n[r].nodeType || e.appendChild(n[r].cloneNode(!0))
            }
        }
        return e
    }
    ...
    function h(t, e, i) {
        ...
        if (s)if (typeof t.id == P && (t.id = i), U.ie && U.win) {
            var r = "";
    ...
    function _(t, e, i, n) {
        if (!U.ie || !U.mac) {
            var s = $.getElementsByTagName("head")[0];
            if (s) {
                var r = i && "string" == typeof i ? i : "screen";
                if (n && (S = null, E = null), !S || E != r) {
                    var o = g("style");
                    o.setAttribute("type", "text/css"), o.setAttribute("media", r), S = s.appendChild(o), U.ie && U.win && typeof $.styleSheets != P && $.styleSheets.length > 0 && (S = $.styleSheets[$.styleSheets.length - 1]), E = r
                }
                U.ie && U.win ? S && typeof S.addRule == D && S.addRule(t, e) : S && typeof $.createTextNode != P && S.appendChild($.createTextNode(t + " {" + e + "}"))
            }
        }
    }
    ...
    function w(t) {
        var e = /[\\\"<>\.;]/, i = null != e.exec(t);
        return i && typeof encodeURIComponent != P ? encodeURIComponent(t) : t
    }

    var x, k, C, T, S, E, P = "undefined", D = "object", I = "Shockwave Flash", M = "ShockwaveFlash.ShockwaveFlash", A = "application/x-shockwave-flash", N = "SWFObjectExprInst", V = "onreadystatechange", j = window, $ = document, O = navigator, F = !1, H = [n], L = [], B = [], z = [], R = !1, W = !1, q = !0, U = function () {
        var t = typeof $.getElementById != P && typeof $.getElementsByTagName != P && typeof $.createElement != P, e = O.userAgent.toLowerCase(), i = O.platform.toLowerCase(), n = i ? /win/.test(i) : /win/.test(e), s = i ? /mac/.test(i) : /mac/.test(e), r = /webkit/.test(e) ? parseFloat(e.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, o = !1, a = [0, 0, 0], l = null;
        if (typeof O.plugins != P && typeof O.plugins[I] == D)l = O.plugins[I].description, !l || typeof O.mimeTypes != P && O.mimeTypes[A] && !O.mimeTypes[A].enabledPlugin || (F = !0, o = !1, l = l.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), a[0] = parseInt(l.replace(/^(.*)\..*$/, "$1"), 10), a[1] = parseInt(l.replace(/^.*\.(.*)\s.*$/, "$1"), 10), a[2] = /[a-zA-Z]/.test(l) ? parseInt(l.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0); else if (typeof j.ActiveXObject != P)try {
        ...
        return{w3: t, pv: a, wk: r, ie: o, win: n, mac: s}
    }();
    return!function () {
        U.w3 && ((typeof $.readyState != P && "complete" == $.readyState || typeof $.readyState == P && ($.getElementsByTagName("body")[0] || $.body)) && t(), R || (typeof $.addEventListener != P && $.addEventListener("DOMContentLoaded", t, !1), U.ie && U.win && ($.attachEvent(V, function () {
            "complete" == $.readyState && ($.detachEvent(V, arguments.callee), t())
        }), j == top && !function () {
            if (!R) {
                try {
            ...
            return R ? void 0 : /loaded|complete/.test($.readyState) ? (t(), void 0) : (setTimeout(arguments.callee, 0), void 0)
        }(), i(t)))
    }(), !function () {
        ...
        var f = {success: !1, id: i};
        U.w3 && !(U.wk && U.wk < 312) && t && i && n && s && r ? (b(i, !1), e(function () {
            n += "", s += "";
            var e = {};
            if (d && typeof d === D)for (var m in d)e[m] = d[m];
            e.data = t, e.width = n, e.height = s;
            var g = {};
            if (c && typeof c === D)for (var v in c)g[v] = c[v];
            if (u && typeof u === D)for (var _ in u)typeof g.flashvars != P ? g.flashvars += "&" + _ + "=" + u[_] : g.flashvars = _ + "=" + u[_];
            if (y(r)) {
                var w = h(e, g, i);
    ...
    }, hasFlashPlayerVersion: y, createSWF: function (t, e, i) {
        ...
        var e = $.location.search || $.location.hash;
        if (e) {
            if (/\?/.test(e) && (e = e.split("?")[1]), null == t)return w(e);
            for (var i = e.split("&"), n = 0; n < i.length; n++)if (i[n].substring(0, i[n].indexOf("=")) == t)return w(i[n].substring(i[n].indexOf("=") + 1))
        }
        return""
...
!function () {
    ...
    function i(t, e) {
        if (t) {
            ...
            } else for (var r = t[0]; s > n && e.call(r, n, r) !== !1; r = t[++n]);
            return t
        }
    }
    ...
    function r(t) {
        var e = t.indexOf(".");
        if (-1 != e) {
            var n = t.slice(0, e) || "*", s = t.slice(e + 1, t.length), r = [];
    ...
    function u(r, u, c) {
        function f() {
            ...
            $f(r) ? ($f(r).getParent().innerHTML = "", _ = $f(r).getIndex(), p[_] = k) : (p.push(k), _ = p.length - 1), x = parseInt(r.style.height, 10) || r.clientHeight, v = r.id || "fp" + l(), y = u.id || v + "_api", u.id = y, m = r.innerHTML, "string" == typeof c && (c = {clip: {url: c}}), c.playerId = v, c.clip = c.clip || {}, r.getAttribute("href", 2) && !c.clip.url && (c.clip.url = r.getAttribute("href", 2)), g = new h(c.clip, -1, k), c.playlist = c.playlist || [c.clip];
            var s = 0;
            i(c.playlist, function () {
                var t = this;
                "object" == typeof t && t.length && (t = {url: "" + t}), i(c.clip, function (e, i) {
        ...
        var m, g, v, y, _, b, w, x, k = this, C = null, T = !1, S = [], E = {}, P = {};
        if (s(k, {id: function () {
            return v
        }, isLoaded: function () {
            ...
            if (!k.isLoaded() && k._fireEvent("onBeforeLoad") !== !1) {
                var e = function () {
                    m && !flashembed.isSupported(u.version) && (r.innerHTML = ""), t && (t.cached = !0, a(P, "onLoad", t)), flashembed(r, u, {config: c})
                }, n = 0;
                i(p, function () {
            ...
            "string" == typeof e && (e = [e]);
            var s = e[0], r = e[1], o = e[2], a = e[3], l = 0;
    ...
    var h = function (t, e, n) {
        var r = this, o = {}, u = {};
        if (r.index = e, "string" == typeof t && (t = {url: t}), s(this, t, !0), i("Begin*,Start,Pause*,Resume*,Seek*,Stop*,Finish*,LastSecond,Update,BufferFull,BufferEmpty,BufferStop".split(","), function () {
            var t = "on" + this;
            if (-1 != t.indexOf("*")) {
                t = t.slice(0, t.length - 1);
        ...
        }), s(this, {onCuepoint: function (t, i) {
            ...
            var i = n.getConfig(), o = -1 == e ? i.clip : i.playlist[e];
            s(o, t, !0)
    ...
    window.flowplayer = window.$f = function () {
        ...
        if (arguments.length > 1) {
            var a = arguments[1], l = 3 == arguments.length ? arguments[2] : {};
            if ("string" == typeof a && (a = {src: a}), a = s({bgcolor: "#000000", version: [10, 1], expressInstall: "http://releases.flowplayer.org/swf/expressinstall.swf", cachebusting: !1}, a), "string" == typeof o) {
                if (-1 != o.indexOf(".")) {
                    var h = [];
        ...
        return null
    }, s(window.$f, {fireEvent: function () {
        var t = [].slice.call(arguments), e = $f(t[0]);
        return e ? e._fireEvent(t.slice(1)) : null
    }, addPlugin: function (t, e) {
        return u.prototype[t] = e, $f
    }, each: i, extend: s}), "function" == typeof jQuery && (jQuery.fn.flowplayer = function (t, i) {
    ...
    function i(e, i, r) {
        if (l.isSupported(i.version))e.innerHTML = l.getHTML(i, r); else if (i.expressInstall && l.isSupported([6, 65]))e.innerHTML = l.getHTML(t(i, {src: i.expressInstall}), {MMredirectURL: encodeURIComponent(location.href), MMplayerType: "PlugIn", MMdoctitle: document.title}); else if (e.innerHTML.replace(/\s/g, "") || (e.innerHTML = "<h2>Flash version " + i.version + " or greater is required</h2>" + "<h3>" + (u[0] > 0 ? "Your version is " + u : "You have no flash plugin installed") + "</h3>" + ("A" == e.tagName ? "<p>Click here to download latest version</p>" : "<p>Download latest version from <a href='" + s + "'>here</a></p>"), ("A" == e.tagName || "DIV" == e.tagName) && (e.onclick = function () {
            location.href = s
        })), i.onFail) {
            var o = i.onFail.call(this);
            "string" == typeof o && (e.innerHTML = o)
        }
        n && (window[i.id] = document.getElementById(i.id)), t(this, {getRoot: function () {
            return e
        }, getOptions: function () {
            return i
        }, getConf: function () {
    ...
    var n = document.all, s = "http://get.adobe.com/flashplayer", r = "function" == typeof jQuery, o = /(\d+)[^\d]+(\d+)[^\d]*(\d*)/, a = {width: "100%", height: "100%", id: "_" + ("" + Math.random()).slice(9), allowfullscreen: !0, allowscriptaccess: "always", quality: "high", version: [3, 0], onFail: null, expressInstall: null, w3c: !1, cachebusting: !1};
    window.attachEvent && window.attachEvent("onbeforeunload", function () {
        __flash_unloadHandler = function () {
        }, __flash_savedUnloadHandler = function () {
        }
    }), window.flashembed = function (e, n, s) {
        return"string" == typeof e && (e = document.getElementById(e.replace("#", ""))), e ? ("string" == typeof n && (n = {src: n}), new i(e, t(t({}, a), n), s)) : void 0
    };
    var l = t(window.flashembed, {conf: a, getVersion: function () {
        var t, e;
        try {
    ...
    r && (jQuery.tools = jQuery.tools || {version: "3.2.11"}, jQuery.tools.flashembed = {conf: a}, jQuery.fn.flashembed = function (t, e) {
        return this.each(function () {
            $(this).data("flashembed", flashembed(this, t, e))
        })
    })
}(), function (window, undefined) {
    console.log("function45");
    function returnTrue() {
        return!0
    }
    ...
    VideoJS.players = {}, VideoJS.options = {techOrder: ["dailymotionHtml5", "dailymotion", "youtube", "html5", "flash"], html5: {}, flash: {swf: "http://vjs.zencdn.net/c/video-js.swf"}, youtube: {}, dailymotion: {}, dailymotionHtml5: {}, width: "auto", height: "auto", defaultVolume: 0, components: {posterImage: {}, textTrackDisplay: {}, loadingSpinner: {}, bigPlayButton: {}, controlBar: {}}}, "GENERATED_CDN_VSN" != CDN_VERSION && (_V_.options.flash.swf = "http://vjs.zencdn.net/" + CDN_VERSION + "/video-js.swf"), _V_.merge = function (t, e, i) {
        e || (e = {});
        ...
        e = e || t;
        var i = Math.floor(t % 60), n = Math.floor(t / 60 % 60), s = Math.floor(t / 3600), r = Math.floor(e / 60 % 60), o = Math.floor(e / 3600);
        ...
        if (!e)return 0;
        var n = document.documentElement, s = document.body, r = n.clientLeft || s.clientLeft || 0, o = window.pageXOffset || s.scrollLeft, a = e.left + o - r;
        return a
    } : function (t) {
        ...
        if (handle = this.handle, bar = this.bar, isNaN(e) && (e = 0), t = e, handle) {
            var i = this.el, n = i.offsetWidth, s = handle.el.offsetWidth, r = s ? s / n : 0, o = 1 - r;
        ...
        var e = this.el, i = _V_.findPosX(e), n = e.offsetWidth, s = this.handle;
        if (s) {
        ...
        } else for (e in s.events)_V_.cleanUpEvents(t, e)
        ...
        if (t.target || (t.target = t.srcElement || document), 3 === t.target.nodeType && (t.target = t.target.parentNode), !t.relatedTarget && t.fromElement && (t.relatedTarget = t.fromElement === t.target ? t.toElement : t.fromElement), null == t.pageX && null != t.clientX) {
            var s = t.target.ownerDocument || document, r = s.documentElement, o = s.body;
        ...
        var i, n = _V_.getData(t), s = (t.parentNode || t.ownerDocument, e.type || e);
    ...
    JSON || (JSON = {}), function () {
        ...
        "function" != typeof JSON.parse && (JSON.parse = function (text, reviver) {
            function walk(t, e) {
                var i, n, s = t[e];
                if (s && "object" == typeof s)for (i in s)Object.prototype.hasOwnProperty.call(s, i) && (n = walk(s, i), n !== undefined ? s[i] = n : delete s[i]);
        ...
        this.tag = t;
        var n = this.el = _V_.createElement("div"), s = this.options = {}, r = s.width = t.getAttribute("width"), o = s.height = t.getAttribute("height"), a = r || 300, l = o || 150;
        if (t.player = n.player = this, this.ready(i), t.parentNode.insertBefore(n, t), n.appendChild(t), n.id = this.id = t.id, n.className = t.className, t.id += "_html5_api", t.className = "vjs-tech", _V_.players[n.id] = this, n.setAttribute("width", a), n.setAttribute("height", l), n.style.width = a + "px", n.style.height = l + "px", t.removeAttribute("width"), t.removeAttribute("height"), _V_.merge(s, _V_.options), _V_.merge(s, this.getVideoTagSettings()), _V_.merge(s, e), t.removeAttribute("controls"), t.removeAttribute("poster"), t.hasChildNodes())for (var u = 0, c = t.childNodes; u < c.length; u++)("SOURCE" == c[u].nodeName || "TRACK" == c[u].nodeName) && t.removeChild(c[u]);
        if (this.values = {}, this.addClass("vjs-paused"), this.addEvent("ended", this.onEnded), this.addEvent("play", this.onPlay), this.addEvent("pause", this.onPause), this.addEvent("progress", this.onProgress), this.addEvent("error", this.onError), s.controls && this.ready(function () {
            this.initComponents()
        }), this.textTracks = [], s.tracks && s.tracks.length > 0 && this.addTextTracks(s.tracks), s.sources && 0 != s.sources.length)this.src(s.sources); else for (var u = 0, c = s.techOrder; u < c.length; u++) {
            var h = c[u], d = _V_[h];
            if (d.isSupported()) {
                this.loadTech(h);
                break
        ...
        for (var e = 0, i = this.options.techOrder; e < i.length; e++) {
            var n = i[e], s = _V_[n];
            if (s.isSupported())for (var r = 0, o = t; r < o.length; r++) {
                var a = o[r];
                if (s.canPlaySource.call(this, a))return{source: a, tech: n}
            }
        }
        return!1
    }, src: function (t) {
        ...
        this.player = t;
        var i = e.source, n = e.parentEl, s = this.el = _V_.createElement("div", {id: n.id + "_temp_flash"}), r = t.el.id + "_flash_api", o = t.options, a = _V_.merge({readyFunction: "_V_.flash.onReady", eventProxyFunction: "_V_.flash.onEvent", errorEventProxyFunction: "_V_.flash.onError", autoplay: o.autoplay, preload: o.preload, loop: o.loop, muted: o.muted}, e.flashVars), l = _V_.merge({wmode: "opaque", bgcolor: "#000000"}, e.params), u = _V_.merge({id: r, name: r, "class": "vjs-tech"}, e.attributes);
        if (i && (a.src = encodeURIComponent(_V_.getAbsoluteURL(i.src))), _V_.insertFirst(s, n), e.startTime && this.ready(function () {
        ...
        }), 1 != e.iFrameMode || _V_.isFF)_V_.flash.embed(e.swf, s, a, l, u); else {
            var c = _V_.createElement("iframe", {id: r + "_iframe", name: r + "_iframe", className: "vjs-tech", scrolling: "no", marginWidth: 0, marginHeight: 0, frameBorder: 0});
            a.readyFunction = "ready", a.eventProxyFunction = "events", a.errorEventProxyFunction = "errors", _V_.addEvent(c, "load", _V_.proxy(this, function () {
                ...
                t = c.contentDocument ? c.contentDocument : c.contentWindow.document, t.write(_V_.flash.getEmbedCode(e.swf, a, l, u)), i.player = this.player, i.ready = _V_.proxy(this.player, function (e) {
                    var i = t.getElementById(e), n = this, s = n.tech;
        ...
        var r = _V_.flash.getEmbedCode(t, i, n, s), o = _V_.createElement("div", {innerHTML: r}).childNodes[0], a = e.parentNode;
        ...
        var s = '<object type="application/x-shockwave-flash"', r = "", o = "";
    ...
    }, _V_.flash = _V_.PlaybackTech.extend({flowplayer: null, init: function (t, e) {
        this.player = t, e.source;
        var i = t.options, n = _V_.merge({key: i.key, preload: i.preload, loop: i.loop, muted: i.muted, clip: {provider: i.type, url: t.values.src, scaling: "fit", autoPlay: i.autoPlay, autoBuffering: !0}, play: {opacity: 0}, plugins: {controls: null}, onLoad: $.proxy(_V_.flash.onReady, this), onBeforeFinish: $.proxy(_V_.flash.onBeforeFinish, this), onStart: $.proxy(_V_.flash.onPlay, this), onResume: $.proxy(_V_.flash.onPlay, this), onPause: $.proxy(_V_.flash.onPause, this), onError: $.proxy(_V_.flash.onError, this), onSeek: $.proxy(_V_.flash.onSeek, this)}, e.flashVars);
        i.rtmp_info && (n.clip.url = i.rtmp_info.url, n.plugins.rtmp = {url: i.rtmpPluginSwf, netConnectionUrl: i.rtmp_info.net_connection_url}), window.flowplayer("subber_player", {src: i.swf, wmode: "opaque", scale: "noborder"}, n), this.flowplayer = window.flowplayer("subber_player")
    }, currentTime: function () {
    ...
    }, api: {supportsFullScreen: function () {
        return!1
    }, enterFullScreen: function () {
        ...
        return t.type in _V_.flash.prototype.support.formats ? "maybe" : void 0
    }, _V_.flash.prototype.support = {formats: {"video/flv": "FLV", "video/x-flv": "FLV", "video/mp4": "MP4", "video/m4v": "MP4"}, progressEvent: !1, timeupdateEvent: !1, fullscreenResize: !1, parentResize: !_V_.ua.match("Firefox")}, _V_.flash.onReady = function () {
        var t = _V_.el("subber_player_api"), e = t.player || t.parentNode.player, i = e.tech;
        ...
        var s = '<object type="application/x-shockwave-flash"', r = "", o = "", a = "";
        return e && (r = "config=" + JSON.stringify(e).replace(/"/g, "'")), i = _V_.merge({movie: t, flashvars: r, allowScriptAccess: "always", allowNetworking: "all"}, i), _V_.eachProp(i, function (t, e) {
            o += '<param name="' + t + '" value="' + e + '" />'
        }), n = _V_.merge({data: t, width: "100%", height: "100%"}, n), _V_.eachProp(n, function (t, e) {
            a += t + '="' + e + '" '
        }), s + a + ">" + o + "</object>"
    }, _V_.youtube = _V_.PlaybackTech.extend({name: "YouTube", player: null, support: null, init: function (t) {
        this.player = t, this.support = {format: {}, progressEvent: !1, timeupdateEvent: !1};
        var e = _V_.createElement("div", {id: "subber_player_temp_ytswf"}), i = "subber_player_youtube_api", n = {allowScriptAccess: "always", wmode: "opaque", bgcolor: "#000000", controls: 2}, s = {id: i, name: i, "class": "vjs-tech"};
        ...
        var t = this.el.getVideoBytesLoaded() / this.el.getVideoBytesTotal(), e = this.duration() * t;
    ...
    }, _V_.dailymotion = _V_.PlaybackTech.extend({name: "DailyMotion", player: null, support: null, init: function (t) {
        this.player = t, this.support = {format: {}, progressEvent: !1, timeupdateEvent: !1};
        var e = _V_.createElement("div", {id: "subber_player_temp_dmswf"}), i = "subber_player_dailymotion_api", n = {allowScriptAccess: "always", wmode: "opaque", bgcolor: "#000000", controls: 2}, s = {id: i, name: i, "class": "vjs-tech"};
        t.addEvent("techready", $.proxy(function () {
            var e = t.values.src;
    ...
    }, _V_.dailymotionHtml5 = _V_.PlaybackTech.extend({name: "DailyMotionHtml5", player: null, support: null, init: function (t) {
        this.player = t, this.support = {format: {}, progressEvent: !1, timeupdateEvent: !1}, this.timeGap = 0, this.timeGapIntervalEvent = null;
        var e = document.createElement("script");
        e.async = !0, e.src = document.location.protocol + "//api.dmcdn.net/all.js";
        var i = document.getElementsByTagName("script")[0];
        i.parentNode.insertBefore(e, i);
        var n = "subber_player_dailymotion_api", s = "subber_player", r = document.createElement("div");
        r.id = n, r.className = "vjs-tech", document.getElementById(s).appendChild(r);
        var o = this;
        window.dmAsyncInit = function () {
            var e = t.values.src.match(/video\/([a-zA-Z0-9]+)/)[1], i = _V_.ua.match("Chrome"), s = DM.player(n, {video: e, width: "480", height: "295", params: {api: !0, quality: "240", chromeless: 1, html: i}});
            s.addEventListener("apiready", function () {
                var t = _V_.el(n), e = t.parentNode.player, i = e.tech;
                ...
                var t = _V_.el(n), e = t.parentNode.player;
        ...
        for (var e, i, n, s, r = t.split("\n"), o = "", a = 1, l = r.length; l > a; a++)if (o = _V_.trim(r[a])) {
            for (-1 == o.indexOf("-->") ? (s = o, o = _V_.trim(r[++a])) : s = this.cues.length, e = {id: s, index: this.cues.length}, i = o.split(" --> "), e.startTime = this.parseCueTime(i[0]), e.endTime = this.parseCueTime(i[1]), n = []; r[++a] && (o = _V_.trim(r[a]));)n.push(o);
            e.text = n.join("<br/>"), this.cues.push(e)
        }
        this.readyState = 2, this.triggerEvent("loaded")
    }, parseCueTime: function (t) {
        var e, i, n, s, r, o = t.split(":"), a = 0;
        ...
        if (this.cues.length > 0) {
            ...
            if (this.prevChange === undefined || t < this.prevChange || this.nextChange <= t) {
                var e, i, n, s, r = this.cues, o = this.player.duration(), a = 0, l = !1, u = [];
                for (t >= this.nextChange || this.nextChange === undefined ? s = this.firstActiveIndex !== undefined ? this.firstActiveIndex : 0 : (l = !0, s = this.lastActiveIndex !== undefined ? this.lastActiveIndex : r.length - 1); ;) {
                    if (n = r[s], n.endTime <= t)a = Math.max(a, n.endTime), n.active && (n.active = !1); else if (t < n.startTime) {
                        if (o = Math.min(o, n.startTime), n.active && (n.active = !1), !l)break
                    } else l ? (u.splice(0, 0, n), i === undefined && (i = s), e = s) : (u.push(n), e === undefined && (e = s), i = s), o = Math.min(o, n.endTime), a = Math.max(a, n.startTime), n.active = !0;
                    if (l) {
                        if (0 === s)break;
                        s--
                    } else {
        ...
        for (var t, e, i = this.player.textTracks, n = 0, s = i.length, r = this.items = []; s > n; n++)if (t = i[n], t.kind == this.kind && t["default"]) {
        ...
        if (o.el.appendChild(_V_.createElement("li", {className: "vjs-menu-title", innerHTML: _V_.uc(this.kind)})), e)for (var a, l, u = e.cues, n = 0, s = u.length; s > n; n++)a = u[n], l = new _V_.ChaptersTrackMenuItem(this.player, {track: e, cue: a}), r.push(l), o.addComponent(l);
        ...
        var i = this.track = e.track, n = this.cue = e.cue, s = t.currentTime();
        ...
        if (n && n.length > 0)for (var s = 0, r = n.length; r > s; s++) {
...
Window.getHref = function () {
...
}.call(this), window.viki = window.viki || {}, viki.languages = {ab: {direction: "ltr", native_name: "Abkhazian", name: {en: "Abkhazian", es: "Abjasio"}}, aa: {direction: "ltr", native_name: "Afar", name: {en: "Afar", es: "Afar"}}, af: {direction: "ltr", native_name: "Afrikaans", name: {en: "Afrikaans", es: "Afrikaans"}}, ak: {direction: "ltr", native_name: "Akana", name: {en: "Akan", es: "Akan"}}, sq: {direction: "ltr", native_name: "Shqip", name: {en: "Albanian", es: "AlbanÃ©s"}}, al: {direction: "ltr", native_name: "Alemannisch", name: {en: "Alemannic", es: "AlemÃ¡nico"}}, am: {direction: "ltr", native_name: "Amharic", name: {en: "Amharic", es: "AmÃ¡rico"}}, ag: {direction: "ltr", native_name: "AngloSaxon", name: {en: "Anglo-Saxon", es: "AnglosajÃ³n"}}, ar: {direction: "rtl", native_name: "Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©", name: {en: "Arabic", es: "Ãrabe"}}, an: {direction: "ltr", native_name: "AragonÃ©s", name: {en: "Aragonese", es: "AragonÃ©s"}}, hy: {direction: "ltr", native_name: "Õ€Õ¡ÕµÕ¥Ö€Õ¥Õ¶", name: {en: "Armenian", es: "Armenio"}}, ra: {direction: "ltr", native_name: "ArmÃ£neashce", name: {en: "Aromanian", es: "Arrumano"}}, as: {direction: "ltr", native_name: "Assamese", name: {en: "Assamese", es: "AsamÃ©s"}}, at: {direction: "ltr", native_name: "Asturianu", name: {en: "Asturian", es: "Asturiano"}}, av: {direction: "ltr", native_name: "ÐÐ²Ð°Ñ€", name: {en: "Avar", es: "Avar"}}, ay: {direction: "ltr", native_name: "Aymar", name: {en: "Aymara", es: "Aimara"}}, az: {direction: "ltr", native_name: "AzÉ™rbaycan", name: {en: "Azeri", es: "AzerÃ­"}}, bm: {direction: "ltr", native_name: "Bamanankan", name: {en: "Bambara", es: "Bambara"}}, ba: {direction: "ltr", native_name: "Ð‘Ð°ÑˆÒ¡Ð¾Ñ€Ñ‚", name: {en: "Bashkir", es: "Bashkir"}}, eu: {direction: "ltr", native_name: "Euskara", name: {en: "Basque", es: "Vasco"}}, be: {direction: "ltr", native_name: "Ð‘ÐµÐ»Ð°Ñ€ÑƒÑÐºÐ°Ñ", name: {en: "Belarusian", es: "Bielorruso"}}, bn: {direction: "ltr", native_name: "Bengali", name: {en: "Bengali", es: "BengalÃ­"}}, bh: {direction: "ltr", native_name: "à¤­à¥‹à¤œà¤ªà¥à¤°à¥€", name: {en: "Bihari", es: "Bihari"}}, bi: {direction: "ltr", native_name: "Bislama", name: {en: "Bislama", es: "Bislama"}}, bs: {direction: "ltr", native_name: "Bosanski", name: {en: "Bosnian", es: "Bosnio"}}, br: {direction: "ltr", native_name: "Brezhoneg", name: {en: "Breton", es: "BretÃ³n"}}, bg: {direction: "ltr", native_name: "Ð‘ÑŠÐ»Ð³Ð°Ñ€ÑÐºÐ¸", name: {en: "Bulgarian", es: "BÃºlgaro"}}, my: {direction: "ltr", native_name: "Myanmasa", name: {en: "Burmese", es: "Birmano"}}, km: {direction: "ltr", native_name: "Khmer", name: {en: "Khmer", es: "Jemer"}}, ca: {direction: "ltr", native_name: "CatalÃ ", name: {en: "Catalan", es: "CatalÃ¡n"}}, ch: {direction: "ltr", native_name: "Chamoru", name: {en: "Chamorro", es: "Chamorro"}}, ce: {direction: "ltr", native_name: "Cherokee", name: {en: "Cherokee", es: "Checheno"}}, zh: {direction: "ltr", native_name: "ç®€ä½“ä¸­æ–‡", name: {en: "Chinese(ç®€ä½“)", es: "Chinosimplificado"}}, zt: {direction: "ltr", native_name: "ç¹é«”ä¸­æ–‡", name: {en: "Chinese(ç¹é«”)", es: "ChinotradicionÃ¡l"}}, kw: {direction: "ltr", native_name: "Kernewek/Karnuack", name: {en: "Cornish", es: "CÃ³rnico"}}, co: {direction: "ltr", native_name: "Corsu", name: {en: "Corsican", es: "Corso"}}, cr: {direction: "ltr", native_name: "Nehiyaw", name: {en: "Cree", es: "Cree"}}, hr: {direction: "ltr", native_name: "Hrvatski", name: {en: "Croatian", es: "Croata"}}, cs: {direction: "ltr", native_name: "ÄŒeÅ¡tina", name: {en: "Czech", es: "Checo"}}, da: {direction: "ltr", native_name: "Dansk", name: {en: "Danish", es: "DanÃ©s"}}, dv: {direction: "ltr", native_name: "Divehi", name: {en: "Divehi", es: "Divehi"}}, nl: {direction: "ltr", native_name: "Nederlands", name: {en: "Dutch", es: "NeerlandÃ©s"}}, dz: {direction: "ltr", native_name: "Dzongkha", name: {en: "Dzongkha", es: "Dzongkha"}}, en: {direction: "ltr", native_name: "English", name: {en: "English", es: "InglÃ©s"}}, eo: {direction: "ltr", native_name: "Esperanto", name: {en: "Esperanto", es: "Esperanto"}}, et: {direction: "ltr", native_name: "Eesti", name: {en: "Estonian", es: "Estonio"}}, fo: {direction: "ltr", native_name: "FÃ¸royskt", name: {en: "Faroese", es: "FeroÃ©s"}}, fj: {direction: "ltr", native_name: "NaVosaVakaviti", name: {en: "Fijian", es: "Fiyiano"}}, fi: {direction: "ltr", native_name: "Suomi", name: {en: "Finnish", es: "FinÃ©s"}}, fr: {direction: "ltr", native_name: "FranÃ§ais", name: {en: "French", es: "FrancÃ©s"}}, gl: {direction: "ltr", native_name: "Galego", name: {en: "Galician", es: "Gallego"}}, ka: {direction: "ltr", native_name: "áƒ¥áƒáƒ áƒ—áƒ£áƒšáƒ˜", name: {en: "Georgian", es: "Georgiano"}}, de: {direction: "ltr", native_name: "Deutsch", name: {en: "German", es: "AlemÃ¡n"}}, el: {direction: "ltr", native_name: "Î•Î»Î»Î·Î½Î¹ÎºÎ¬", name: {en: "Greek", es: "Griego"}}, kl: {direction: "ltr", native_name: "Kalaallisut", name: {en: "Greenlandic", es: "GroenlandÃ©s"}}, gn: {direction: "ltr", native_name: "AvaÃ±e'áº½", name: {en: "Guarani", es: "GuaranÃ­"}}, gu: {direction: "ltr", native_name: "àª—à«àªœàª°àª¾àª¤à«€", name: {en: "Gujarati", es: "Gujarati"}}, ha: {direction: "rtl", native_name: "Ù‡ÙŽÙˆÙØ³ÙŽ", name: {en: "Hausa", es: "Hausa"}}, he: {direction: "rtl", native_name: "×¢×‘×¨×™×ª", name: {en: "Hebrew", es: "Hebreo"}}, hi: {direction: "ltr", native_name: "à¤¹à¤¿à¤¨à¥à¤¦à¥€", name: {en: "Hindi", es: "Hindi"}}, hm: {direction: "ltr", native_name: "Hmong", name: {en: "Hmong", es: "Hmong"}}, hu: {direction: "ltr", native_name: "Magyar", name: {en: "Hungarian", es: "HÃºngaro"}}, is: {direction: "ltr", native_name: "Ãslenska", name: {en: "Icelandic", es: "IslandÃ©s"}}, io: {direction: "ltr", native_name: "Ido", name: {en: "Ido", es: "Ido"}}, id: {direction: "ltr", native_name: "BahasaIndonesia", name: {en: "Indonesian", es: "Indonesio"}}, ia: {direction: "ltr", native_name: "Interlingua", name: {en: "Interlingua", es: "Interlingua"}}, ie: {direction: "ltr", native_name: "Interlingue", name: {en: "Interlingue", es: "Interlingue"}}, iu: {direction: "ltr", native_name: "Inuktitut", name: {en: "Inuktitut", es: "Inuktitut"}}, ik: {direction: "ltr", native_name: "IÃ±upiak", name: {en: "Inupiak", es: "Inupiaq"}}, ga: {direction: "ltr", native_name: "Gaeilge", name: {en: "Irish", es: "IrlandÃ©s"}}, it: {direction: "ltr", native_name: "Italiano", name: {en: "Italian", es: "Italiano"}}, ja: {direction: "ltr", native_name: "æ—¥æœ¬èªž", name: {en: "Japanese", es: "JaponÃ©s"}}, jv: {direction: "ltr", native_name: "BasaJawa", name: {en: "Javanese", es: "JavanÃ©s"}}, kn: {direction: "ltr", native_name: "à²•à²¨à³à²¨à²¡", name: {en: "Kannada", es: "CanarÃ©s"}}, ks: {direction: "ltr", native_name: "à¤•à¤¶à¥à¤®à¥€à¤°à¥€-(ÙƒØ´Ù…ÙŠØ±ÙŠ", name: {en: "Kashmiri", es: "Cachemiro"}}, cb: {direction: "ltr", native_name: "KaszÃ«bsczi", name: {en: "Kashubian", es: "Casubio"}}, mu: {direction: "ltr", native_name: "Karaoke", name: {en: "Karaoke", es: "Karaoke"}}, kk: {direction: "ltr", native_name: "Ò›Ð°Ð·Ð°Ò›ÑˆÐ°", name: {en: "Kazakh", es: "Kazajo"}}, ky: {direction: "ltr", native_name: "KÄ±rgÄ±zca", name: {en: "Kirghiz", es: "Kirghiz"}}, rn: {direction: "ltr", native_name: "Kirundi", name: {en: "Kirundi", es: "Kiroundi"}}, tm: {direction: "ltr", native_name: "tlhIngan-Hol", name: {en: "Klingon", es: "Klingon"}}, ko: {direction: "ltr", native_name: "í•œêµ­ì–´", name: {en: "Korean", es: "Coreano"}}, ku: {direction: "ltr", native_name: "KurdÃ®/ÙƒÙˆØ±Ø¯ÛŒ", name: {en: "Kurdish", es: "Kurdo"}}, lo: {direction: "ltr", native_name: "Lao", name: {en: "Lao", es: "Laosiano"}}, la: {direction: "ltr", native_name: "Latina", name: {en: "Latin", es: "LatÃ­n"}}, lv: {direction: "ltr", native_name: "LatvieÅ¡u", name: {en: "Latvian", es: "LetÃ³n"}}, li: {direction: "ltr", native_name: "Limburgs", name: {en: "Limburgian", es: "LimburguÃ©s"}}, ln: {direction: "ltr", native_name: "Lingala", name: {en: "Lingala", es: "Lingala"}}, lt: {direction: "ltr", native_name: "LietuviÅ³", name: {en: "Lithuanian", es: "Lituano"}}, jb: {direction: "ltr", native_name: "Lojban", name: {en: "Lojban", es: "Lojban"}}, nd: {direction: "ltr", native_name: "PlattdÃ¼Ã¼tsch", name: {en: "LowSaxon", es: "Ndebeleseptentrional"}}, lb: {direction: "ltr", native_name: "LÃ«tzebuergesch", name: {en: "Luxembourgish", es: "LuxemburguÃ©s"}}, mk: {direction: "ltr", native_name: "ÐœÐ°ÐºÐµÐ´Ð¾Ð½ÑÐºÐ¸", name: {en: "Macedonian", es: "Macedonio"}}, mg: {direction: "ltr", native_name: "Malagasy", name: {en: "Malagasy", es: "Malgache"}}, ms: {direction: "ltr", native_name: "BahasaMelayu", name: {en: "Malay", es: "Malayo"}}, ml: {direction: "ltr", native_name: "Malayalam", name: {en: "Malayalam", es: "Malayalam"}}, mt: {direction: "ltr", native_name: "bil-Malti", name: {en: "Maltese", es: "MaltÃ©s"}}, gv: {direction: "ltr", native_name: "Gaelg", name: {en: "Manx", es: "GaÃ©licomanÃ©s"}}, mi: {direction: "ltr", native_name: "MÄori", name: {en: "Maori", es: "MaorÃ­"}}, mr: {direction: "ltr", native_name: "à¤®à¤°à¤¾à¤ à¥€", name: {en: "Marathi", es: "Marathi"}}, mh: {direction: "ltr", native_name: "Ebon", name: {en: "Marshallese", es: "MarshalÃ©s"}}, zm: {direction: "ltr", native_name: "BÃ¢n-lÃ¢m-gÃº", name: {en: "MinNan", es: "MinNan"}}, mo: {direction: "ltr", native_name: "Moldoveana", name: {en: "Moldovan", es: "Moldavo"}}, mn: {direction: "ltr", native_name: "ÐœÐ¾Ð½Ð³Ð¾Ð»", name: {en: "Mongolian", es: "Mongol"}}, nh: {direction: "ltr", native_name: "Nahuatl", name: {en: "Nahuatl", es: "NÃ¡huatl"}}, na: {direction: "ltr", native_name: "dorerinNaoero", name: {en: "Nauruan", es: "Nauruano"}}, ne: {direction: "ltr", native_name: "à¤¨à¥‡à¤ªà¤¾à¤²à¥€", name: {en: "Nepali", es: "NepalÃ­"}}, no: {direction: "ltr", native_name: "Norsk(BokmÃ¥l)", name: {en: "Norwegian(BokmÃ¥l)", es: "Noruego"}}, nn: {direction: "ltr", native_name: "Nynorsk", name: {en: "Norwegian(Nynorsk)", es: "Nynorsknoruego"}}, oc: {direction: "ltr", native_name: "Occitan", name: {en: "Occitan", es: "Occitano(despuÃ©sdel1500)"}}, or: {direction: "ltr", native_name: "Oriya", name: {en: "Oriya", es: "Oriya"}}, om: {direction: "ltr", native_name: "Oromoo", name: {en: "Oromo", es: "Oromo"}}, pi: {direction: "ltr", native_name: "à¤ªà¤¾à¤¿à¤´", name: {en: "Pali", es: "Pali"}}, ps: {direction: "rtl", native_name: "Ù¾ÚšØªÙˆ", name: {en: "Pashto", es: "Pashto"}}, fa: {direction: "rtl", native_name: "ÙØ§Ø±Ø³ÛŒ", name: {en: "Persian", es: "Persa"}}, pl: {direction: "ltr", native_name: "Polski", name: {en: "Polish", es: "Polaco"}}, pt: {direction: "ltr", native_name: "PortuguÃªs", name: {en: "Portuguese", es: "PortuguÃ©s"}}, pa: {direction: "ltr", native_name: "à¨ªà©°à¨œà¨¾à¨¬à©€", name: {en: "Punjabi", es: "PunjabÃ­"}}, qu: {direction: "ltr", native_name: "RunaSimi", name: {en: "Quechua", es: "Quechua"}}, rm: {direction: "ltr", native_name: "Rumantsch", name: {en: "RaetoRomance", es: "RetorromÃ¡nico"}}, ro: {direction: "ltr", native_name: "RomÃ¢nÄƒ", name: {en: "Romanian", es: "Rumano"}}, ru: {direction: "ltr", native_name: "Ð ÑƒÑÑÐºÐ¸Ð¹", name: {en: "Russian", es: "Ruso"}}, sm: {direction: "ltr", native_name: "GaganaSamoa", name: {en: "Samoan", es: "Samoano"}}, sg: {direction: "ltr", native_name: "SÃ¤ngÃ¶", name: {en: "Sango", es: "Sango"}}, sa: {direction: "ltr", native_name: "à¤¸à¤‚à¤¸à¥à¤•à¥ƒà¤¤à¤®à¥", name: {en: "Sanskrit", es: "SÃ¡nscrito"}}, sc: {direction: "ltr", native_name: "Sardu", name: {en: "Sardinian", es: "Sardo"}}, gd: {direction: "ltr", native_name: "GÃ idhlig", name: {en: "ScottishGaelic", es: "GaÃ©licoescocÃ©s"}}, sr: {direction: "ltr", native_name: "Ð¡Ñ€Ð¿ÑÐºÐ¸/Srpski", name: {en: "Serbian", es: "Serbio"}}, sh: {direction: "ltr", native_name: "Srpskohrvatski", name: {en: "Serbo-Croatian", es: "Serbocroata"}}, tn: {direction: "ltr", native_name: "Setswana", name: {en: "Setswana", es: "Setchwana"}}, sn: {direction: "ltr", native_name: "chiShona", name: {en: "Shona", es: "Shona"}}, sb: {direction: "ltr", native_name: "Sicilianu", name: {en: "Sicilian", es: "Siciliano"}}, se: {direction: "ltr", native_name: "SimpleEnglish", name: {en: "SimpleEnglish", es: "Samiseptentrional"}}, sd: {direction: "rtl", native_name: "Ø³Ù†ÚŒÙŠ", name: {en: "Sindhi", es: "Sindhi"}}, si: {direction: "ltr", native_name: "Sinhalese", name: {en: "Sinhalese", es: "CingalÃ©s"}}, sk: {direction: "ltr", native_name: "SlovenÄina", name: {en: "Slovak", es: "Eslovaco"}}, sl: {direction: "ltr", native_name: "SlovenÅ¡Äina", name: {en: "Slovenian", es: "Esloveno"}}, so: {direction: "ltr", native_name: "Soomaaliga", name: {en: "Somali", es: "SomalÃ­"}}, st: {direction: "ltr", native_name: "seSotho", name: {en: "SouthernSotho", es: "Sesotho"}}, es: {direction: "ltr", native_name: "EspaÃ±ol", name: {en: "Spanish", es: "EspaÃ±ol"}}, su: {direction: "ltr", native_name: "BasaSunda", name: {en: "Sundanese", es: "SundanÃ©s"}}, sw: {direction: "ltr", native_name: "Kiswahili", name: {en: "Swahili", es: "Swahili"}}, ss: {direction: "ltr", native_name: "SiSwati", name: {en: "Swati", es: "Siswati"}}, sv: {direction: "ltr", native_name: "Svenska", name: {en: "Swedish", es: "Sueco"}}, tl: {direction: "ltr", native_name: "Tagalog", name: {en: "Tagalog", es: "Tagalo"}}, tg: {direction: "ltr", native_name: "Ð¢Ð¾Ò·Ð¸ÐºÓ£", name: {en: "Tajik", es: "Tayiko"}}, ta: {direction: "ltr", native_name: "à®¤à®®à®¿à®´à¯", name: {en: "Tamil", es: "Tamil"}}, tt: {direction: "ltr", native_name: "TatarÃ§a/Ð¢Ð°Ñ‚Ð°Ñ€Ñ‡Ð°", name: {en: "Tatar", es: "TÃ¡rtaro"}}, te: {direction: "ltr", native_name: "à°¤à±†à°²à±à°—à±", name: {en: "Telugu", es: "Telugu"}}, th: {direction: "ltr", native_name: "à¹„à¸—à¸¢", name: {en: "Thai", es: "TailandÃ©s"}}, bo: {direction: "ltr", native_name: "Bodskad", name: {en: "Tibetan", es: "Tibetano"}}, ti: {direction: "ltr", native_name: "Tigrinya", name: {en: "Tigrinya", es: "TegriÃ±a"}}, tp: {direction: "ltr", native_name: "TokPisin", name: {en: "TokPisin", es: "TokPisin"}}, tq: {direction: "ltr", native_name: "Tokipona", name: {en: "Tokipona", es: "Tokipona"}}, to: {direction: "ltr", native_name: "fakaTonga", name: {en: "Tongan", es: "Tonga(islastonga)"}}, ts: {direction: "ltr", native_name: "Xitsonga", name: {en: "Tsonga", es: "Tsonga"}}, tr: {direction: "ltr", native_name: "TÃ¼rkÃ§e", name: {en: "Turkish", es: "Turco"}}, tk: {direction: "ltr", native_name: "ØªØ±ÙƒÙ…Ù†/Ð¢ÑƒÑ€ÐºÐ¼ÐµÐ½", name: {en: "Turkmen", es: "Turcomano"}}, tw: {direction: "ltr", native_name: "Twi", name: {en: "Twi", es: "Twi"}}, udm: {direction: "ltr", native_name: "Ð£Ð´Ð¼ÑƒÑ€Ñ‚Ð­Ð»ÑŒÐºÑƒÐ½", name: {en: "Udmurt", es: "Udmurto"}}, uk: {direction: "ltr", native_name: "Ð£ÐºÑ€Ð°Ñ—Ð½ÑÑŒÐºÐ°", name: {en: "Ukrainian", es: "Ucraniano"}}, ur: {direction: "rtl", native_name: "Ø§Ú™Ø¯Ùˆ", name: {en: "Urdu", es: "Urdu"}}, ug: {direction: "ltr", native_name: "Oyghurque", name: {en: "Uyghur", es: "Uigur"}}, uz: {direction: "ltr", native_name: "Oâ€˜zbek", name: {en: "Uzbek", es: "Uzbeko"}}, vi: {direction: "ltr", native_name: "Tiáº¿ngViá»‡t", name: {en: "Vietnamese", es: "Vietnamita"}}, vo: {direction: "ltr", native_name: "VolapÃ¼k", name: {en: "VolapÃ¼k", es: "VolapÃ¼k"}}, wa: {direction: "ltr", native_name: "Walon", name: {en: "Walloon", es: "ValÃ³n"}}, cy: {direction: "ltr", native_name: "Cymraeg", name: {en: "Welsh", es: "GalÃ©s"}}, fy: {direction: "ltr", native_name: "Frysk", name: {en: "WestFrisian", es: "FrisÃ³n"}}, wo: {direction: "ltr", native_name: "Wollof", name: {en: "Wolof", es: "Uolof"}}, xh: {direction: "ltr", native_name: "isiXhosa", name: {en: "Xhosan", es: "Xhosa"}}, yi: {direction: "rtl", native_name: "×™×™Ö´×“×™×©", name: {en: "Yiddish", es: "Yidis"}}, yo: {direction: "ltr", native_name: "YorÃ¹bÃ¡", name: {en: "Yoruba", es: "Yoruba"}}, za: {direction: "ltr", native_name: "Cuengh", name: {en: "Zhuang", es: "Zhuang"}}, zu: {direction: "ltr", native_name: "isiZulu", name: {en: "Zulu", es: "ZulÃº"}}, han: {direction: "ltr", native_name: "æ¹–å—è¯", name: {en: "Xiang", es: "Xiang"}}, hak: {direction: "ltr", native_name: "å®¢å®¶", name: {en: "Hakka", es: "Hakka"}}, bho: {direction: "ltr", native_name: "à¤­à¥‹à¤œà¤ªà¥à¤°à¥€", name: {en: "Bhojpuri", es: "Bhojpuri"}}, mai: {direction: "ltr", native_name: "à¤®à¥ˆà¤¥à¤¿à¤²à¥€", name: {en: "Maithili", es: "Maithili"}}, ful: {direction: "ltr", native_name: "Fula", name: {en: "Fula", es: "Fula"}}, ibo: {direction: "ltr", native_name: "Igbo", name: {en: "Igbo", es: "Igbo"}}, gan: {direction: "ltr", native_name: "è´›èªž", name: {en: "Gan", es: "Gan"}}, ceb: {direction: "ltr", native_name: "Binisaya", name: {en: "Cebuano/Binisaya", es: "Cebuano/Bisaya"}}, skr: {direction: "ltr", native_name: "Ø³Ø±Ø§Ø¦ÛŒÚ©ÛŒ", name: {en: "Saraiki", es: "Saraiki"}}, ctg: {direction: "ltr", native_name: "à¦Ÿà¦—à¦¾à¦à¦‡à¦¯à¦¼à¦¾à¦¬à§à¦²à¦¿", name: {en: "Chittagonian", es: "Chittagonian"}}, mad: {direction: "ltr", native_name: "Ø¨ÙŽÙ‡Ø§Ø³ÙŽÙ…ÙŽØ¯ÙˆØ±Ø§", name: {en: "Madurese", es: "MadurÃ©s"}}, bgc: {direction: "ltr", native_name: "à¤¹à¤°à¤¿à¤¯à¤¾à¤£à¤µà¥€", name: {en: "Haryanvi", es: "Haryanvi"}}, mwr: {direction: "ltr", native_name: "à¤®à¤¾à¤°à¤µà¤¾à¤¡à¤¼à¥€", name: {en: "Marwari", es: "Marwari"}}, hne: {direction: "ltr", native_name: "à¤›à¤¤à¥à¤¤à¥€à¤¸à¤—à¤¢à¤¼à¥€", name: {en: "Chhattisgarhi", es: "Chhattisgarhi"}}, nya: {direction: "ltr", native_name: "Nyanja", name: {en: "Chewa/Nyanja", es: "Chewa/Nyanja"}}, dcc: {direction: "ltr", native_name: "Ø¯Ú©Ù†ÛŒâ€Ž", name: {en: "Dakhini", es: "Dakani"}}, mnp: {direction: "ltr", native_name: "é—½åŒ—è¯­", name: {en: "MinBei", es: "MinBei"}}, cdo: {direction: "ltr", native_name: "é–©æ±èªž", name: {en: "MinDong", es: "MinDong"}}, syl: {direction: "ltr", native_name: "à¦›à¦¿à¦²à¦Ÿà§€", name: {en: "Sylheti", es: "Sylheti"}}, kin: {direction: "ltr", native_name: "Ikinyarwanda", name: {en: "Kinyarwanda", es: "Kinyarwanda"}}, hat: {direction: "ltr", native_name: "KreyÃ²layisyen", name: {en: "HaitianCreole", es: "CriolloHaitiano"}}, ilo: {direction: "ltr", native_name: "Ilokano", name: {en: "Ilokano", es: "Ilocano"}}, mos: {direction: "ltr", native_name: "MÃ²orÃ©", name: {en: "Mossi", es: "MorÃ©"}}, bal: {direction: "ltr", native_name: "Ø¨Ù„ÙˆÚ†ÛŒ", name: {en: "Balochi", es: "Baluchi"}}, kok: {direction: "ltr", native_name: "à¤•à¥‹à¤‚à¤•à¤£à¥€", name: {en: "Konkani", es: "KonkanÃ­"}}, zom: {direction: "ltr", native_name: "Zomi", name: {en: "Zomi", es: "Zomi"}}, lol: {direction: "ltr", native_name: "lolspeak", name: {en: "lolspeak", es: "lolspeak"}}}, function () {
    window.PopupPosition = function () {
        function t() {
            console.log("function49");
        }

        return t.adjustToMiddle = function (t) {
            return t.css({"margin-top": -t.height() / 2, "margin-left": -t.width() / 2})
        }, t
    }()
}.call(this), function () {
    window.Popup = function () {
        function t(t) {
            null != t.container ? this.template = t.container : ($("body").append(JST["templates/popup"]({type: t.type, message: t.message})), this.template = $("body").find("#" + t.type + "-popup")), null != t.openLink && (this.openLink = t.openLink, this.openLink.bind("click", $.proxy(this.show, this))), this.overlay = t.overlay, this.template.find(".close, .close-btn").bind("click", $.proxy(this.hide, this)), PopupPosition.adjustToMiddle(this.template)
        }
    ...
    console.log("function50");
    window.TabSelector = function () {
        function t() {
        }

        return t.init = function () {
            var t, e, i, n, s, r, o, a, l, u, c, h;
            return o = $("#tool-button"), i = $("#disqus-button"), s = $("#team-note-button"), t = $("#activities-button"), a = $("#tool-tab"), n = $("#disqus-tab"), r = $("#team-note-tab"), e = $("#activities-tab"), u = [o, i, s, t], h = [a, n, r, e], c = function () {
                var t, e, i, n, s, r, o;
                for (i = 0, s = u.length; s > i; i++)t = u[i], t.removeClass("active");
                for (o = [], n = 0, r = h.length; r > n; n++)e = h[n], o.push(e.addClass("hidden"));
                return o
            }, l = function (t, e) {
    ...
    console.log("function51");
    var t = [].slice;
    window.I18n = {bulk: function () {
        var e, i = this;
        ...
        return{en: {learn_more: "To learn more about subtitling and segmenting,", checkout_viki_u: "check out Viki U!", save: "Save", cancel: "Cancel", tab_tooltip: "Shortcut key: Tab (also move to next segment)", esc_tooltip: "Shortcut key: Esc", replay_tooltip: "Replay segment (Ctrl + R)", history_tooltip: "History", start_segment_tooltip: "Open segment at start of dialogue.", shortcut: "Shortcut", can_not_open_seg_tooltip: "Cannot open a segment that overlaps with an existing one.", close_segment_tooltip: "Close segment after dialogue ends.", cancel_segment_tooltip: "To cancel the segment, use", continue_segment_tooltip_pre: "Use", continue_segment_tooltip_post: "to segment without pausing.", play: "Play", pause: "Pause", back_1_sec_tooltip: "Back by 1 second", forward_1_sec_tooltip: "Forward by 1 second", save_and_next: "Save and next", save_and_previous: "Save and previous", close: "Close", error_occurred: "An error has occurred", no_delete_subtitle_perm: "You can only delete your own subtitles.", retry: "Retry", duplicate_subtitle: "Another user already created the same subtitle. Please select it from Subtitle History.", no_segment: "This segment has been deleted", waring_delete_segment: "Are you sure you want to delete this segment? Note that any related subtitles will also be deleted and cannot be recovered.", fps_description: "Select lower setting to improve performance", switch_flash: "Switch to Flash Player", switch_html: "Switch to HTML5 Player", player_trouble: "Having trouble viewing this video? Click the button to"}, es: {learn_more: "Para aprender mÃ¡s acerca de la subtitulaciÃ³n y la segmentaciÃ³n,", checkout_viki_u: "echa un vistazo a Viki U!", save: "Guardar", cancel: "Cancelar", tab_tooltip: "tecla para acceso directo: Tab (tambiÃ©n pasar al siguiente segmento)", esc_tooltip: "tecla para acceso directo: Esc", replay_tooltip: "Repetir Segmento (Ctrl + R)", history_tooltip: "Historial", start_segment_tooltip: "Abrir segmento cuando inicie un diÃ¡logo.", shortcut: "Atajo", can_not_open_seg_tooltip: "No se puede abrir un segmento que coincida con uno ya existente.", close_segment_tooltip: "Cerrar segmento despuÃ©s de terminar el diÃ¡logo.", cancel_segment_tooltip: "Para cancelar el segmento, utiliza", continue_segment_tooltip_pre: "Utiliza", continue_segment_tooltip_post: "para segmentar sin detenerte", play: "Reproducir", pause: "Pausa", back_1_sec_tooltip: "Regresar 1 segundo", forward_1_sec_tooltip: "Avanzar 1 segundo", save_and_next: "Guardar y siguiente", save_and_previous: "Guardar y anterior", close: "Cerrar", error_occurred: "Se ha producido un error", no_delete_subtitle_perm: "SÃ³lo puedes borrar tus propios subtÃ­tulos.", retry: "Reintento", duplicate_subtitle: "Otro usuario ya ha creado el mismo subtÃ­tulo. Por favor, selecciÃ³nalo desde la lista de subtÃ­tulos.", no_segment: "Este segmento ha sido borrado", waring_delete_segment: "Â¿EstÃ¡ seguro que desea eliminar este segmento? Tenga en cuenta que todos los subtÃ­tulos relacionados tambiÃ©n serÃ¡n borrados y no se pueden recuperar.", fps_description: "Seleccione el ajuste bajo para mejorar el rendimientos", switch_flash: "Pasar a Flash Player", switch_html: "Pasar a reproductor HTML5", player_trouble: "Â¿Tiene problemas para ver este video? Haga clic en el botÃ³n para"}}
    }}
}.call(this), function () {
    console.log("function52");
    ...
    console.log("function54");
    $(function () {
        return window.documentIsReady = !0, window.isSignedIn = null != $.cookie("subber_username")
    }), window.onerror = function (t, e, i) {
        return $.post("/javascript_error", {error: t, file: e, location: window.location.href, lineNumber: i, documentReady: window.documentIsReady, ua: navigator.userAgent, userSignedIn: window.isSignedIn})
    }, window.logging_to_server = function (t, e) {
        return $.post("/javascript_log", {label: t, message: e})
    }, window.statd_increment = function (t) {
        return $.post("/statd_increment", {label: t})
    }
}.call(this), function () {
    window.App = {}
}.call(this), function () {
    ...
    window.SubtitlerPage = {titleForTechName: {dailymotion: "Dailymotion", youtube: "Youtube", html5: "HTML5", flash: "Flash"}, init: function () {
        var t, e, i;
        ...
        return $("#unlock-subtitle").bind("click", function () {
            var t = this;
            return $.ajax({url: $(this).data("uri"), type: "put", success: function () {
                var e;
        ...
        var i;
        return i = new Popup({container: $("#shortcuts-pop"), openLink: $("#showkeyboard"), overlay: e}), i.onOpenPopup(function () {
            return t.pause()
        }), new Shortcut({keyCodes: [191], shiftKey: !0, caller: i, callback: i.show})
    }, initBrowserSupport: function (t) {
        var e;
        return BrowserCheck.isValid() || (e = new Popup({container: $("#unsupported-popup"), overlay: t}), e.show()), "Mac" === BrowserCheck.OS ? $(".for-pc").hide() : $(".for-mac").hide()
    }, initCheckingVideoValidation: function (t, e) {
        return t.addEvent("invalidvideo", function () {
            var t;
            return t = new Popup({type: "Error", message: messages.invalid_video, overlay: e}), t.show()
        })
    }, initIntroPopup: function (t, e) {
        var i, n;
        return n = new App.User, i = new window.IntroPopup({overlay: e, user: n}), i.onOpenPopup(function () {
            return t.pause()
    ...
    window.Shortcut = function () {
        ...
        return t.prototype.keyCodes = [], t.prototype.metaKey = !1, t.prototype.ctrlKey = !1, t.prototype.shiftKey = !1, t.prototype.altKey = !1, t.prototype.caller = null, t.prototype.callback = null, t.prototype.toggle = null, t.prototype.callbackForOff = null, t.prototype.buildEventNames = function () {
            ...
            var e, i, n, s, r;
            for (i = t.keyCodes, r = [], n = 0, s = i.length; s > n; n++)e = i[n], r.push($(document).unbind(window.Shortcut.buildEventNameFor($.extend(t, {keyCode: e}))));
            return r
    ...
    window.Segment = function (e) {
        ...
        return i(n, e), n.prototype.minimumLength = 100, n.prototype.subtitle = null, n.prototype.baseUrl = null, n.prototype.defaults = {saved: !1, activated: !1, invalid: !1, original: {}}, n.prototype.initialize = function (t) {
            return this.subtitle = new Subtitle, this.subtitle.segment = this, subtitles.add(this.subtitle), this.get("id") && (this.subtitle.setUrlRoot(this), this.set({original: {start_time: t.start_time, end_time: t.end_time}})), this.on("change:id", this.subtitle.setUrlRoot, this.subtitle), this.on("destroy", this.destroySubtitle), this.on("sync", this.afterSync)
        ...
        }, n.prototype.prepareSubtitle = function () {
            var t;
            return t = {}, this.get("subtitle_id") && (t = {id: this.get("subtitle_id"), content: null === this.get("subtitle_content") ? "" : this.get("subtitle_content")}), t.language_code = this.get("subtitle_language_code"), t.saved = !0, this.subtitle.set(t)
        }, n.prototype.destroySubtitle = function () {
            return this.subtitle.destroy_without_sync()
        }, n.prototype.afterSync = function (t) {
            return t.set({saved: !0, invalid: !1})
        }, n
    }(Backbone.Model)
}.call(this), function () {
    var t, e = {}.hasOwnProperty, i = function (t, i) {
    ...
    window.Subtitle = function (e) {
        ...
        return i(n, e), n.prototype.segment = null, n.prototype.defaults = {content: "", saved: !1}, n.prototype.setUrlRoot = function (t) {
            return this.urlRoot = $("#segments").data("url") + "/" + t.get("id") + "/subtitles"
        }, n.prototype.destroy_without_sync = function () {
            return this.id = null, this.destroy()
        }, n
    }(Backbone.Model)
}.call(this), function () {
    console.log("function57");
    var t, e = {}.hasOwnProperty, i = function (t, i) {
        function n() {
            this.constructor = t
        }
    ...
    window.SubbingTool = function (e) {
        ...
        return i(n, e), n.prototype.segments = null, n.prototype.player = null, n.prototype.replayingSegment = null, n.prototype.intervalEventForReplaying = null, n.prototype.defaults = {segmentSelected: !1, isReplaying: !1}, n.prototype.initialize = function (t) {
            return this.segments = t.segments, this.player = t.player
        }, n.prototype.replaySegment = function (t) {
            return null != t ? (this.player.currentTime(t.get("start_time") / 1e3), this.replayingSegment = t, this.player.play(), this.intervalEventForReplaying && clearInterval(this.intervalEventForReplaying), this.intervalEventForReplaying = setInterval($.proxy(this.checkEndTimeOfReplayingSegment, this), 42)) : void 0
            ...
            return 1e3 * this.player.currentTime()
        }, n.prototype.durationInMilliSecond = function () {
            return 1e3 * this.player.duration()
        }, n
    }(Backbone.Model)
}.call(this), function () {
    ...
    window.SegmentView = function (e) {
        ...
        return i(n, e), n.prototype.tagName = "li", n.prototype.className = "segment", n.prototype.collection = null, n.prototype.events = {click: "select", resize: "updateTime", "click .delete-segment": "removeFormList", "click .replay-segment": "replaySegment"}, n.prototype.initialize = function (t) {
            return null == t && (t = {}), _.bindAll(this, "render", "remove", "removeFormList", "updateSize", "toggleActivation", "toggleDrawing", "toggleInvalidation"), this.model.on("change:start_time", this.updateSize), this.model.on("change:end_time", this.updateSize), this.model.on("change:activated", this.toggleActivation), this.model.on("change:drawing", this.toggleDrawing), this.model.on("change:invalid", this.toggleInvalidation), this.model.on("invalid", this.updateSize), this.model.on("destroy", this.remove), this.model.on("sync", this.render), this.collection = t.collection, this.subbingTool = t.subbingTool, this.subtitles = t.subtitles
            ...
            return this.collection.updateWithAdjacentSegment(this.model, {start_time: this.model.get("start_time") - 100})
        }, n.prototype.contractFromLeftWithAdjacent = function () {
            return this.collection.updateWithAdjacentSegment(this.model, {start_time: this.model.get("start_time") + 100})
        }, n.prototype.expandFromRightWithAjacent = function () {
            return this.collection.updateWithAdjacentSegment(this.model, {end_time: this.model.get("end_time") + 100})
            ...
            var t, e;
            return e = this.pixelToMillisecond(this.$el.position().left), t = 100 * Math.floor((e + this.pixelToMillisecond(this.$el.width())) / 100), e = 100 * Math.ceil(e / 100), this.model.set({start_time: e, end_time: t, saved: !1}, {validate: !0})
            ...
            return this.$el.hasClass("ui-resizable") || this.$el.resizable({handles: "e, w"}), this.$el.resizable({disabled: !1})
        }, n.prototype.disableResizable = function () {
            return this.$el.hasClass("ui-resizable") ? this.$el.resizable({disabled: !0}) : void 0
            ...
            return _.each([$.ui.keyCode.LEFT, $.ui.keyCode.RIGHT, $.ui.keyCode.UP, $.ui.keyCode.DOWN], function (t) {
                return Shortcut.unbindFor({keyCodes: [t], ctrlKey: !0}), Shortcut.unbindFor({keyCodes: [t], metaKey: !0})
            })
        }, n.prototype.bindKeyEvent = function () {
            return new Shortcut({keyCodes: [$.ui.keyCode.LEFT], ctrlKey: !0, caller: this, callback: this.expandFromLeftWithAdjacent}), new Shortcut({keyCodes: [$.ui.keyCode.RIGHT], ctrlKey: !0, caller: this, callback: this.contractFromLeftWithAdjacent}), new Shortcut({keyCodes: [$.ui.keyCode.UP], ctrlKey: !0, caller: this, callback: this.expandFromRightWithAjacent}), new Shortcut({keyCodes: [$.ui.keyCode.DOWN], ctrlKey: !0, caller: this, callback: this.contractFromRightWithAjacent}), new Shortcut({keyCodes: [$.ui.keyCode.LEFT], metaKey: !0, caller: this, callback: this.expandFromLeftWithAdjacent}), new Shortcut({keyCodes: [$.ui.keyCode.RIGHT], metaKey: !0, caller: this, callback: this.contractFromLeftWithAdjacent}), new Shortcut({keyCodes: [$.ui.keyCode.UP], metaKey: !0, caller: this, callback: this.expandFromRightWithAjacent}), new Shortcut({keyCodes: [$.ui.keyCode.DOWN], metaKey: !0, caller: this, callback: this.contractFromRightWithAjacent})
    ...
    window.SegmentBarView = function (e) {
        ...
        return i(n, e), n.prototype.player = null, n.prototype.intervalForPosition = null, n.prototype.intervalForSegmenting = null, n.prototype.defaultLanguageCode = null, n.prototype.newSegment = null, n.prototype.nextOfNewSegment = null, n.prototype.autosaveInterval = 6e4, n.prototype.rangeForClosestSegment = 17e3, n.prototype.defaultMillisecondPerPixel = 42, n.prototype.minimumLengthOfSegment = 100, n.prototype.offsetForTimeline = 0, n.prototype.initialize = function (t) {
            ...
            return this.segmentViewFactory = new SegmentViewFactory(this.collection, this.subtitles, this.model, $("#subtitles").data("language-code")), this.segmentFactory = new SegmentFactory(this.collection, $("#subtitles").data("language-code")), this.subtitleViewFactory = new SubtitleViewFactory(this.subtitles)
        }, n.prototype.initVariablesForElement = function () {
            return this.segmentsOnView = $("#segments"), this.subtitlesOnView = $("#subtitles"), this.waveformOnView = $("#waveform"), this.timescalesOnView = $("#timescales"), this.timelinesOnView = $("#timelines"), this.startSegmentButton = $("#start-segment"), this.endSegmentButton = $("#end-segment"), this.saveButton = $("#save-changes")
            ...
            return t = document.createDocumentFragment(), e = document.createDocumentFragment(), this.collection.each($.proxy(function (i) {
                var n, s;
                return n = this.segmentViewFactory.create_with_segment(i), null != n ? (s = this.subtitleViewFactory.create_with_subtitle(i.subtitle), t.appendChild(n.render().el), e.appendChild(s.render().el)) : void 0
            ...
            var t;
            return t = this.currentTimeSegment(), null != t && t.get("end_time") > this.model.currentTimeInMilliSecond() || !this.videoController.get("playable") ? this.videoController.set({segmentable: !1}) : this.videoController.set({segmentable: !0})
        }, n.prototype.disableAllButtons = function () {
            return this.videoController.set({playable: !1, segmentable: !1}), this.subtitler.showSpinner()
        }, n.prototype.enableAllButtons = function () {
            return this.videoController.set({playable: !0}), this.toggleSegmentButton(), this.subtitler.hideSpinner()
            ...
            return this.collection.saveAll(), this.subtitles.saveAll({ignoreDependency: !0}), !1
            ...
            var t, e;
            return e = this.model.currentTimeInMilliSecond(), t = this.segmentViewFactory.create(e, e + this.minimumLengthOfSegment, !1), null == t ? !1 : (this.segmentsOnView.append(t.render().el), t.model.set({drawing: !0}), this.videoController.set({segmenting: !0}), this.updateNewSegment(t.model), this.player.play(), this.intervalForSegmenting = setInterval($.proxy(this.updateSegment, this), this.millisecondPerPixel), !1)
        }, n.prototype.splitSegment = function () {
            var t, e, i, n, s;
            return e = this.model.currentTimeInMilliSecond(), t = this.currentTimeSegment(), i = t.get("end_time"), t.canSplitWith(e) ? (t.set({end_time: e, saved: !1}), n = this.segmentViewFactory.create(e, i, !1), s = this.subtitleViewFactory.create(n.model), this.segmentsOnView.append(n.render().el), this.subtitlesOnView.append(s.render().el)) : void 0
        }, n.prototype.stopSegment = function () {
            var t, e;
            return t = this.collection.getDrawing(), this.collection.stopDrawing(), e = this.subtitleViewFactory.create(t), this.subtitlesOnView.append(e.render().el), this.updateCurrentTimeSegment(), this.collection.select(t), this.player.pause(), this.videoController.set({segmenting: !1}), this.model.set({segmentSelected: !0}), this.updateNewSegment(null), clearInterval(this.intervalForSegmenting), !1
        }, n.prototype.cancelSegment = function () {
            var t;
            return t = this.collection.getDrawing(), null != t ? (this.collection.stopDrawing(), t.destroy(), this.updateCurrentTimeSegment(), this.videoController.set({segmenting: !1}), this.updateNewSegment(null), clearInterval(this.intervalForSegmenting), !1) : void 0
        }, n.prototype.updateSegment = function () {
            var t, e, i, n;
            if (i = this.collection.getDrawing(), null != i) {
                if (e = i.get("end_time"), t = this.model.currentTimeInMilliSecond(), n = this.nextOfNewSegment, t >= this.collection.endTimeInMillisecond())return i.set({end_time: this.collection.endTimeInMillisecond()}), this.stopSegment();
                if (null != n && t >= n.get("start_time"))return i.set({end_time: n.get("start_time")}), this.stopSegment();
                if (t > e)return i.set({end_time: t})
            }
            ...
            return this.videoController.set({segmentable: !0}), this.intervalForPosition = setInterval($.proxy(this.updatePosition, this), this.millisecondPerPixel), this.model.replayingSegment ? void 0 : this.deselectSegment()
            ...
            return new Shortcut({keyCodes: [$.ui.keyCode.DELETE, $.ui.keyCode.BACKSPACE], caller: this.collection, callback: this.collection.deleteSelected}), new Shortcut({keyCodes: [$.ui.keyCode.SPACE], shiftKey: !0, caller: this, callback: this.cutSegment}), new Shortcut({keyCodes: [$.ui.keyCode.SPACE], caller: this, callback: this.stopSegment, toggle: this.isSegmenting, callbackForOff: this.startSegment}), new Shortcut({keyCodes: [$.ui.keyCode.ESCAPE], caller: this, callback: this.cancelSegment}), new Shortcut({keyCodes: [$.ui.keyCode.TAB], caller: this, callback: this.jumpToNextSegment}), new Shortcut({keyCodes: [$.ui.keyCode.TAB], shiftKey: !0, caller: this, callback: this.jumpToPrevSegment}), new Shortcut({keyCodes: [82], caller: this, callback: this.replayVideo}), new Shortcut({keyCodes: [$.ui.keyCode.ENTER], caller: this, callback: this.syncSegments}), new Shortcut({keyCodes: [83], caller: this, callback: this.selectClosestSegment}), new Shortcut({keyCodes: [$.ui.keyCode.UP], caller: this, callback: this.focusInSubtitle}), new Shortcut({keyCodes: [$.ui.keyCode.DOWN], caller: this, callback: this.focusOutSubtitle})
        }, n
    }(Backbone.View)
}.call(this), function () {
    console.log("function62");
    var t, e = {}.hasOwnProperty, i = function (t, i) {
        function n() {
            this.constructor = t
        }
    ...
    window.SubtitleView = function (e) {
        ...
        return i(n, e), n.prototype.tagName = "li", n.prototype.className = "subtitle", n.prototype.events = {"click textarea": "refocus", "focus textarea": "selectSegment", "blur textarea": "updateContent"}, n.prototype.initialize = function () {
            return _.bindAll(this, "render", "toggleVisibility", "remove", "focusInTextArea", "focusOutTextArea"), this.status = $("#subtitles").data("status"), this.model.on("change:activated", this.toggleVisibility), this.model.on("destroy", this.remove), this.model.on("focusIn", this.focusInTextArea), this.model.on("focusOut", this.focusOutTextArea)
        }, n.prototype.render = function () {
            var t, e;
            return null != this.status && (e = "readonly"), t = "<textarea maxlength='120' placeholder='" + this.placeholder() + "' " + e + ">", this.model.get("content").length > 0 && (t += this.model.get("content")), t += "</textarea>", this.$el.html(t), this.hide(), this
            ...
            var t;
            return t = this.$("textarea").val().trim(), t !== this.model.get("content") ? 0 === t.length ? this.model.set({content: "", saved: !0}) : this.model.set({content: t, saved: !1}) : void 0
            ...
            return"blocked" === this.status ? "[" + viki.languages[this.model.get("language_code")].name.en + "] subtitle have been blocked" : "locked" === this.status ? "[" + viki.languages[this.model.get("language_code")].name.en + "] subtitle have been locked" : "Add [" + viki.languages[this.model.get("language_code")].name.en + "] subtitle"
        }, n
    }(Backbone.View)
}.call(this), function () {
    console.log("function63");
    var t, e = {}.hasOwnProperty, i = function (t, i) {
        function n() {
            this.constructor = t
        }
    ...
    window.VideoControllerView = function (e) {
        ...
        return i(n, e), n.prototype.initialize = function (t) {
            ...
            var t = this;
            return new Shortcut({keyCodes: [70, 80], caller: this, callback: this.playVideo, toggle: this.playerPaused, callbackForOff: this.pauseVideo}), new Shortcut({keyCodes: [37, 65], caller: this, callback: function () {
                return t.seekFromCurrentTime(-1)
            }}), new Shortcut({keyCodes: [39, 68], caller: this, callback: function () {
                return t.seekFromCurrentTime(1)
            }}), new Shortcut({keyCodes: [37], shiftKey: !0, caller: this, callback: function () {
                return t.seekFromCurrentTime(-.1)
            }}), new Shortcut({keyCodes: [39], shiftKey: !0, caller: this, callback: function () {
                return t.seekFromCurrentTime(.1)
            }})
        }, n
    }(Backbone.View)
}.call(this), function () {
    console.log("function64");
    var t, e = {}.hasOwnProperty, i = function (t, i) {
        function n() {
            this.constructor = t
        }
    ...
    window.Segments = function (e) {
        ...
        return i(n, e), n.prototype.model = Segment, n.prototype.selectedSegment = null, n.prototype.drawingSegment = null, n.prototype.sortedSegments = null, n.prototype.unsavedSegments = null, n.prototype.savingSegment = null, n.prototype.savingTimeout = null, n.prototype.requestTimeout = 15e3, n.prototype.url = null, n.prototype.initialize = function () {
            return this.url = $("#segments").data("url"), this.sortedSegments = new SortedSegments(this), this.unsavedSegments = new UnsavedSegments, this.setStartTime($("#segments").data("start-time")), this.setEndTime($("#segments").data("end-time")), this.on("add", this.enqueueToUnsavedSegments, this), this.on("change:drawing", this.enqueueToUnsavedSegments, this), this.on("change:start_time", this.enqueueToUnsavedSegments, this), this.on("change:end_time", this.enqueueToUnsavedSegments, this), this.on("remove", this.dequeueToUnsavedSegments, this), this.on("reqeustsend", this.setTimeoutForSaving, this), this.on("reqeustcomplete", this.resetTimeoutForSaving, this), this.on("reqeustcomplete", this.startSaving, this), this.on("requesttimeout", this.restartSaving, this)
        }, n.prototype.getDrawing = function () {
            return null == this.drawingSegment && (this.drawingSegment = this.where({drawing: !0})[0]), this.drawingSegment
        }, n.prototype.getSelected = function () {
            return null == this.selectedSegment && (this.selectedSegment = this.where({activated: !0})[0]), this.selectedSegment
        }, n.prototype.getInvalid = function () {
            return this.where({invalid: !0})[0]
        }, n.prototype.getUnsaved = function () {
            return this.where({saved: !1})[0]
        }, n.prototype.saveAll = function () {
            var t = this;
            return this.unsavedSegments.moveToSavingQueue(), !this.savingSegment && this.unsavedSegments.savingQueue().length > 0 ? (this.beforeSave(), this.startSaving()) : null != this.where({saved: !1, drawing: !1})[0] ? _.each(this.where({saved: !1, drawing: !1}), function (e) {
                return t.savingSegment !== e ? (logging_to_server("remained", e.attributes), t.enqueueToUnsavedSegments(e)) : void 0
            }) : void 0
        }, n.prototype.setTimeoutForSaving = function () {
            var t = this;
            return this.savingTimeout = setTimeout(function () {
                return t.trigger("requesttimeout")
            }, this.requestTimeout)
        }, n.prototype.resetTimeoutForSaving = function () {
            return clearTimeout(this.savingTimeout)
        }, n.prototype.restartSaving = function () {
            return logging_to_server("timeout", this.savingSegment.attributes), this.savingSegment = null, this.startSaving()
        }, n.prototype.startSaving = function () {
            var t, e = this;
            return t = this.unsavedSegments.dequeueFromSavingQueue(), null == t ? (this.afterSave(), void 0) : t.isValid() ? this.get(t.cid) ? (this.trigger("reqeustsend"), this.savingSegment = t, t.save({}, {success: function (t, i) {
                return e.afterSuccess(t, i), e.trigger("reqeustcomplete")
            }, error: function (t, i) {
                return e.afterFail(t, i), e.trigger("reqeustcomplete")
            }})) : (this.startSaving(), void 0) : (this.afterFail(t, {status: 403}), this.startSaving(), void 0)
        }, n.prototype.deleteSelected = function () {
            var t, e = this;
            return t = this.getSelected(), null != t && t.destroy({wait: !0, error: function (t, i) {
                return 401 === i.status ? e.triggerAuthenticationError() : 403 === i.status ? e.triggerPermissionError() : (e.add(t), t.destroy())
            }}), subbingTool.set({segmentSelected: !1})
            ...
            return null != this.selectedSegment ? (this.selectedSegment.set({activated: !1}), subbingTool.set({segmentSelected: !1}), this.selectedSegment = null) : void 0
        }, n.prototype.select = function (t) {
            return t !== this.selectedSegment ? (this.deselectAll(), this.selectedSegment = t, t.set({activated: !0}), subtitles.select(t.subtitle), subbingTool.set({segmentSelected: !0})) : void 0
        }, n.prototype.draw = function (t) {
            return this.drawingSegment = t, this.drawingSegment.set({drawing: !0})
        }, n.prototype.stopDrawing = function () {
            var t;
            return null != (t = this.drawingSegment) && t.set({drawing: !1}), this.drawingSegment = null
            ...
            var i, n;
            return null != e.start_time ? (n = this.prevSegment(t), t.get("start_time") - (null != n ? n.get("end_time") : void 0) > 100 && (n = null), t.get("start_time") > e.start_time ? (null != n && n.set({end_time: e.start_time, saved: !1}, {validate: !0}), t.set({start_time: e.start_time, saved: !1}, {validate: !0})) : (t.set({start_time: e.start_time, saved: !1}, {validate: !0}), null != n ? n.set({end_time: e.start_time, saved: !1}, {validate: !0}) : void 0)) : null != e.end_time ? (i = this.nextSegment(t), (null != i ? i.get("start_time") : void 0) - t.get("end_time") > 100 && (i = null), t.get("end_time") > e.end_time ? (t.set({end_time: e.end_time, saved: !1}, {validate: !0}), null != i ? i.set({start_time: e.end_time, saved: !1}, {validate: !0}) : void 0) : (null != i && i.set({start_time: e.end_time, saved: !1}, {validate: !0}), t.set({end_time: e.end_time, saved: !1}, {validate: !0}))) : void 0
        }, n.prototype.beforeSave = function () {
            var t;
            return t = new Message("info", "Saving segments..."), t.show()
            ...
            return 401 === e.status ? this.triggerAuthenticationError() : (t.set({invalid: !0}), logging_to_server("invalid", this.toHash()), this.enqueueToUnsavedSegments(t))
        }, n.prototype.afterSave = function () {
            var t;
            return this.savingSegment = null, t = null, t = null != segments.getInvalid() ? new Message("error", "Save failed for the segments highlighted in red. Please try saving again.", 3e3) : new Message("success", "All changes saved", 3e3), t.show()
            ...
            return this.map(function (t) {
                return"(" + t.id + ") " + t.get("start_time") + "-" + t.get("end_time")
            })
        }, n
    }(Backbone.Collection)
}.call(this), function () {
    console.log("function65");
    var t, e = {}.hasOwnProperty, i = function (t, i) {
        function n() {
            this.constructor = t
        }
    ...
    window.Subtitles = function (e) {
        ...
        return i(n, e), n.prototype.model = Subtitle, n.prototype.selectedSubtitle = null, n.prototype.getInvalid = function () {
            ...
            return t.get("saved") || null == t.segment ? void 0 : t.save({}, {success: $.proxy(this.afterSuccess, this)})
        }, n.prototype.afterSuccess = function (t) {
            var e, i;
            return t.set({saved: !0}), i = this.getUnsaved(), null == i && null == this.getInvalid() ? (e = new Message("success", "All changes saved", 3e3), e.show()) : void 0
        }, n.prototype.deselectAll = function () {
            return null != this.selectedSubtitle ? (this.selectedSubtitle.set({activated: !1}), this.selectedSubtitle = null) : void 0
        }, n.prototype.select = function (t) {
            return t !== this.selectedSubtitle ? (this.deselectAll(), this.selectedSubtitle = t, t.set({activated: !0})) : void 0
        }, n
    }(Backbone.Collection)
}.call(this), function () {
    console.log("function66");
    window.SegmentFactory = function () {
        function t(t, e) {
            this.segments = t, this.languageCode = e
        }

        return t.prototype.create = function (t, e, i) {
            var n;
            return n = new Segment({start_time: t, end_time: e, subtitle_language_code: this.languageCode, saved: i}), n.isValid() ? n : (this.rollback(n), null)
        }, t.prototype.rollback = function (t) {
            return t.destroy()
        }, t
    }()
}.call(this), function () {
    console.log("function68");
    window.SegmentViewFactory = function () {
        function t(t, e, i, n) {
            this.segments = t, this.subtitles = e, this.subbingTool = i, this.languageCode = n
        }

        return t.prototype.create = function (t, e, i) {
            var n;
            return n = new Segment({start_time: t, end_time: e, subtitle_language_code: this.languageCode, saved: i}), n.isValid() ? this.create_with_segment(n) : void 0
        }, t.prototype.create_with_segment = function (t) {
            return t.isValid() ? (this.segments.add(t), new SegmentView({model: t, collection: this.segments, subtitles: this.subtitles, subbingTool: this.subbingTool})) : void 0
        }, t
    }()
}.call(this), function () {
    console.log("function69");
    window.SubtitleViewFactory = function () {
        ...
        return t.prototype.create = function (t) {
            return t.prepareSubtitle(), this.create_with_subtitle(t.subtitle)
        }, t.prototype.create_with_subtitle = function (t) {
            return new SubtitleView({model: t, collection: this.subtitles})
        }, t
    }()
}.call(this), function () {
    var t;
    t = I18n.t("shortcut"), window.toolTips = {start_segment: {messages: {"*": "<p>" + I18n.t("start_segment_tooltip") + " " + t + ": <span class='key'>Spacebar</span></p>", inactive: "<p>" + I18n.t("can_not_open_seg_tooltip") + "</p>"}, target: "start-segment", top: 63, left: 360}, end_segment: {messages: {"*": "<p>" + I18n.t("close_segment_tooltip") + " " + t + ": <span class='key'>Spacebar</span>. </p><p>" + I18n.t("cancel_segment_tooltip") + " <span class='key'>ESC</span>. " + I18n.t("continue_segment_tooltip_pre") + " <span class='key'>Shift</span> + <span class='key'>Spacebar</span> " + I18n.t("continue_segment_tooltip_post") + "</p>"}, target: "end-segment", top: 63, left: 350}, play: {messages: {"*": "<p>" + I18n.t("play") + " (" + t + ": <span class='key'>P</span>)</p>"}, target: "play_button", top: 63, left: 22}, pause: {messages: {"*": "<p>" + I18n.t("pause") + " (" + t + ": <span class='key'>P</span>)</p>"}, target: "pause_button", top: 63, left: 18}, rewind: {messages: {"*": "<p>" + I18n.t("back_1_sec_tooltip") + " (" + t + ": <span class='key'> â† </span> or <span class='key'> A </span>)</p>"}, target: "rewind", top: 63, left: -65}, fast_forward: {messages: {"*": "<p>" + I18n.t("forward_1_sec_tooltip") + " (" + t + ": <span class='key'> â†’ </span> or <span class='key'> D </span>)</p>"}, target: "fast_forward", top: 63, left: 40}, save: {messages: {"*": "<p> " + I18n.t("save") + " (" + t + ": <span class='key'>S</span>)</p>"}, target: "save-changes", top: 63, left: 520}, fps: {messages: {"*": "<p> " + I18n.t("fps_description") + "</p>"}, target: "mpp", top: 63, left: 620}}
}.call(this), function () {
    window.messages = {invalid_video: "This video is not available anymore", waveform_is_processing: "The Waveform is currently being processed. This should take about 30min. Please <a href='http://support.viki.com/requests/new' target='_blank'>contact the  Help Center</a> if you continue to see issues with the Waveform.", waveform_is_not_available: "The blue Waveform that you see in the Segment Timer on official channels is not available on Fan Channels. Don't worry -- you can still segment using this tool!"}
}.call(this), function () {
    window.Subtitler = function () {
        function t() {
            this.urlInfo = new UrlParser(window.location.href), this.player = _V_("subber_player"), window.segments = new Segments, window.subtitles = new Subtitles, window.subbingTool = new SubbingTool({segments: window.segments, player: this.player}), window.originLanguage = new Language($("#subtitles").data("language-code")), this.initVideoError(), this.initBeforeUnload(), this.render()
        }

        return t.prototype.player = null, t.prototype.segmentBarView = null, t.prototype.scale = 1e3 / 30, t.prototype.isSegmentReady = !1, t.prototype.isMetaDataReady = !1, t.prototype.urlInfo = null, t.prototype.render = function () {
            return this.fetchSegments(), this.isOfficialVideo() && this.renderWaveform($("#timeframe").data("waveform-url")), this.initComponents()
        }, t.prototype.initSubbingTool = function () {
            var t;
            return this.isSegmentReady = !0, window.segments.each(function (t) {
                return t.set({saved: !0}), t.prepareSubtitle()
            }), segments.cleanUnsavedSegments(), t = new VideoController, new VideoControllerView({model: t, player: this.player, startTime: window.segments.startTime(), endTime: window.segments.endTime()}), t.set({playable: !0, segmentable: !1}), this.segmentBarView = new SegmentBarView({subtitler: this, collection: window.segments, subtitles: window.subtitles, model: window.subbingTool, videoController: t, mpp: this.urlInfo.getParams().mpp}), $("#timeframe").append(this.segmentBarView.render().el), this.openEditor()
        }, t.prototype.fetchSegments = function () {
            return window.segments.fetch({reset: !0, data: $.param({language_code: originLanguage.code, start_time: window.segments.startTimeInMillisecond(), end_time: null != window.segments.endTimeInMillisecond() ? window.segments.endTimeInMillisecond() : 0}), success: $.proxy(this.initSubbingTool, this), error: $.proxy(this.showErrorMessage, this)})
            ...
            }, 6e4), void 0) : $.jsonp({url: t, callback: "parseResponse", success: function (t) {
                var i;
            ...
            var t;
            return t = this.offsetOfTimeline() / 2, $(".segment-disabled.front").css("width", t + window.segments.startTimeInMillisecond() / this.scale + "px"), $(".segment-disabled.front").css("left", "-" + t + "px"), $(".segment-disabled.rear").css("width", t + (1e3 * this.player.duration() - window.segments.endTimeInMillisecond()) / this.scale + "px"), $(".segment-disabled.rear").css("left", window.segments.endTimeInMillisecond() / this.scale + "px")
        }, t.prototype.showErrorMessage = function () {
            return setTimeout($.proxy(function () {
                return this.fetchSegments()
            }, this), this.refetchInterval())
        }, t.prototype.openEditor = function () {
            return this.isSegmentReady && this.isMetaDataReady ? (this.hideSpinner(), this.player.play(), this.player.currentTime(window.segments.startTime())) : void 0
        }, t.prototype.showSpinner = function () {
            return $(".timeframe-spinner").show()
        }, t.prototype.hideSpinner = function () {
            return $(".timeframe-spinner").hide()
        }, t.prototype.refetchInterval = function () {
            return 5e3
        }, t.prototype.getVideoInfo = function () {
            var t;
            return t = this, $.ajax({url: this.urlInfo.getBaseUrl() + "/info.json", type: "get", success: function (e) {
                return t.renderWaveform(e.waveform)
            }})
        }, t.prototype.offsetOfTimeline = function () {
        ...
        return t.prototype.pixelPerSecond = .03, t.prototype.waveformData = null, t.prototype.container = null, t.prototype.renderingIndex = 0, t.prototype.renderingIntervalId = null, t.prototype.renderingInterval = 5e3, t.prototype.generate = function () {
            ...
            if (!(0 > t)) {
                ...
                if (r = this.parts[t], !r.rendered) {
                    ...
                    return e = $(this.container).append("<div style='width: " + i.length + "px; position: absolute; left: " + r.startTime + "px;'></div>").children().last()[0], o = new Waveform({container: e, data: i, height: 50, width: i.length, innerColor: "#00CCFF"}), r.$canvas = $(e), r.rendered = !0
                }
            }
    ...
    window.TimelinePart = function () {
        ...
        return t.prototype.template = null, t.prototype.scale = 1e3 / 30, t.prototype.unitOfTime = 5, t.prototype.pixelOfPart = 150, t.prototype.maxLength = 7200, t.prototype.totalLegnth = null, t.prototype.startPosition = 460, t.prototype.currentIndex = 0, t.prototype.formattedTime = function (t) {
            ...
            if (s = this.parts[t], null != s && !(s.rendered || (e = s.endTime - s.startTime, n = parseInt(e / this.unitOfTime, 10), 0 >= n))) {
                for (o = "timeline-" + t, this.template.append("<ul id='" + o + "'></ul>"), i = 0, r = this.offset + (s.startTime - this.startTime) / this.unitOfTime * this.pixelOfPart; n > i;)this.template.find("#" + o).append(JST["templates/timeslice"]({position: r, formatted_time: this.formattedTime(s.startTime + i * this.unitOfTime)})), r += this.pixelOfPart, ++i;
    ...
    window.SlideBar = function () {
        function t(t, e, i, n) {
            this.player = t, this.container = e, this.startTime = i, this.duration = n, this.knob = this.container.find(".current_knob"), this.timebar = this.container.find(".full_bar"), this.progressBar = $(".play_range"), this.endTime = this.startTime + this.duration, this.width = this.timebar.width(), this.addEventToPlayer(), this.addEventToSlideBar()
        }
        ...
        }, t.prototype.radiusOfKnob = function () {
            return this.knob.width() / 2
    ...
    window.Message = function () {
        function t(t, e, i) {
            var n = this;
            this.$container = $("#message-box-container"), this.$container.append(JST["templates/message"]({type: t, message: e, icon: this.icons[t]})), this.$messageBox = $(this.$container.children().last()), this.$messageBox.find(".close").bind("click", function () {
                return n.hide()
            }), this.duration = i
        }

        return t.prototype.$messageBox = null, t.prototype.duration = null, t.prototype.icons = {info: "!", success: "Ã¥", error: "~"}, t.prototype.show = function () {
            var t = this;
            return this.removeExistingBox(), this.$messageBox.show(), null != this.duration ? setTimeout(function () {
                return t.hide()
            }, this.duration) : void 0
        }, t.prototype.hide = function () {
            return this.$messageBox.remove()
        }, t.prototype.removeExistingBox = function () {
            return _.each(this.$container.children(), function (t) {
                var e;
                return e = $(t), e.is(":visible") ? e.remove() : void 0
            })
        }, t
    }()
}.call(this), function () {
    window.ToolTip = function () {
        function t(t, e, i, n, s) {
            ...
            for (r in i)"*" !== r && this.statuses.push(r), o = i[r], this.container.append(JST["templates/tool-tip"]({id: this.targetId(r), messages: o, top: n, left: s}));
    ...
    window.IntroPopup = function () {
        ...
        return s = null, e = null, i = null, n = null, r = null, o = null, t.prototype.close = function () {
            ...
            return this.user.markAsNotNewUser(), $.ajax({url: "/subtitlers/disable_intro", type: "put"})
        }, t.prototype.show = function () {
    ...
    window.InactivityChecker = function () {
        function t(t, e) {
            this.overlay = e, this.template = $("#inactivity-popup"), this.urlToActivate = "" + t + "/check_video_lock", PopupPosition.adjustToMiddle(this.template), this.params = {start_time: this.template.data("start-time"), end_time: this.template.data("end-time")}
        }
        ...
        return t.prototype.inactivityTimeout = null, t.prototype.show = function (t) {
            ...
            var t;
            return t = this, $.ajax({url: this.urlToActivate, type: "put", data: this.params, success: function () {
    ...
    window.UnsavedSegments = function () {
        ...
        return t.prototype.clean = function () {
            ...
            for (n = this.extractAll(), a = n[0], s = n[1], o = a.length, r = 0; o >= r;)for (r++, t = c = 0, d = a.length; d > c; t = ++c)if (u = a[t], e = !1, null != u) {
                for (h = 0, p = a.length; p > h; h++)if (l = a[h], null != l && l.cid !== u.cid && u.get("start_time") < l.get("original").end_time && u.get("end_time") > l.get("original").start_time) {
                    e = !0;
                    break
                }
    ...
    window.SortedSegments = function () {
        ...
        return t.prototype.segments = null, t.prototype.collection = null, t.prototype.reset = function () {
            ...
            var e, i, n, s, r;
            for (e = t.get("start_time"), i = this.collection.length - 1, r = 0; i >= r;)if (n = Math.round((i + r) / 2), s = this.collection[n].get("start_time"), e > s)r = n + 1; else {
                if (!(s > e))return n;
                i = n - 1
            }
        }, t.prototype.indexByTime = function (t) {
            var e, i, n, s, r, o;
            for (e = t, i = this.collection.length - 1, o = 0; i >= o;)if (s = Math.round((i + o) / 2), r = this.collection[s].get("start_time"), n = this.collection[s].get("end_time"), r > e)i = s - 1; else {
                if (!(e > n))return s;
                o = s + 1
            }
            return[i, o]
    ...
    this.JST || (this.JST = {}), this.JST["templates/message"] = function (obj) {
        var __p = [];
        with (obj || {})__p.push('<div class="alert alert-', type, '" style=\'display:none;\'>\n  <i class="icon icon-alert pull-left" data-icon="', icon, '"></i>\n  <div class="alert-body">\n    ', message, "\n  </div>\n</div>\n");
        return __p.join("")
    }
}.call(this), function () {
    ...
    var t = _V_.el("subber_player_youtube_api"), e = t.parentNode.player;
    e.play();
    var i = e.duration();
    ...
    var t = _V_.el("subber_player_youtube_api"), e = t.parentNode.player, i = e.tech;
    ...
    var t = _V_.el("subber_player_dailymotion_api"), e = t.parentNode.player, i = e.tech;
    ...
    var t = _V_.el("subber_player_dailymotion_api"), e = t.parentNode.player;
    e.play();
    var i = e.duration();
    ...
    window.PlayerSelectionLink = function () {
        ...
        return t.prototype.render = function () {
            var t;
            return this.setPlayer(), this.$container.append(this.linkTemplate()), this.$container.append(this.toolTipTemplate()), t = this.$container.find(".info-tooltip"), this.$container.hover(function () {
