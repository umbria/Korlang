! function (t, e) {
    ...
    function H(t, e, i) {
        ...
        return F(u, c), le.isFunction(u.opts.start) && u.opts.start.call(t, u), le.fx.timer(le.extend(l, {
            elem: t,
            anim: u,
            queue: u.opts.queue
    ...
    function (t, e) {
        ...
        function w() {}
        var x, k, C, T, S, E, P, D, I, M, A, N, V, $, j, O, F, H = "sizzle" + -new Date,
            L = t.document,
            B = {}, z = 0,
            R = 0,
            W = n(),
        ...
        S = o.isXML = function (t) {
            ...
            }), V = new RegExp(V.join("|")), $ = new RegExp($.join("|")), O = i(A.contains) || A.compareDocumentPosition ? function (t, e) {
...
function (t) {
    ...
    function r(r) {
        function p(t) {
            X++ || (G(), W && (S[U] = {
                s: [t]
            }), L && (t = L.apply(r, [t])), n(O, r, [t, w, r]), n(H, r, [r, w]))
        }
    ...
    var x, k, C, T, S, E, P = "undefined",
        ...
        U = function () {
            var t = typeof j.getElementById != P && typeof j.getElementsByTagName != P && typeof j.createElement != P,
                ...
                a = [0, 0, 0],
                l = null;
            if (typeof O.plugins != P && typeof O.plugins[I] == D) l = O.plugins[I].description, !l || typeof O.mimeTypes != P && O.mimeTypes[A] && !O.mimeTypes[A].enabledPlugin || (F = !0, o = !1, l = l.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), a[0] = parseInt(l.replace(/^(.*)\..*$/, "$1"), 10), a[1] = parseInt(l.replace(/^.*\.(.*)\s.*$/, "$1"), 10), a[2] = /[a-zA-Z]/.test(l) ? parseInt(l.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
...
function () {
    ...
    be: {
        direction: "ltr",
        native_name: "Ð‘ÐµÐ»Ð°Ñ€ÑƒÑÐºÐ°Ñ",
        name: {
            en: "Belarusian",
            es: "Bielorruso"
        }
    ...
    ka: {
        direction: "ltr",
        native_name: "áƒ¥áƒáƒ áƒ—áƒ£áƒšáƒ˜",
        name: {
            en: "Georgian",
            es: "Georgiano"
        }
    ...
    ks: {
        direction: "ltr",
        native_name: "à¤•à¤¶à¥à¤®à¥€à¤°à¥€-(ÙƒØ´Ù…ÙŠØ±ÙŠ",
        name: {
            en: "Kashmiri",
            es: "Cachemiro"
        }
    ...
    mk: {
        direction: "ltr",
        native_name: "ÐœÐ°ÐºÐµÐ´Ð¾Ð½ÑÐºÐ¸",
        name: {
            en: "Macedonian",
            es: "Macedonio"
        }
    ...
    no: {
        direction: "ltr",
        native_name: "Norsk(BokmÃ¥l)",
        name: {
            en: "Norwegian(BokmÃ¥l)",
            es: "Noruego"
        }
    },
    nn: {
    ...
    sr: {
        direction: "ltr",
        native_name: "Ð¡Ñ€Ð¿ÑÐºÐ¸/Srpski",
        name: {
            en: "Serbian",
            es: "Serbio"
        }
    ...
    tt: {
        direction: "ltr",
        native_name: "TatarÃ§a/Ð¢Ð°Ñ‚Ð°Ñ€Ñ‡Ð°",
        name: {
            en: "Tatar",
            es: "TÃ¡rtaro"
        }
    ...
    tk: {
        direction: "ltr",
        native_name: "ØªØ±ÙƒÙ…Ù†/Ð¢ÑƒÑ€ÐºÐ¼ÐµÐ½",
        name: {
            en: "Turkmen",
            es: "Turcomano"
        }
    ...
    udm: {
        direction: "ltr",
        native_name: "Ð£Ð´Ð¼ÑƒÑ€Ñ‚Ð­Ð»ÑŒÐºÑƒÐ½",
        name: {
            en: "Udmurt",
            es: "Udmurto"
        }
    ...
    uk: {
        direction: "ltr",
        native_name: "Ð£ÐºÑ€Ð°Ñ—Ð½ÑÑŒÐºÐ°",
        name: {
            en: "Ukrainian",
            es: "Ucraniano"
        }
    ...
    ctg: {
        direction: "ltr",
        native_name: "à¦Ÿà¦—à¦¾à¦à¦‡à¦¯à¦¼à¦¾à¦¬à§à¦²à¦¿",
        name: {
            en: "Chittagonian",
            es: "Chittagonian"
        }
    ...
    mad: {
        direction: "ltr",
        native_name: "Ø¨ÙŽÙ‡Ø§Ø³ÙŽÙ…ÙŽØ¯ÙˆØ±Ø§",
        name: {
            en: "Madurese",
            es: "MadurÃ©s"
        }
    ...
    hne: {
        direction: "ltr",
        native_name: "à¤›à¤¤à¥à¤¤à¥€à¤¸à¤—à¤¢à¤¼à¥€",
        name: {
            en: "Chhattisgarhi",
            es: "Chhattisgarhi"
        }
...
function () {
    window.TabSelector = function () {
        ...
        return t.init = function () {
            return $("#tool-button").click(function () {
                return $("#disqus-tab").addClass("hidden"), $("#disqus-button").removeClass("active"), $("#team-note-tab").addClass("hidden"), $("#team-note-button").removeClass("active"), $("#tool-button").addClass("active"), $("#tool-tab").removeClass("hidden")
            }), $("#disqus-button").click(function () {
                return $("#tool-tab").addClass("hidden"), $("#tool-button").removeClass("active"), $("#team-note-tab").addClass("hidden"), $("#team-note-button").removeClass("active"), $("#disqus-button").addClass("active"), $("#disqus-tab").removeClass("hidden")
            }), $("#team-note-button").click(function () {
                return $("#tool-tab").addClass("hidden"), $("#tool-button").removeClass("active"), $("#disqus-tab").addClass("hidden"), $("#disqus-button").removeClass("active"), $("#team-note-button").addClass("active"), $("#team-note-tab").removeClass("hidden")
            })
        }, t
    }()
}.call(this),
    ...
    window.I18n = {
        ...
        languages: function () {
            return {
                ...
                es: {
                    learn_more: "Para aprender mÃ¡s acerca de la subtitulaciÃ³n y la segmentaciÃ³n,",
                    checkout_viki_u: "echa un vistazo a Viki U!",
                    save: "Guardar",
                    cancel: "Cancelar",
                    tab_tooltip: "tecla para acceso directo: Tab (tambiÃ©n pasar al siguiente segmento)",
                    esc_tooltip: "tecla para acceso directo: Esc",
                    replay_tooltip: "Repetir Segmento (Ctrl + R)",
                    history_tooltip: "Historial",
                    start_segment_tooltip: "Abrir segmento cuando inicie un diÃ¡logo.",
                    shortcut: "Atajo",
                    can_not_open_seg_tooltip: "No se puede abrir un segmento que coincida con uno ya existente.",
                    close_segment_tooltip: "Cerrar segmento despuÃ©s de terminar el diÃ¡logo.",
                    ...
                    no_delete_subtitle_perm: "SÃ³lo puedes borrar tus propios subtÃ­tulos.",
                    retry: "Reintento",
                    duplicate_subtitle: "Otro usuario ya ha creado el mismo subtÃ­tulo. Por favor, selecciÃ³nalo desde la lista de subtÃ­tulos.",
                    no_segment: "Este segmento ha sido borrado",
                    waring_delete_segment: "Â¿EstÃ¡ seguro que desea eliminar este segmento? Tenga en cuenta que todos los subtÃ­tulos relacionados tambiÃ©n serÃ¡n borrados y no se pueden recuperar.",
                    ...
                    player_trouble: "Â¿Tiene problemas para ver este video? Haga clic en el botÃ³n para"
                }
            }
        }
    }
...
function () {
    ...
    window.Segment = function (e) {
        ...
        return i(n, e), n.prototype.minimumLength = 100, n.prototype.subtitle = null, n.prototype.baseUrl = null, n.prototype.defaults = {
            ...
            return this.subtitle = new Subtitle, this.subtitle.segment = this, subtitles.add(this.subtitle), this.get("id") && (this.subtitle.setUrlRoot(this), this.set({
                original: {
                    start_time: t.start_time,
                    end_time: t.end_time
                }
            })), this.on("change:id", this.subtitle.setUrlRoot, this.subtitle), this.on("destroy", this.destroySubtitle), this.on("sync", this.afterSync)
            ...
            var t;
            return t = {}, this.get("subtitle_id") && (t = {
...
function () {
    ...
    window.SubbingTool = function (e) {
        ...
        return i(n, e), n.prototype.segments = null, n.prototype.player = null, n.prototype.replayingSegment = null, n.prototype.intervalEventForReplaying = null, n.prototype.defaults = {
            segmentSelected: !1,
            isReplaying: !1
        }, n.prototype.initialize = function (t) {
    ...
    window.SegmentBarView = function (e) {
        ...
        return i(n, e), n.prototype.player = null, n.prototype.intervalForPosition = null, n.prototype.intervalForSegmenting = null, n.prototype.defaultLanguageCode = null, n.prototype.newSegment = null, n.prototype.nextOfNewSegment = null, n.prototype.autosaveInterval = 6e4, n.prototype.rangeForClosestSegment = 17e3, n.prototype.defaultMillisecondPerPixel = 42, n.prototype.minimumLengthOfSegment = 100, n.prototype.offsetForTimeline = 0, n.prototype.initialize = function (t) {
            ...
            return this.videoController.set({
                playable: !1,
                segmentable: !1
            }), this.subtitler.showSpinner()
        }, n.prototype.enableAllButtons = function () {
            return this.videoController.set({
                playable: !0
            }), this.toggleSegmentButton(), this.subtitler.hideSpinner()
            ...
            var t, e;
            return e = this.model.currentTimeInMilliSecond(), t = this.segmentViewFactory.create(e, e + this.minimumLengthOfSegment, !1), null == t ? !1 : (this.segmentsOnView.append(t.render().el), t.model.set({
                drawing: !0
            }), this.videoController.set({
                segmenting: !0
            ...
            var t, e, i, n, s;
            return e = this.model.currentTimeInMilliSecond(), t = this.currentTimeSegment(), i = t.get("end_time"), t.canSplitWith(e) ? (t.set({
                end_time: e,
                saved: !1
            }), n = this.segmentViewFactory.create(e, i, !1), s = this.subtitleViewFactory.create(n.model), this.segmentsOnView.append(n.render().el), this.subtitlesOnView.append(s.render().el)) : void 0
            ...
            if (i = this.collection.getDrawing(), null != i) {
                if (e = i.get("end_time"), t = this.model.currentTimeInMilliSecond(), n = this.nextOfNewSegment, t >= this.collection.endTimeInMillisecond()) return i.set({
                    end_time: this.collection.endTimeInMillisecond()
                }), this.stopSegment();
                if (null != n && t >= n.get("start_time")) return i.set({
                    end_time: n.get("start_time")
                }), this.stopSegment();
                if (t > e) return i.set({
                    end_time: t
                })
...
function () {
    ...
    window.Segments = function (e) {
        ...
        return i(n, e), n.prototype.model = Segment, n.prototype.selectedSegment = null, n.prototype.drawingSegment = null, n.prototype.sortedSegments = null, n.prototype.unsavedSegments = null, n.prototype.savingSegment = null, n.prototype.savingTimeout = null, n.prototype.requestTimeout = 15e3, n.prototype.url = null, n.prototype.initialize = function () {
            ...
            var t, e = this;
            return t = this.unsavedSegments.dequeueFromSavingQueue(), null == t ? (this.afterSave(), void 0) : t.isValid() ? this.get(t.cid) ? (this.trigger("reqeustsend"), this.savingSegment = t, t.save({}, {
            ...
            })) : (this.startSaving(), void 0) : (this.afterFail(t, {
                status: 403
            }), this.startSaving(), void 0)
        }, n.prototype.deleteSelected = function () {
            var t, e = this;
            return t = this.getSelected(), null != t && t.destroy({
                wait: !0,
                error: function (t, i) {
            ...
            return t !== this.selectedSegment ? (this.deselectAll(), this.selectedSegment = t, t.set({
                activated: !0
            ...
            return 401 === e.status ? this.triggerAuthenticationError() : (t.set({
                invalid: !0
            }), logging_to_server("invalid", this.toHash()), this.enqueueToUnsavedSegments(t))
...
function () {
    ...
    window.Subtitles = function (e) {
        ...
        return i(n, e), n.prototype.model = Subtitle, n.prototype.selectedSubtitle = null, n.prototype.getInvalid = function () {
            ...
            return t.get("saved") || null == t.segment ? void 0 : t.save({}, {
            ...
            return t.set({
                saved: !0
            }), i = this.getUnsaved(), null == i && null == this.getInvalid() ? (e = new Message("success", "All changes saved", 3e3), e.show()) : void 0
        }, n.prototype.deselectAll = function () {
...
function () {
    window.SegmentFactory = function () {
        ...
        return t.prototype.create = function (t, e, i) {
            var n;
            return n = new Segment({
                start_time: t,
                end_time: e,
                subtitle_language_code: this.languageCode,
                saved: i
            }), n.isValid() ? n : (this.rollback(n), null)
    ...
    window.SegmentViewFactory = function () {
        ...
        return t.prototype.create = function (t, e, i) {
            ...
            return n = new Segment({
                ...
                subtitle_language_code: this.languageCode,
                saved: i
            }), n.isValid() ? this.create_with_segment(n) : void 0
...
function () {
    ...
    t = I18n.t("shortcut"), window.toolTips = {
        ...
        rewind: {
            messages: {
                "*": "<p>" + I18n.t("back_1_sec_tooltip") + " (" + t + ": <span class='key'> â† </span> or <span class='key'> A </span>)</p>"
            },
            target: "rewind",
            top: 63,
            left: -65
        ...
        fast_forward: {
            messages: {
                "*": "<p>" + I18n.t("forward_1_sec_tooltip") + " (" + t + ": <span class='key'> â†’ </span> or <span class='key'> D </span>)</p>"
            },
            target: "fast_forward",
            top: 63,
            left: 40
        ...
        save: {
            messages: {
                "*": "<p> " + I18n.t("save") + " (" + t + ": <span class='key'>S</span>)</p>"
            },
            target: "save-changes",
            top: 63,
            left: 520
...
function () {
    window.Subtitler = function () {
        function t() {
            this.urlInfo = new UrlParser(window.location.href), this.player = _V_("subber_player"), window.segments = new Segments, window.subtitles = new Subtitles, window.subbingTool = new SubbingTool({
                segments: window.segments,
                player: this.player
            }), window.originLanguage = new Language($("#subtitles").data("language-code")), this.initVideoError(), this.initBeforeUnload(), this.render()
        }
        return t.prototype.player = null, t.prototype.segmentBarView = null, t.prototype.scale = 1e3 / 30, t.prototype.isSegmentReady = !1, t.prototype.isMetaDataReady = !1, t.prototype.urlInfo = null, t.prototype.render = function () {
            ...
            }), $("#timeframe").append(this.segmentBarView.render().el), this.openEditor()
            ...
            return window.segments.fetch({
                ...
                error: $.proxy(this.showErrorMessage, this)
            })
...
function () {
    window.Message = function () {
        function t(t, e, i) {
            var n = this;
            this.$container = $("#message-box-container"), this.$container.append(JST["templates/message"]({
                type: t,
                message: e,
                icon: this.icons[t]
            })), this.$messageBox = $(this.$container.children().last()), this.$messageBox.find(".close").bind("click", function () {
                return n.hide()
            }), this.duration = i
        }
        return t.prototype.$messageBox = null, t.prototype.duration = null, t.prototype.icons = {
            info: "!",
            success: "Ã¥",
            error: "~"
        }, t.prototype.show = function () {
